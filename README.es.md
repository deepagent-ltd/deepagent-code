...
npm i -g deepagent-code@latest        # o bun/pnpm/yarn
scoop install deepagent-code             # Windows
choco install deepagent-code             # Windows
brew install anomalyco/tap/deepagent-code # macOS y Linux (recomendado, siempre al día)
brew install deepagent-code              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S deepagent-code            # Arch Linux (Stable)
paru -S deepagent-code-bin               # Arch Linux (Latest from AUR)
mise use -g deepagent-code               # cualquier sistema
nix run nixpkgs#deepagent-code           # o github:lessweb/deepagent-code para la rama dev más reciente
```
...
DeepAgent Code también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/lessweb/deepagent-code/releases) o desde [deepagent-code.ai/download](https://deepagent-code.ai/download).
...
1. `$DEEPAGENT_CODE_INSTALL_DIR` - Directorio de instalación personalizado
2. `$XDG_BIN_DIR` - Ruta compatible con la especificación XDG Base Directory
3. `$HOME/bin` - Directorio binario estándar del usuario (si existe o se puede crear)
4. `$HOME/.deepagent-code/bin` - Alternativa por defecto
...
DeepAgent Code incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://deepagent-code.ai/docs/agents).

### Documentación

Para más información sobre cómo configurar DeepAgent Code, [**ve a nuestra documentación**](https://deepagent-code.ai/docs).

### Contribuir

Si te interesa contribuir a DeepAgent Code, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en DeepAgent Code

Si estás trabajando en un proyecto basado en DeepAgent Code y usas "deepagent-code" como parte del nombre, por ejemplo, "deepagent-code-dashboard" u "deepagent-code-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de DeepAgent Code y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/deepagent-code) | [X.com](https://x.com/deepagent-code)
