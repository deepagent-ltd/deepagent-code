...
let
  packageJson = lib.pipe ../packages/deepagent-code/package.json [
    builtins.readFile
    builtins.fromJSON
  ];
...
stdenvNoCC.mkDerivation {
  pname = "deepagent-code-node_modules";
  ...
  src = lib.fileset.toSource {
    ...
    fileset = lib.fileset.intersection (lib.fileset.fromSource (lib.sources.cleanSource ../.)) (
      lib.fileset.unions [
        ...
        ../.github/TEAM_MEMBERS # required by @deepagent-code/script
      ]
    );
  };
  ...
  buildPhase = ''
    ...
    bun install \
      ...
      --os="${bunOs}" \
      --filter '!./' \
      --filter './packages/deepagent-code' \
