...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/deepagent-ltd/deepagent-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for deepagent-ltd/deepagent-code...\n")
...
console.log("Fetching npm all-time downloads for deepagentCode...\n")
const npmDownloads = await fetchNpmDownloads("deepagent-code")
