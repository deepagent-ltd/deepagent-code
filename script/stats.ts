...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/lessweb/deepagent-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for lessweb/deepagentCode...\n")
