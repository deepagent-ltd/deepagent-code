...
export const suites: Suite[] = [
  ...
  {
    id: "release:desktop-interrupted-permission-package",
    package: "desktop",
    command: ["bun", "run", "test:llm-release:interrupted-permission-package"],
    realLLM: true,
    desktop: true,
    packageScript: "test:llm-release:interrupted-permission-package",
  },
  {
  ...
  {
    id: "release:desktop-r0-interactive",
    package: "desktop",
    command: ["bun", "run", "test:llm-release:r0-interactive"],
    realLLM: true,
    desktop: true,
    packageScript: "test:llm-release:r0-interactive",
  },
]
