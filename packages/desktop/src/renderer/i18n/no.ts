export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av DeepAgent Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av DeepAgent Code er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke 'deepagent-code'-kommandoen.",
