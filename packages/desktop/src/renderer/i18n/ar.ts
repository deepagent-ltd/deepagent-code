export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من DeepAgent Code",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من DeepAgent Code، هل ترغب في تثبيته وإعادة تشغيله؟",
