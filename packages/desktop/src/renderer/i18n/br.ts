export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do DeepAgent Code",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do DeepAgent Code foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.cli.installed.message": "CLI instalada em {{path}}\n\nReinicie seu terminal para usar o comando 'deepagent-code'.",
