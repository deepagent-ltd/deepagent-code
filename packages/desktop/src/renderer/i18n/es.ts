export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de DeepAgent Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de DeepAgent Code. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.cli.installed.message":
    "CLI instalada en {{path}}\n\nReinicia tu terminal para usar el comando 'deepagent-code'.",
