export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji DeepAgent Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} DeepAgent Code. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'deepagent-code'.",
