export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの DeepAgent Code を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "DeepAgent Code のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'deepagent-code' コマンドを使用してください。",
