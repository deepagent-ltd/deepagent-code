...
import type { WslServersState } from "@deepagent-code/app/wsl/types"
...
function runtime(kind: "starting" | "ready" | "failed" | "stopped") {
  if (kind === "ready") return { kind, url: "http://127.0.0.1:4096", username: "deepagent-code", password: "secret" }
