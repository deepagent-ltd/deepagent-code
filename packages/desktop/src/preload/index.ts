...
const api: ElectronAPI = {
  ...
  wslServers: {
    ...
    probeOpencode: (name) => ipcRenderer.invoke("wsl-servers-probe-deepagent-code", name),
    installOpencode: (name) => ipcRenderer.invoke("wsl-servers-install-deepagent-code", name),
