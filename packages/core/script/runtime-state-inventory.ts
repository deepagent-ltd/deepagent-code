  ...
  ...Object.fromEntries(
    (
      [
        ...
        ["packages/deepagent-code/src/session/durable-executor-lock.ts:processReservations", ["module-keyed-mutex", "per-executor-key", "lock-hold-duration", "release-on-exit", "coordination-only", "instance-scoped", "safe_bounded"]],
        ...
        ["packages/deepagent-code/src/tool/task.ts:sharedWriteFallbackLocks", ["module-keyed-mutex", "per-session-key", "lock-hold-duration", "release-on-settle", "coordination-only", "instance-scoped", "safe_bounded"]],
        ["packages/deepagent-code/src/tool/task.ts:subagentSettlementLocks", ["module-keyed-mutex", "per-session-key", "lock-hold-duration", "release-on-settle", "coordination-only", "instance-scoped", "safe_bounded"]],
