...
function seedSession() {
  return Effect.gen(function* () {
    ...
    yield* db.insert(SessionTable).values({ id: sessionId, project_id: projectId, slug: "c3-dyn", directory: "/tmp/c3-dyn", title: "C3 dyn", version: "test", execution_claim_token: 103 }).run()
    yield* db
