import { convertToOpenAICompatibleChatMessages as convertToCopilotMessages } from "@deepagent-code/core/github-copilot/chat/convert-to-openai-compatible-chat-messages"
