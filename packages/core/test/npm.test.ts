...
describe("Npm.sanitize", () => {
  test("keeps normal scoped package specs unchanged", () => {
    expect(Npm.sanitize("@deepagent-code/acme")).toBe("@deepagent-code/acme")
    expect(Npm.sanitize("@deepagent-code/acme@1.0.0")).toBe("@deepagent-code/acme@1.0.0")
    expect(Npm.sanitize("prettier")).toBe("prettier")
  })

  test("handles git https specs", () => {
    const spec = "acme@git+https://github.com/deepagent-code/acme.git"
    const expected = win ? "acme@git+https_//github.com/deepagent-code/acme.git" : spec
