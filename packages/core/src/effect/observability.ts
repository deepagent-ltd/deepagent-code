...
import { ensureProcessMetadata } from "../util/deepagent-code-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    serviceName: "deepagent-code",
    serviceVersion: InstallationVersion,
    attributes: {
      ...attributes,
      "deployment.environment.name": InstallationChannel,
      "deepagent-code.client": Flag.DEEPAGENT_CODE_CLIENT,
      "deepagent-code.process_role": processMetadata.processRole,
      "deepagent-code.run_id": processMetadata.runID,
