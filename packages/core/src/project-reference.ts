...
export class Service extends Context.Service<Service, Interface>()("@deepagent-code/ProjectReference") {}
...
export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (!Flag.DEEPAGENT_CODE_EXPERIMENTAL_REFERENCES) return Service.of(inert)
