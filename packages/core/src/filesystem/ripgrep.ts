...
import { sanitizedProcessEnv } from "../util/deepagent-code-process"
...
export class Service extends Context.Service<Service, Interface>()("@deepagent-code/Ripgrep") {}
    ...
    Effect.gen(function* () {
      ...
      const tree: Interface["tree"] = Effect.fn("Ripgrep.tree")(function* (input: TreeInput) {
        ...
        for (const file of list) {
          if (file.includes(".deepagent-code")) continue
