export * as DeepAgentCode from "./deepagent-code"
...
/** Intentional public native API for Effect applications embedding DeepAgent Code. */
export class Service extends Context.Service<Service, Interface>()("@deepagent-code/public/DeepAgentCode") {}
...
>()("@deepagent-code/public/DeepAgentCode/SessionModelValidation") {}
...
const SessionModelValidationLayer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    return SessionModelValidation.of({
      validate: Effect.fn("DeepAgentCode.sessions.validateModel")(function* (input) {
  ...
  Effect.gen(function* () {
    ...
    return Service.of({
      ...
      sessions: {
        ...
        get: sessions.get,
        list: sessions.list,
        switchModel: Effect.fn("DeepAgentCode.sessions.switchModel")(function* (input) {
...
// TODO: Add DeepAgent Code.create(...) as the Promise facade over the same native API semantics.
