...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@deepagent-code/example/RequestContextRef",
) {}
...
export class ConfigService extends Context.Service<ConfigService, ConfigServiceShape>()(
  "@deepagent-code/example/ConfigService",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@deepagent-code/example/ConfigServiceMap", {
