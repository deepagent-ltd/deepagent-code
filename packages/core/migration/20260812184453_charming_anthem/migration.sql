...
ALTER TABLE `learning_job` ADD `expected_result_ref` text;--> statement-breakpoint
CREATE UNIQUE INDEX `task_structured_finalizer_response_message_idx` ON `task_structured_finalizer_response` (`response_message_id`);
