...
--> statement-breakpoint
CREATE INDEX `session_context_checkpoint_session_idx` ON `session_context_checkpoint` (`session_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `session_model_policy_receipt_session_idx` ON `session_model_policy_receipt` (`session_id`,`created_at`);