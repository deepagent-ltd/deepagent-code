...
export const TypeId: TypeId = "~@deepagent-code/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@deepagent-code/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@deepagent-code/effect-sqlite-node/NodeSqliteClient")
