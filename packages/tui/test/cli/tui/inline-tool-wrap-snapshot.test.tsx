...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "DEEPAGENT_CODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/deepagent-code/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/deepagent-code (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/deepagent-code/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/deepagent-code/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const DEEPAGENT_CODE_DB|DEEPAGENT_CODE_DB|DEEPAGENT_CODE_DEV|Global\\.Path\\.data|data =" in packages/deepagent-code/src (115 matches)',
  },
] as const
