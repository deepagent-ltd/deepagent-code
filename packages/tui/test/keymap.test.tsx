...
import { getOpencodeModeStack, DEEPAGENT_CODE_BASE_MODE, OpencodeKeymapProvider, registerOpencodeKeymap } from "../src/keymap"
...
test("mode-less bindings stay active when deepagent-code mode changes", async () => {
