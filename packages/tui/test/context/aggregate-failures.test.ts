...
import { aggregateFailures } from "@deepagent-code/tui/context/aggregate-failures"
...
describe("aggregateFailures", () => {
  ...
  test("formats structured config errors hidden inside SDK error causes", () => {
    ...
    expect(err!.message).toContain("config.get: Configuration is invalid at /tmp/deepagent-code.json")
