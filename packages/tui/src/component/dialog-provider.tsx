...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@deepagent-code/sdk/v2"
...
const CUSTOM_PROVIDER_OPTION_VALUE = "__deepagent_code_custom_provider__"
  ...
  return [
    ...pipe(
      ...
      map((provider) => ({
        ...
        description: {
          "deepagent-code": "(Recommended)",
          anthropic: "(API key)",
          openai: "(ChatGPT Plus/Pro or API key)",
          "deepagent-code-go": "Low cost subscription for everyone",
        }[provider.id],
    ...
    <DialogPrompt
      ...
      onConfirm={async (value) => {
        ...
        if (props.custom && !sync.data.provider_next.all.some((provider) => provider.id === props.providerID)) {
          toast.show({
            variant: "info",
            message: `Saved credential for ${props.providerID}. Configure it in deepagent-code.json to use it.`,
          })
          dialog.clear()
          return
        }
