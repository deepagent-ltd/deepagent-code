...
import defaultSoundPath from "@deepagent-code/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@deepagent-code/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@deepagent-code/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@deepagent-code/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@deepagent-code/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@deepagent-code/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "deepagent-code"
const DEFAULT_PACK_ID = "deepagent-code.default"
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "DeepAgent Code Default",
  builtin: true,
  sounds: {
