...
const TIPS: Tip[] = [
  ...
  "Place TUI settings in {highlight}~/.deepagent/code/tui.json{/highlight} for global config",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/deepagent-ltd/deepagent-code{/highlight} for containerized use",
