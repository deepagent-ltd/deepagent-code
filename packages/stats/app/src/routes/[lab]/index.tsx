...
const statsLabFallbackUrl = "https://stats.deepagent-code.ai"
...
export default function StatsLab() {
  ...
  const labDescription = createMemo(
    () =>
      `Explore ${labName()} models used in DeepAgent Code, with recent token usage, context windows, release dates, and model-specific stats.`,
  )
    ...
    <section id="overview" data-section="lab-hero">
      <div data-slot="model-hero-grid">
        <div data-slot="model-hero-copy">
          ...
          <h1>Model Lab</h1>
          <p>Reading model availability and recent DeepAgent Code usage.</p>
        </div>
      </div>
    </section>
  )
    ...
    <section id="overview" data-section="lab-hero">
      ...
      <div data-slot="model-hero-grid">
        <div data-slot="model-hero-copy">
          ...
          <p>
            Explore {props.lab.models.length} {props.lab.name} models used in DeepAgent Code
        ...
        <div data-component="model-rank-panel">
          ...
          <p>
            {props.stats
              ? `${formatPercent(props.stats.tokenShare)} of recent DeepAgent Code usage`
              : latest()
  ...
  return (
    <section id="usage" data-section="model-panel">
      <p data-slot="section-title">
        ...
        <span>Daily DeepAgent Code token volume over the last two months.</span>
      </p>
      <Show
