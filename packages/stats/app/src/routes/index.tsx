...
import {
  ...
  type TokenCostEntry,
  type UsagePoint,
} from "@deepagent-code/stats-core/domain/home"
...
const statsHomeTitle = "DeepAgent Code Stats"
const statsHomeDescription = "DeepAgent Code usage, market share, token cost, and session cost stats."
const statsHomeFallbackUrl = "https://deepagent-code.ai/stats/"
const statsUnfurlPath = "banner.png"
const statsUnfurlAlt = "DeepAgent Code Stats wordmark on a dark patterned background"
const usageColors = [
  "#ed6aff",
  "#a684ff",
  "#7c86ff",
...
export default function StatsHome() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="DeepAgent Code" />
...
function getStatsHomeUrl(base: string, requestUrl: string) {
  ...
  if (url.hostname === "stats.deepagent-code.ai") return "https://deepagent-code.ai/stats/"
  if (url.hostname === "stats.dev.deepagent-code.ai") return "https://dev.deepagent-code.ai/stats/"
  return url.toString()
}
  ...
  return (
    <section id="top-models" data-section="top-models">
      <h2 data-slot="top-models-title">
        <strong>Top models.</strong> <span>Usage of models across DeepAgent Code Go.</span>
      </h2>
      <Show
