import deepagentCodeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  href: "https://github.com/lessweb/deepagent-code",
  apiHref: "https://api.github.com/repos/lessweb/deepagent-code",
  label: "GitHub",
  fallbackStars: "150K",
  ariaLabel: "Star DeepAgent Code on GitHub",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "deepagent-code:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://deepagent-code.ai/">
            <strong>Try DeepAgent Code</strong>
          </a>
          <button
...
function DeepAgentCodeMark() {
  return (
    <svg data-slot="deepagent-code-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://deepagent-code.ai/legal/terms-of-service", label: "Terms of service" },
    { href: "https://deepagent-code.ai/legal/privacy-policy", label: "Privacy policy" },
  ]
  const connect = [
    { href: "mailto:hello@deepagentCode.ai", label: "Contact us" },
    { href: "https://deepagent-code.ai/discord", label: "Community" },
    { href: "https://x.com/deepagent-code", label: "X" },
    githubLink,
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://deepagent-code.ai" aria-label="DeepAgent Code home">
          <DeepAgentCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={deepagentCodeWordmarkDark} alt="DeepAgent Code" />
        ...
        <div data-slot="modal-body">
          <div data-slot="modal-intro">
            <h2 id="subscribe-title">DeepAgent Code Newsletter</h2>
            <p>
