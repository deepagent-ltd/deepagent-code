...
DeepAgent Code は、エンタープライズネットワーク環境の標準プロキシ環境変数とカスタム証明書をサポートしています。

---

## プロキシ

DeepAgent Code は標準のプロキシ環境変数を尊重します。
...
企業が HTTPS 接続にカスタム CA を使用している場合は、それらを信頼するように DeepAgent Code を構成します。
