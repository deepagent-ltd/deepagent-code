...
1. TUI で `/connect` コマンドを実行し、`DeepAgent Code Zen` を選択して、[deepagent-code.ai/zen](https://deepagent-code.ai/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`DeepAgent Code Go` を選択して、[deepagent-code.ai/zen](https://deepagent-code.ai/zen) にアクセスします。
