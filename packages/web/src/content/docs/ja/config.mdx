...
サーバー/ランタイム構成スキーマは [**`deepagent-code.ai/config.json`**](https://deepagent-code.ai/config.json) で定義されています。

TUI 設定は [**`deepagent-code.ai/tui.json`**](https://deepagent-code.ai/tui.json) を使用します。
