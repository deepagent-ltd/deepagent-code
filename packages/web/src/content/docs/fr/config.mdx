...
Le fichier de configuration a un schéma défini dans [**`deepagent-code.ai/config.json`**](https://deepagent-code.ai/config.json).

La configuration TUI utilise [**`deepagent-code.ai/tui.json`**](https://deepagent-code.ai/tui.json).
