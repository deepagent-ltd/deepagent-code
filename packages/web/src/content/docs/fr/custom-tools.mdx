...
description: Créez des outils que le LLM peut appeler dans deepagent-code.
---

Les outils personnalisés sont des fonctions que vous créez et que le LLM peut appeler pendant les conversations. Ils fonctionnent avec les [outils intégrés](/docs/tools) de deepagent-code comme `read`, `write` et `bash`.
...
- Localement en les plaçant dans le répertoire `.deepagent-code/tools/` de votre projet.
- Ou globalement, en les plaçant dans `~/.config/deepagent-code/tools/`.
