...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez deepagent-code et dirigez-vous vers [deepagent-code.ai/auth](https://deepagent-code.ai/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `DeepAgent Code Go` et rendez-vous sur [deepagent-code.ai/auth](https://deepagent-code.ai/zen).
