...
Vous pouvez définir des serveurs MCP dans votre [DeepAgent Code Config](https://ai.deepagent.ltd/docs/config/) sous `mcp`. Ajoutez chaque MCP avec un nom unique. Vous pouvez faire référence à ce MCP par son nom lorsque vous demandez le LLM.
