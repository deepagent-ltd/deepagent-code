...
DeepAgent Code Go est un abonnement à bas coût — **5 $ pour votre premier mois**, puis **10 $/mois** — qui vous donne un accès fiable aux modèles de codage ouverts populaires.

Go fonctionne comme n'importe quel autre fournisseur dans DeepAgent Code. Vous vous abonnez à DeepAgent Code Go et obtenez votre clé d'API. C'est **totalement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser DeepAgent Code.
...
DeepAgent Code Go vous donne accès à ces modèles pour **5 $ pour votre premier mois**, puis **10 $/mois**.

---

## Comment ça marche

DeepAgent Code Go fonctionne comme n'importe quel autre fournisseur dans DeepAgent Code.

1. Vous vous connectez à **<a href={console}>DeepAgent Code Zen</a>**, vous vous abonnez à Go et copiez votre clé d'API.
2. Vous exécutez la commande `/connect` dans la TUI, sélectionnez `DeepAgent Code Go` et collez votre clé d'API.
3. Exécutez `/models` dans la TUI pour voir la liste des modèles disponibles via Go.

:::note
Un seul membre par espace de travail peut s'abonner à DeepAgent Code Go.
:::
...
DeepAgent Code Go inclut les limites suivantes :
...
| ----------------- | ----------------- | ------------------------------------------------ | --------------------------- |
| GLM-5.1           | glm-5.1           | `https://deepagent-code.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5             | glm-5             | `https://deepagent-code.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5         | kimi-k2.5         | `https://deepagent-code.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://deepagent-code.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://deepagent-code.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://deepagent-code.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5         | mimo-v2.5         | `https://deepagent-code.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro     | mimo-v2.5-pro     | `https://deepagent-code.ai/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M3        | minimax-m3        | `https://deepagent-code.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.7      | minimax-m2.7      | `https://deepagent-code.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5      | minimax-m2.5      | `https://deepagent-code.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Max       | qwen3.7-max       | `https://deepagent-code.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus      | qwen3.7-plus      | `https://deepagent-code.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://deepagent-code.ai/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |

L'[ID de modèle](/docs/config/#models) dans votre configuration DeepAgent Code utilise le format `deepagent-code-go/<model-id>`. Par exemple, pour Kimi K2.6, vous utiliseriez `deepagent-code-go/kimi-k2.6` dans votre configuration.
...
```
https://deepagent-code.ai/zen/go/v1/models
```
...
Nous avons créé DeepAgent Code Go pour :
...
4. N'avoir **aucun verrouillage exclusif** en vous permettant d'utiliser n'importe quel autre fournisseur avec DeepAgent Code également.
