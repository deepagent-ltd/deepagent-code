...
| ----------------- | ----------------- | ------------------------------------------------ | --------------------------- |
| GLM-5.1           | glm-5.1           | `https://ai.deepagent.ltd/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| GLM-5             | glm-5             | `https://ai.deepagent.ltd/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.5         | kimi-k2.5         | `https://ai.deepagent.ltd/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| Kimi K2.6         | kimi-k2.6         | `https://ai.deepagent.ltd/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Pro   | deepseek-v4-pro   | `https://ai.deepagent.ltd/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash | deepseek-v4-flash | `https://ai.deepagent.ltd/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5         | mimo-v2.5         | `https://ai.deepagent.ltd/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiMo-V2.5-Pro     | mimo-v2.5-pro     | `https://ai.deepagent.ltd/zen/go/v1/chat/completions` | `@ai-sdk/openai-compatible` |
| MiniMax M3        | minimax-m3        | `https://ai.deepagent.ltd/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.7      | minimax-m2.7      | `https://ai.deepagent.ltd/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| MiniMax M2.5      | minimax-m2.5      | `https://ai.deepagent.ltd/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Max       | qwen3.7-max       | `https://ai.deepagent.ltd/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus      | qwen3.7-plus      | `https://ai.deepagent.ltd/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus      | qwen3.6-plus      | `https://ai.deepagent.ltd/zen/go/v1/messages`         | `@ai-sdk/anthropic`         |
...
```
https://ai.deepagent.ltd/zen/go/v1/models
```
