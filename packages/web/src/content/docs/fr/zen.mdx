---
title: Zen
description: Liste organisée de modèles fournis par DeepAgent Code.
---
...
DeepAgent Code Zen est une liste de modèles testés et vérifiés fournie par l'équipe DeepAgent Code.

Zen fonctionne comme n'importe quel autre fournisseur dans DeepAgent Code. Vous vous connectez à DeepAgent Code Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser DeepAgent Code.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec DeepAgent Code.
:::
...
DeepAgent Code Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

DeepAgent Code Zen fonctionne comme n'importe quel autre fournisseur dans DeepAgent Code.

1. Vous vous connectez à **<a href={console}>DeepAgent Code Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez DeepAgent Code Zen et collez votre clé API.
...
| ---------------------- | ---------------------- | ---------------------------------------------------- | --------------------------- |
| GPT 5.5                | gpt-5.5                | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.5 Pro            | gpt-5.5-pro            | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4                | gpt-5.4                | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Pro            | gpt-5.4-pro            | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Mini           | gpt-5.4-mini           | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Nano           | gpt-5.4-nano           | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.3 Codex          | gpt-5.3-codex          | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark    | gpt-5.3-codex-spark    | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.2                | gpt-5.2                | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.2 Codex          | gpt-5.2-codex          | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1                | gpt-5.1                | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex          | gpt-5.1-codex          | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max      | gpt-5.1-codex-max      | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini     | gpt-5.1-codex-mini     | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5                  | gpt-5                  | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5 Codex            | gpt-5-codex            | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5 Nano             | gpt-5-nano             | `https://deepagent-code.ai/zen/v1/responses`               | `@ai-sdk/openai`            |
| Claude Opus 4.8        | claude-opus-4-8        | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.7        | claude-opus-4-7        | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.6        | claude-opus-4-6        | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.5        | claude-opus-4-5        | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.1        | claude-opus-4-1        | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6      | claude-sonnet-4-6      | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5      | claude-sonnet-4-5      | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4        | claude-sonnet-4        | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5       | claude-haiku-4-5       | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5       | claude-3-5-haiku       | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Gemini 3.5 Flash       | gemini-3.5-flash       | `https://deepagent-code.ai/zen/v1/models/gemini-3.5-flash` | `@ai-sdk/google`            |
| Gemini 3.1 Pro         | gemini-3.1-pro         | `https://deepagent-code.ai/zen/v1/models/gemini-3.1-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash         | gemini-3-flash         | `https://deepagent-code.ai/zen/v1/models/gemini-3-flash`   | `@ai-sdk/google`            |
| Qwen3.7 Max            | qwen3.7-max            | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus           | qwen3.7-plus           | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus           | qwen3.6-plus           | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.5 Plus           | qwen3.5-plus           | `https://deepagent-code.ai/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| DeepSeek V4 Flash      | deepseek-v4-flash      | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiniMax M2.7           | minimax-m2.7           | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiniMax M2.5           | minimax-m2.5           | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| GLM 5.1                | glm-5.1                | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| GLM 5                  | glm-5                  | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Kimi K2.5              | kimi-k2.5              | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Kimi K2.6              | kimi-k2.6              | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Grok Build 0.1         | grok-build-0.1         | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Big Pickle             | big-pickle             | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiMo-V2.5 Free         | mimo-v2.5-free         | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Nemotron 3 Ultra Free  | nemotron-3-ultra-free  | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash Free | deepseek-v4-flash-free | `https://deepagent-code.ai/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |

Le [model id](/docs/config/#models) dans votre configuration DeepAgent Code utilise le format `deepagent-code/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `deepagent-code/gpt-5.5` dans votre configuration.
...
```
https://deepagent-code.ai/zen/v1/models
```
...
- DeepSeek V4 Flash Free est disponible sur DeepAgent Code pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- MiMo-V2.5 Free est disponible sur DeepAgent Code pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Ultra Free est disponible sur DeepAgent Code pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Big Pickle est un modèle stealth gratuit sur DeepAgent Code pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
Nous avons créé DeepAgent Code Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec DeepAgent Code également.
