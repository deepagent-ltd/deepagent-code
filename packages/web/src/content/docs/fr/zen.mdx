...
| ---------------------- | ---------------------- | ---------------------------------------------------- | --------------------------- |
| GPT 5.5                | gpt-5.5                | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.5 Pro            | gpt-5.5-pro            | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4                | gpt-5.4                | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Pro            | gpt-5.4-pro            | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Mini           | gpt-5.4-mini           | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.4 Nano           | gpt-5.4-nano           | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.3 Codex          | gpt-5.3-codex          | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark    | gpt-5.3-codex-spark    | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.2                | gpt-5.2                | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.2 Codex          | gpt-5.2-codex          | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1                | gpt-5.1                | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex          | gpt-5.1-codex          | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max      | gpt-5.1-codex-max      | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini     | gpt-5.1-codex-mini     | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5                  | gpt-5                  | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5 Codex            | gpt-5-codex            | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| GPT 5 Nano             | gpt-5-nano             | `https://ai.deepagent.ltd/zen/v1/responses`               | `@ai-sdk/openai`            |
| Claude Opus 4.8        | claude-opus-4-8        | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.7        | claude-opus-4-7        | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.6        | claude-opus-4-6        | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.5        | claude-opus-4-5        | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Opus 4.1        | claude-opus-4-1        | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6      | claude-sonnet-4-6      | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5      | claude-sonnet-4-5      | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Sonnet 4        | claude-sonnet-4        | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5       | claude-haiku-4-5       | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5       | claude-3-5-haiku       | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Gemini 3.5 Flash       | gemini-3.5-flash       | `https://ai.deepagent.ltd/zen/v1/models/gemini-3.5-flash` | `@ai-sdk/google`            |
| Gemini 3.1 Pro         | gemini-3.1-pro         | `https://ai.deepagent.ltd/zen/v1/models/gemini-3.1-pro`   | `@ai-sdk/google`            |
| Gemini 3 Flash         | gemini-3-flash         | `https://ai.deepagent.ltd/zen/v1/models/gemini-3-flash`   | `@ai-sdk/google`            |
| Qwen3.7 Max            | qwen3.7-max            | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.7 Plus           | qwen3.7-plus           | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.6 Plus           | qwen3.6-plus           | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| Qwen3.5 Plus           | qwen3.5-plus           | `https://ai.deepagent.ltd/zen/v1/messages`                | `@ai-sdk/anthropic`         |
| DeepSeek V4 Flash      | deepseek-v4-flash      | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiniMax M2.7           | minimax-m2.7           | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiniMax M2.5           | minimax-m2.5           | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| GLM 5.1                | glm-5.1                | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| GLM 5                  | glm-5                  | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Kimi K2.5              | kimi-k2.5              | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Kimi K2.6              | kimi-k2.6              | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Grok Build 0.1         | grok-build-0.1         | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Big Pickle             | big-pickle             | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| MiMo-V2.5 Free         | mimo-v2.5-free         | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| Nemotron 3 Ultra Free  | nemotron-3-ultra-free  | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
| DeepSeek V4 Flash Free | deepseek-v4-flash-free | `https://ai.deepagent.ltd/zen/v1/chat/completions`        | `@ai-sdk/openai-compatible` |
...
```
https://ai.deepagent.ltd/zen/v1/models
```
