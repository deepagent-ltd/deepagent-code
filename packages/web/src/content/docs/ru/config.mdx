...
Файл конфигурации имеет схему, определенную в [**`deepagent-code.ai/config.json`**](https://deepagent-code.ai/config.json).

Конфигурация TUI использует [**`deepagent-code.ai/tui.json`**](https://deepagent-code.ai/tui.json).
