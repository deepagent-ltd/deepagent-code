---
title: SDK
description: Типобезопасный JS-клиент для сервера deepagent-code.
---
...
Создайте экземпляр deepagent-code:
...
Вы можете передать объект конфигурации для настройки поведения. Экземпляр по-прежнему получает ваш `deepagent-code.json`, но вы можете переопределить или добавить встроенную конфигурацию:
...
Если у вас уже есть работающий экземпляр deepagent-code, вы можете создать экземпляр клиента для подключения к нему:
