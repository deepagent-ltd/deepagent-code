...
1. Запустите команду `/connect` в TUI, выберите `DeepAgent Code Zen` и перейдите по адресу [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
...
1. Запустите команду `/connect` в TUI, выберите `DeepAgent Code Go` и перейдите по адресу [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
