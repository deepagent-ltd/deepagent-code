---
title: ปลั๊กอิน
description: เขียนปลั๊กอินของคุณเองเพื่อขยาย DeepAgent Code
---

ปลั๊กอินช่วยให้คุณสามารถขยาย DeepAgent Code ได้โดยเชื่อมโยงกับเหตุการณ์ต่างๆ และปรับแต่งลักษณะการทำงาน คุณสามารถสร้างปลั๊กอินเพื่อเพิ่มคุณสมบัติใหม่ บูรณาการกับบริการภายนอก หรือแก้ไขการทำงานเริ่มต้นของ DeepAgent Code
...
- `.deepagent-code/plugins/` - ​​ปลั๊กอินระดับโครงการ
- `~/.config/deepagent-code/plugins/` - ​​ปลั๊กอินทั่วโลก
...
**ปลั๊กอิน npm** ได้รับการติดตั้งโดยอัตโนมัติโดยใช้ Bun เมื่อเริ่มต้น แพ็คเกจและการขึ้นต่อกันถูกแคชไว้ใน `~/.cache/deepagent-code/node_modules/`
...
1. การกำหนดค่าส่วนกลาง (`~/.config/deepagent-code/deepagent-code.json`)
2. การกำหนดค่าโครงการ (`deepagent-code.json`)
3. ไดเร็กทอรีปลั๊กอินสากล (`~/.config/deepagent-code/plugins/`)
4. ไดเรกทอรีปลั๊กอินโครงการ (`.deepagent-code/plugins/`)
...
DeepAgent Code รัน `bun install` เมื่อเริ่มต้นเพื่อติดตั้งสิ่งเหล่านี้ ปลั๊กอินและเครื่องมือของคุณสามารถนำเข้าได้
...
- `client`: ไคลเอนต์ deepagent-code SDK สำหรับการโต้ตอบกับ AI
...
นี่คือตัวอย่างบางส่วนของปลั๊กอินที่คุณสามารถใช้เพื่อขยาย deepagent-code
...
:::note
หากคุณใช้แอปเดสก์ท็อป DeepAgent Code แอปสามารถส่งการแจ้งเตือนของระบบโดยอัตโนมัติเมื่อมีการตอบกลับพร้อมหรือเมื่อเซสชันเกิดข้อผิดพลาด
:::
...
ป้องกันไม่ให้ deepagent-code อ่านไฟล์ `.env`:
...
ปลั๊กอินยังสามารถเพิ่มเครื่องมือที่กำหนดเองให้กับ deepagent-code:
...
ตัวช่วย `tool` สร้างเครื่องมือแบบกำหนดเองที่สามารถเรียกใช้ deepagent-code ได้ ใช้ฟังก์ชัน Zod schema และส่งกลับคำจำกัดความของเครื่องมือด้วย:
...
เครื่องมือที่คุณกำหนดเองจะพร้อมใช้งานสำหรับ deepagent-code ควบคู่ไปกับเครื่องมือในตัว
...
ระดับ: `debug`, `info`, `warn`, `error` ดู[SDKเอกสารประกอบ](https://deepagent-code.ai/docs/sdk)สำหรับรายละเอียด
