...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`deepagent-code.ai/config.json`**](https://deepagent-code.ai/config.json)

การกำหนดค่า TUI ใช้ [**`deepagent-code.ai/tui.json`**](https://deepagent-code.ai/tui.json)
