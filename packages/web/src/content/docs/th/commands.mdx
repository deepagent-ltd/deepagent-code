...
สร้าง `.deepagent-code/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ DeepAgent Code:
...
- ระดับผู้ใช้ (Global): `~/.config/deepagent-code/commands/`
- ระดับโปรเจ็กต์: `.deepagent-code/commands/`
...
DeepAgent Code มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
