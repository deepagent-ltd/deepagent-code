...
DeepAgent Code มีเอเจนต์สองประเภท: **Primary Agent** (เอเจนต์หลัก) และ **Subagent** (เอเจนต์ย่อย)
...
DeepAgent Code มีเอเจนต์หลักในตัวได้แก่ **Build** และ **Plan**
...
DeepAgent Code มี subagent ในตัวได้แก่ **General**, **Explore** และ **Scout** ดูรายละเอียดด้านล่าง

---

## บิวท์อิน

DeepAgent Code มาพร้อมกับเอเจนต์หลัก 2 ตัวและ subagent ในตัว 3 ตัว
...
เอเจนต์แบบอ่านอย่างเดียวสำหรับค้นคว้าเอกสารภายนอกและ dependency ใช้สิ่งนี้เมื่อคุณต้องการ clone repository ของ dependency เข้าไปใน cache ที่ DeepAgent Code จัดการให้, ตรวจสอบ source code ของไลบรารี, หรือเทียบโค้ดในเครื่องกับ implementation จาก upstream โดยไม่แก้ไข workspace ของคุณ
...
กำหนดค่าเอเจนต์ในไฟล์ `deepagent-code.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/deepagent-code/agents/`
- ระดับโปรเจ็กต์: `.deepagent-code/agents/`
...
หมายเหตุ: DeepAgent Code ค่าเริ่มต้นคือ 0 สำหรับโมเดลส่วนใหญ่ และ 0.55 สำหรับโมเดล Qwen
...
:::tip
หากไม่ได้ระบุโมเดล เอเจนต์จะใช้ [โมเดลเริ่มต้น](/docs/config#models) ของ DeepAgent Code
:::
...
:::tip
ใช้ `deepagent-code models` เพื่อดูรายการตัวเลือกทั้งหมด
:::
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/deepagent-ltd/deepagent-code)
:::
