...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก deepagent-code และไปที่ [deepagent-code.ai/auth](https://deepagent-code.ai/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `DeepAgent Code Go` และไปที่ [deepagent-code.ai/auth](https://deepagent-code.ai/zen)
