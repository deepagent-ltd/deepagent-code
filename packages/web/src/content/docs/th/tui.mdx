---
title: TUI
description: การใช้อินเทอร์เฟซผู้ใช้ terminal DeepAgent Code
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

DeepAgent Code มีอินเทอร์เฟซ terminal แบบโต้ตอบหรือ TUI สำหรับการทำงานในโครงการของคุณด้วย LLM

การรัน DeepAgent Code จะเริ่มต้น TUI สำหรับไดเร็กทอรีปัจจุบัน
...
เมื่อใช้ DeepAgent Code TUI คุณสามารถพิมพ์ `/` ตามด้วยชื่อคำสั่งเพื่อดำเนินการอย่างรวดเร็ว ตัวอย่างเช่น:
...
เพิ่มผู้ให้บริการให้กับ DeepAgent Code ให้คุณเลือกจากผู้ให้บริการที่มีอยู่และเพิ่มคีย์ API
...
ออกจาก DeepAgent Code _นามแฝง_: `/quit`, `/q`
...
สิ่งนี้แยกจาก `deepagent-code.json` ซึ่งกำหนดค่าพฤติกรรมเซิร์ฟเวอร์/รันไทม์
...
- `leader_timeout` - ควบคุมระยะเวลาที่ DeepAgent Code จะรอหลังจากกด leader key ค่าเริ่มต้นคือ `2000`
...
- `sound_pack` - sound pack ID ที่จะใช้ ค่าเริ่มต้นคือ `deepagent-code.default`
