...
เครื่องมืออนุญาตให้ LLM ดำเนินการในโค้ดเบสของคุณ DeepAgent Code มาพร้อมกับชุดเครื่องมือในตัว แต่คุณสามารถขยายได้ด้วย [เครื่องมือที่กำหนดเอง](/docs/custom-tools) หรือ [MCP เซิร์ฟเวอร์](/docs/mcp-servers)
...
นี่คือเครื่องมือในตัวทั้งหมดที่มีอยู่ใน DeepAgent Code
...
:::note
เครื่องมือนี้ใช้ได้เฉพาะเมื่อ `DEEPAGENT_CODE_EXPERIMENTAL_LSP_TOOL=true` (หรือ `DEEPAGENT_CODE_EXPERIMENTAL=true`)
:::
...
:::note
เครื่องมือนี้ใช้ได้เฉพาะเมื่อใช้ผู้ให้บริการ DeepAgent Code หรือเมื่อตัวแปรสภาพแวดล้อม `DEEPAGENT_CODE_ENABLE_EXA` ถูกตั้งค่าเป็นค่าความจริง (เช่น `true` หรือ `1`)

หากต้องการเปิดใช้งานเมื่อเปิดตัว DeepAgent Code:
