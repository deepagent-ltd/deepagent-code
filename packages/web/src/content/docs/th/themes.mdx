...
ด้วย DeepAgent Code คุณสามารถเลือกจากหนึ่งในธีมที่มีอยู่แล้วภายใน ใช้ธีมที่ปรับให้เข้ากับธีม terminal ของคุณ หรือกำหนดธีมที่คุณกำหนดเองได้

ตามค่าเริ่มต้น DeepAgent Code จะใช้ธีม `deepagent-code` ของเราเอง
...
DeepAgent Code มาพร้อมกับธีมในตัวหลายธีม
...
- ต้องการให้ DeepAgent Code ตรงกับรูปลักษณ์ของ terminal
...
DeepAgent Code รองรับระบบธีมที่ใช้ JSON ที่ยืดหยุ่น ซึ่งช่วยให้ผู้ใช้สามารถสร้างและปรับแต่งธีมได้อย่างง่ายดาย
...
2. **ไดเรกทอรีกำหนดค่าผู้ใช้** - กำหนดใน `~/.config/deepagent-code/themes/*.json` หรือ `$XDG_CONFIG_HOME/deepagent-code/themes/*.json`
3. **ไดเรกทอรีรากของโครงการ** - กำหนดไว้ใน `<project-root>/.deepagent-code/themes/*.json`
4. **ไดเร็กทอรีการทำงานปัจจุบัน** - กำหนดใน `./.deepagent-code/themes/*.json`
