...
ทักษะของเจ้าหน้าที่ช่วยให้ DeepAgent Code ค้นพบคำแนะนำที่ใช้ซ้ำได้จาก repo หรือโฮมไดเร็กทอรีของคุณ
...
DeepAgent Code ค้นหาตำแหน่งเหล่านี้:

- การกำหนดค่าโครงการ: `.deepagent-code/skills/<name>/SKILL.md`
- การกำหนดค่าส่วนกลาง: `~/.config/deepagent-code/skills/<name>/SKILL.md`
...
สำหรับเส้นทางภายในโปรเจ็กต์ DeepAgent Code จะเดินขึ้นมาจากไดเร็กทอรีการทำงานปัจจุบันของคุณจนกว่าจะถึงแผนผังงาน git
โดยจะโหลด `skills/*/SKILL.md` ที่ตรงกันใน `.deepagent-code/` และ `.claude/skills/*/SKILL.md` หรือ `.agents/skills/*/SKILL.md` ที่ตรงกันตลอดทาง

คำจำกัดความสากลยังโหลดจาก `~/.config/deepagent-code/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` และ `~/.agents/skills/*/SKILL.md`
...
สร้าง `.deepagent-code/skills/git-release/SKILL.md` แบบนี้:
...
DeepAgent Code แสดงรายการทักษะที่มีอยู่ในคำอธิบายเครื่องมือ `skill`
...
ควบคุมว่าตัวแทนทักษะใดสามารถเข้าถึงโดยใช้สิทธิ์ตามรูปแบบใน `deepagent-code.json`:
...
**สำหรับตัวแทนในตัว** (ใน `deepagent-code.json`):
