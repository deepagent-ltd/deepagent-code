---
title: SDK
description: Type-safe JS client for deepagent-code server.
---

import config from "../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

The deepagent-code JS/TS SDK provides a type-safe client for interacting with the server.
Use it to build integrations and control deepagent-code programmatically.
...
Create an instance of deepagent-code:
...
You can pass a configuration object to customize behavior. The instance still picks up your `deepagent-code.json`, but you can override or add configuration inline:
...
The former `createOpencode*` helpers remain available as compatibility aliases.

## Client only

If you already have a running instance of deepagent-code, you can create a client instance to connect to it:
