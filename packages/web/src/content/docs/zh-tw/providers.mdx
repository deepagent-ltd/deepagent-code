...
1. 在 TUI 中執行 `/connect` 指令，選擇 `DeepAgent Code Zen`，然後前往 [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `DeepAgent Code Go`，然後前往 [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen)。
