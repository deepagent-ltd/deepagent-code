...
Ajan becerileri, deepagent-code'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
deepagent-code su konumlari tarar:

- Proje konfigurasyonu: `.deepagent-code/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/deepagent-code/skills/<name>/SKILL.md`
...
Proje yerel yollarinda deepagent-code, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.deepagent-code/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/deepagent-code/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.deepagent-code/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
deepagent-code, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`deepagent-code.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`deepagent-code.json` icinde):
