---
title: Zen
description: deepagent-code tarafından sağlanan seçilmiş modeller listesi.
---
...
DeepAgent Code Zen, DeepAgent Code ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

Zen, DeepAgent Code'daki diğer sağlayıcılar gibi çalışır. DeepAgent Code Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve DeepAgent Code kullanmak için buna ihtiyacınız yoktur.
...
:::tip
DeepAgent Code ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
DeepAgent Code Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

DeepAgent Code Zen, DeepAgent Code'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>DeepAgent Code Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, DeepAgent Code Zen'i seçin ve API anahtarınızı yapıştırın.
...
DeepAgent Code yapılandırmanızdaki [model id](/docs/config/#models) `deepagent-code/<model-id>` biçimini kullanır. Örneğin, GPT 5.5 için yapılandırmanızda `deepagent-code/gpt-5.5` kullanırsınız.
...
- DeepSeek V4 Flash Free, sınırlı bir süre için DeepAgent Code'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo-V2.5 Free, sınırlı bir süre için DeepAgent Code'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Ultra Free, sınırlı bir süre için DeepAgent Code'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için DeepAgent Code'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
DeepAgent Code Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca DeepAgent Code ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
