---
title: Paylasim
description: deepagent-code konusmalarini genel baglantilarla paylasin.
---

deepagent-code'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda deepagent-code:
...
deepagent-code, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak deepagent-code manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `deepagent-code.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda deepagent-code kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
