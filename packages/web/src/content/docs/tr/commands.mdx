...
`.deepagent-code/commands/test.md` oluştur:
...
deepagent-code işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

deepagent-code [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/deepagent-code/commands/`
- Proje başına: `.deepagent-code/commands/`
...
deepagent-code, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
