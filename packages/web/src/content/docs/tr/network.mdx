...
deepagent-code, kurumsal ağ ortamları için standart proxy ortam değişkenlerini ve özel sertifikaları destekler.

---

## Vekil Sunucu

deepagent-code respects standard proxy environment variables.
...
Kuruluşunuz HTTPS bağlantıları için özel CA'lar kullanıyorsa, deepagent-code'u bunlara güvenecek şekilde yapılandırın.
