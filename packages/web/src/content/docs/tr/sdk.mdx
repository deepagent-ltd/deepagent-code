---
title: SDK
description: deepagent-code sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

deepagent-code JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
deepagent-code'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir deepagent-code örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `deepagent-code.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir deepagent-code örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
