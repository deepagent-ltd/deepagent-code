...
Create `.deepagent-code/commands/test.md`:
...
You can add custom commands through the DeepAgent Code config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your DeepAgent Code [config](/docs/config):
...
- Per-project: `.deepagent-code/commands/`
...
deepagent-code includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
