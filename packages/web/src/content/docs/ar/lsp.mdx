---
title: خوادم LSP
description: يتكامل DeepAgent Code مع خوادم LSP لديك.
---

يمكن أن يتكامل DeepAgent Code مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي DeepAgent Code مع عدة خوادم LSP مدمجة للغات الشائعة:
...
:::note
يمكنك تعطيل تنزيلات خوادم LSP التلقائية عبر ضبط متغير البيئة `DEEPAGENT_CODE_DISABLE_LSP_DOWNLOAD` على `true`.
:::
...
عند تفعيل LSP وفتح deepagent-code لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات deepagent-code.
