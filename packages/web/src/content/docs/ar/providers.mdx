...
1. شغّل الأمر `/connect` في TUI، واختر deepagent-code، ثم انتقل إلى [deepagent-code.ai/auth](https://deepagent-code.ai/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `DeepAgent Code Go`، ثم انتقل إلى [deepagent-code.ai/auth](https://deepagent-code.ai/zen).
