...
يوفّر DeepAgent Code قائمة باختصارات لوحة المفاتيح يمكنك تخصيصها عبر إعدادات DeepAgent Code.
...
يستخدم DeepAgent Code مفتاح `leader` لمعظم اختصارات لوحة المفاتيح. يساعد ذلك على تجنّب التعارضات في terminal لديك.
...
يدعم حقل إدخال الموجّه في تطبيق DeepAgent Code لسطح المكتب اختصارات شائعة لتحرير النص على نمط Readline/Emacs. هذه الاختصارات مدمجة حاليا ولا يمكن تخصيصها عبر `deepagent-code.json`.
