---
title: Deling
description: Del dine DeepAgent Code-samtaler.
---

DeepAgent Codes delingsfunksjon lar deg lage offentlige lenker til dine DeepAgent Code-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, DeepAgent Code:
...
DeepAgent Code støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger DeepAgent Code manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `deepagent-code.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av deepagent-code i organisasjonen din.
