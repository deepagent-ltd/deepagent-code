---
title: TUI
description: Brug af DeepAgent Code-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

DeepAgent Code giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre DeepAgent Code starter TUI for den nuværende mappe.
...
Når du bruger DeepAgent Code TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til DeepAgent Code. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut DeepAgent Code. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `deepagent-code.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe DeepAgent Code venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `deepagent-code.default`.
