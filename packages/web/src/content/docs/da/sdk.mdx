...
Brug den til at bygge integrasjoner og kontrollere deepagent-code programmatisk.
...
Opret en forekomst av deepagent-code:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `deepagent-code.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av deepagent-code, kan du oprete en klientforekomst for at koble til den:
