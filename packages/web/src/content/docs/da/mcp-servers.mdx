...
Du kan definere MCP-servere i din [DeepAgent Code Config](https://ai.deepagent.ltd/docs/config/) under `mcp`. Tilføj hver MCP med et unikt navn. Du kan henvise til denne MCP ved navn, når du spørger LLM.
