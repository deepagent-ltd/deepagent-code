...
1. Kør kommandoen `/connect` i TUI, vælg deepagent-code og gå til [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `DeepAgent Code Go`, og gå til [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
