...
description: Opret værktøjer, som LLM kan kalde deepagent-code ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med deepagent-code's [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.deepagent-code/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/deepagent-code/tools/`.
