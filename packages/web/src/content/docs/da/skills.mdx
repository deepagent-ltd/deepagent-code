...
Agentferdigheter lar DeepAgent Code oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går DeepAgent Code opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
DeepAgent Code viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `deepagent-code.json`:
