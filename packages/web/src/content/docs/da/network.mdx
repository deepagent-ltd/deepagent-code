...
DeepAgent Code understøtter standard proxymiljøvariabler og brugerdefinerede certifikater til virksomhedsnetværksmiljøer.

---

## Proxy

DeepAgent Code respekterer standard proxy-miljøvariabler.
...
Hvis din virksomhed bruger tilpassede CA'er til HTTPS-forbindelser, skal du konfigurere DeepAgent Code til at stole på dem.
