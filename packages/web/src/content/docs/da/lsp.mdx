---
title: LSP-servere
description: DeepAgent Code integreres med dine LSP-servere.
---

DeepAgent Code kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

DeepAgent Code leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `DEEPAGENT_CODE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og deepagent-code åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din deepagent-code-konfiguration.
