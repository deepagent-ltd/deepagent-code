...
Crear `.deepagent-code/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración DeepAgent Code o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su DeepAgent Code [config](/docs/config):
...
- Por proyecto: `.deepagent-code/commands/`
...
deepagent-code incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
