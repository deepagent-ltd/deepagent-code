...
1. Ejecute el comando `/connect` en TUI, seleccione deepagent-code y diríjase a [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `DeepAgent Code Go` y diríjase a [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
