---
title: SDK
description: Cliente JS con seguridad de tipos para el servidor deepagent-code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

El SDK deepagent-code JS/TS proporciona un cliente con seguridad de tipos para interactuar con el servidor.
Úselo para crear integraciones y controlar deepagent-code mediante programación.
...
Cree una instancia de deepagent-code:
...
Puede pasar un objeto de configuración para personalizar el comportamiento. La instancia aún recoge su `deepagent-code.json`, pero puede anular o agregar configuración en línea:
...
Si ya tiene una instancia en ejecución de deepagent-code, puede crear una instancia de cliente para conectarse a ella:
