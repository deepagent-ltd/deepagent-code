...
Si tienes rendimiento lento, problemas de acceso a archivos o problemas de terminal en Windows, asegúrate de usar una versión nativa reciente; consulta la [guía de Windows](/docs/windows).
