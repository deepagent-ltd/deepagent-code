---
title: Zen
description: Lista seleccionada de modelos proporcionada por DeepAgent Code.
---
...
DeepAgent Code Zen es una lista de modelos probados y verificados proporcionada por el equipo de DeepAgent Code.

Zen funciona como cualquier otro proveedor en DeepAgent Code. Inicias sesión en DeepAgent Code Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con DeepAgent Code.
:::
...
DeepAgent Code Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

DeepAgent Code Zen funciona como cualquier otro proveedor en DeepAgent Code.

1. Inicias sesión en **<a href={console}>DeepAgent Code Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas DeepAgent Code Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de DeepAgent Code
usa el formato `deepagent-code/<model-id>`. Por ejemplo, para GPT 5.5, usarías
`deepagent-code/gpt-5.5` en tu configuración.
...
- DeepSeek V4 Flash Free está disponible en DeepAgent Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo-V2.5 Free está disponible en DeepAgent Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Ultra Free está disponible en DeepAgent Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en DeepAgent Code por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
Creamos DeepAgent Code Zen para:
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con DeepAgent Code.
