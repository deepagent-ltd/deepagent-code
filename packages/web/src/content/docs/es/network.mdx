...
DeepAgent Code admite variables de entorno de proxy estándar y certificados personalizados para entornos de red empresarial.

---

## Proxy

DeepAgent Code respeta las variables de entorno de proxy estándar.
...
Si su empresa utiliza CA personalizadas para conexiones HTTPS, configure DeepAgent Code para confiar en ellas.
