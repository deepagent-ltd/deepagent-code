---
title: Compartir
description: Comparte tus conversaciones DeepAgent Code.
---

La función para compartir de DeepAgent Code te permite crear enlaces públicos a tus conversaciones de DeepAgent Code, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, DeepAgent Code:
...
DeepAgent Code admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, DeepAgent Code usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `deepagent-code.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de deepagent-code en su organización.
