...
Puede definir servidores MCP en su [DeepAgent Code Config](https://ai.deepagent.ltd/docs/config/) en `mcp`. Agregue cada MCP con un nombre único. Puede referirse a ese MCP por su nombre cuando solicite el LLM.
