---
title: SDK
description: Typesikker JS-klient for DeepAgent Code-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

DeepAgent Code JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere DeepAgent Code programmatisk.
...
Opprett en forekomst av DeepAgent Code:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `deepagent-code.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av DeepAgent Code, kan du opprette en klientforekomst for å koble til den:
