...
description: Lag verktøy som LLM kan kalle inn DeepAgent Code.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med DeepAgent Code sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.deepagent-code/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/deepagent-code/tools/`.
