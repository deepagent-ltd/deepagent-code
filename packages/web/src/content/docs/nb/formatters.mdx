---
title: Formattere
description: DeepAgent Code bruker språkspesifikke formattere.
---

DeepAgent Code formaterer automatisk filer etter at de er skrevet eller redigert ved hjelp av språkspesifikke formattere. Dette sikrer at koden som genereres følger kodestilene til prosjektet ditt.

---

## Innebygde formattere

DeepAgent Code kommer med flere innebygde formattere for populære språk og rammeverk. Nedenfor er en liste over formattere, støttede filendelser og kommandoer eller konfigurasjonsalternativer den krever.
...
Så hvis prosjektet ditt har `prettier` i `package.json`, vil DeepAgent Code automatisk bruke det.

---

## Slik fungerer det

Når DeepAgent Code skriver eller redigerer en fil, gjør den:
...
Du kan tilpasse formattere gjennom `formatter`-delen i DeepAgent Code-konfigurasjonen.
