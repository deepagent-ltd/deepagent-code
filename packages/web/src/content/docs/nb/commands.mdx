...
Opprett `.deepagent-code/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom DeepAgent Code-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i DeepAgent Code [config](/docs/config):
...
- Per prosjekt: `.deepagent-code/commands/`
...
DeepAgent Code inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
