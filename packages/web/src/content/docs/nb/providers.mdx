...
1. Kjør kommandoen `/connect` i TUI, velg `DeepAgent Code Zen` og gå til [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `DeepAgent Code Go`, og gå til [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
