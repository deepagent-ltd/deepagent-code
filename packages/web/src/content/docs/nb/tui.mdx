---
title: TUI
description: Bruke deepagent-code-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

DeepAgent Code gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre DeepAgent Code starter TUI for gjeldende katalog.
...
Når du bruker DeepAgent Code TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til DeepAgent Code. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt DeepAgent Code. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `deepagent-code.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge DeepAgent Code venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `deepagent-code.default`.
