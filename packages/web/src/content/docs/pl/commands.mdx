...
Utwórz `.deepagent-code/commands/test.md`:
...
Możesz zdefiniować polecenia w `deepagent-code.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji deepagent-code:
...
- Globalnie: `~/.config/deepagent-code/commands/`
- Na projekt: `.deepagent-code/commands/`
...
deepagent-code zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
