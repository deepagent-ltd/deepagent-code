...
1. Uruchom polecenie `/connect` w TUI, wybierz `DeepAgent Code Zen` i przejdź do [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `DeepAgent Code Go` i przejdź do [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
