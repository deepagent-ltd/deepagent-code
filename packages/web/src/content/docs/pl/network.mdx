...
deepagent-code obsługa standardowego zmiennego proxy i certyfikatów dla usług sieciowych przedsiębiorstw.

---

## Pełnomocnik

deepagent-code respektuje standardowe zmienne środowiskowe proxy.
...
Jeśli Twoje przedsiębiorstwo korzysta z niestandardowych usług, urzędów dostępu do HTTPS, skonfiguruj deepagent-code tak, aby im ufać.
