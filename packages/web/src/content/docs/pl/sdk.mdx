---
title: SDK
description: Typowany klient JS dla serwera DeepAgent Code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS DeepAgent Code zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli DeepAgent Code.
...
Utwórz instancję DeepAgent Code:
...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `deepagent-code.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
...
Jeśli masz już działającą instancję DeepAgent Code, możesz utworzyć instancję klienta, aby się z nią połączyć:
