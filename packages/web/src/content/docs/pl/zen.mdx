---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez DeepAgent Code.
---
...
DeepAgent Code Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół DeepAgent Code.

Zen działa jak każdy inny dostawca w DeepAgent Code. Logujesz się do DeepAgent Code Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z DeepAgent Code.
:::
...
DeepAgent Code Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

DeepAgent Code Zen działa jak każdy inny dostawca w DeepAgent Code.

1. Logujesz się do **<a href={console}>DeepAgent Code Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz DeepAgent Code Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji DeepAgent Code używa formatu
`deepagent-code/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`deepagent-code/gpt-5.5`.
...
- DeepSeek V4 Flash Free jest dostępny w DeepAgent Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo-V2.5 Free jest dostępny w DeepAgent Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w DeepAgent Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w DeepAgent Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy DeepAgent Code Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w DeepAgent Code także dowolnego innego dostawcy.
