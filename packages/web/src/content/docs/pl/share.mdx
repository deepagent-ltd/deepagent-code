---
title: Udostępnianie
description: Udostępnij swoje rozmowy dotyczące deepagent-code.
---

Funkcja udostępniania deepagent-code umożliwia tworzenie publicznych linków do konwersacji deepagent-code, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.
...
Kiedy udostępniasz rozmowę, deepagent-code:
...
deepagent-code obsługuje trzy tryby udostępniania, które kontrolują sposób udostępniania rozmów:

---

### Ręczne (domyślne)

Domyślnie deepagent-code korzysta z ręcznego trybu udostępniania. Sesje nie są udostępniane automatycznie, ale możesz je udostępnić ręcznie za pomocą polecenia `/share`:
...
Aby wymusić to w całym zespole dla danego projektu, dodaj go do `deepagent-code.json` w swoim projekcie i sprawdź w Git.
...
[Dowiedz się więcej](/docs/enterprise) o używaniu deepagent-code w Twojej organizacji.
