---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala deepagent-code.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

deepagent-code zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie deepagent-code uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI deepagent-code, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do deepagent-code. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij deepagent-code. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `deepagent-code.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo DeepAgent Code czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `deepagent-code.default`.
