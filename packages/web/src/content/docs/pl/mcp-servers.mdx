...
Dostępny serwery MCP w [deepagent-code Config](https://ai.deepagent.ltd/docs/config/) w `mcp`. Dodaj każdy MCP z unikalną nazwą. Możesz zgłosić się do tego MCP po nazwie, pytając LLM.
