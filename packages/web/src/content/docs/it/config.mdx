...
Il file di configurazione ha uno schema definito in [**`deepagent-code.ai/config.json`**](https://deepagent-code.ai/config.json).

La configurazione TUI usa [**`deepagent-code.ai/tui.json`**](https://deepagent-code.ai/tui.json).
