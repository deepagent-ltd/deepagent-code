...
Puoi definire server MCP nella tua [DeepAgent Code Config](https://ai.deepagent.ltd/docs/config/) sotto `mcp`. Aggiungi ogni MCP con un nome univoco. Puoi riferirti a quell'MCP per nome quando fai prompt all'LLM.
