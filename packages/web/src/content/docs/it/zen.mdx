---
title: Zen
description: Lista curata di modelli fornita da DeepAgent Code.
---
...
DeepAgent Code Zen è un elenco di modelli testati e verificati forniti dal team di DeepAgent Code.

Zen funziona come qualsiasi altro provider in DeepAgent Code. Accedi a DeepAgent Code Zen e ottieni
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con DeepAgent Code.
:::
...
DeepAgent Code Zen è un gateway AI che ti dà accesso a questi modelli.

---

## Come funziona

DeepAgent Code Zen funziona come qualsiasi altro provider in DeepAgent Code.

1. Accedi a **<a href={console}>DeepAgent Code Zen</a>**, aggiungi i dettagli di fatturazione,
   e copia la tua chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona DeepAgent Code Zen, e incolla la tua chiave API.
...
Il [model id](/docs/config/#models) nella config di DeepAgent Code
usa il formato `deepagent-code/<model-id>`. Per esempio, per GPT 5.5, useresti
`deepagent-code/gpt-5.5` nella tua config.
...
- DeepSeek V4 Flash Free è disponibile su DeepAgent Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- MiMo-V2.5 Free è disponibile su DeepAgent Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Nemotron 3 Ultra Free è disponibile su DeepAgent Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
- Big Pickle è un modello stealth che è gratuito su DeepAgent Code per un periodo limitato. Il team usa questo periodo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato DeepAgent Code Zen per:
...
4. Non avere **lock-in** permettendoti di usarlo con qualsiasi altro agente di coding. E permettendoti sempre di usare anche qualsiasi altro provider con DeepAgent Code.
