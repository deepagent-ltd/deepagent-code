---
title: SDK
description: Client JS type-safe per il server deepagent-code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

L'SDK JS/TS di deepagent-code fornisce un client type-safe per interagire con il server.
Usalo per creare integrazioni e controllare deepagent-code in modo programmatico.
...
Crea un'istanza di deepagent-code:
...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `deepagent-code.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
...
Se hai gia un'istanza di deepagent-code in esecuzione, puoi creare un client per collegarti:
