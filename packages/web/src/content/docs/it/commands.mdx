...
Crea `.deepagent-code/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di DeepAgent Code o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di DeepAgent Code:
...
- Globale: `~/.config/deepagent-code/commands/`
- Per progetto: `.deepagent-code/commands/`
...
deepagent-code include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
