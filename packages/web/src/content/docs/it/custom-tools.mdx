...
description: Crea strumenti che l'LLM puo chiamare in deepagent-code.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di deepagent-code come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.deepagent-code/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/deepagent-code/tools/`.
