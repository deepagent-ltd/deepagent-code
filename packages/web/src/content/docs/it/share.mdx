---
title: Condivisione
description: Condividi le tue conversazioni DeepAgent Code.
---

La funzione di condivisione di DeepAgent Code ti permette di creare link pubblici alle tue conversazioni, cosi puoi collaborare con i colleghi o chiedere aiuto ad altre persone.
...
Quando condividi una conversazione, DeepAgent Code:
...
DeepAgent Code supporta tre modalita di condivisione che controllano come vengono condivise le conversazioni:

---

### Manuale (predefinito)

Per impostazione predefinita, DeepAgent Code usa la condivisione manuale. Le sessioni non vengono condivise automaticamente, ma puoi condividerle manualmente con il comando `/share`:
...
Per applicarlo al tuo team in un progetto specifico, aggiungilo a `deepagent-code.json` nel progetto e versionalo su Git.
...
[Scopri di piu](/docs/enterprise) su come usare deepagent-code nella tua organizzazione.
