...
예: `.deepagent-code/commands/test.md`
...
커스텀 명령은 DeepAgent Code 설정으로 추가하거나, `commands/` 디렉터리에 Markdown 파일을 만들어 추가할 수 있습니다.

---

### JSON

DeepAgent Code [config](/docs/config)의 `command` 옵션을 사용합니다.
...
- 전역: `~/.config/deepagent-code/commands/`
- 프로젝트별: `.deepagent-code/commands/`
...
DeepAgent Code는 `/init`, `/undo`, `/redo`, `/share`, `/help` 등 여러 내장 명령을 제공합니다. [더 알아보기](/docs/tui#commands).
