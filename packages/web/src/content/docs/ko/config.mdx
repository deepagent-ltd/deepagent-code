...
server/runtime config schema는 [**`deepagent-code.ai/config.json`**](https://deepagent-code.ai/config.json)에 정의되어 있습니다.

TUI config는 [**`deepagent-code.ai/tui.json`**](https://deepagent-code.ai/tui.json)을 사용합니다.
