...
1. TUI에서 `/connect` 명령을 실행하고 `DeepAgent Code Zen`을 선택한 뒤, [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen)로 이동합니다.
...
1. TUI에서 `/connect` 명령을 실행하고 `DeepAgent Code Go`를 선택한 뒤 [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen)로 이동하십시오.
