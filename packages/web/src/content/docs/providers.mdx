...
1. Run the `/connect` command in the TUI, select `DeepAgent Code Zen`, and head to [deepagent-code.ai/auth](https://deepagent-code.ai/zen).
...
1. Run the `/connect` command in the TUI, select `DeepAgent Code Go`, and head to [deepagent-code.ai/auth](https://deepagent-code.ai/zen).
