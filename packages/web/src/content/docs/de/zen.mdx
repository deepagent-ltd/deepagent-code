---
title: Zen
description: Kuratierte Modellliste direkt von DeepAgent Code.
---
...
DeepAgent Code Zen ist eine Liste von getesteten und verifizierten Modellen, die vom DeepAgent Code-Team bereitgestellt wird.

Zen funktioniert wie jeder andere Provider in DeepAgent Code. Du meldest dich bei DeepAgent Code Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um DeepAgent Code zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit DeepAgent Code funktionieren.
:::
...
DeepAgent Code Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

DeepAgent Code Zen funktioniert wie jeder andere Provider in DeepAgent Code.

1. Du meldest dich bei **<a href={console}>DeepAgent Code Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst DeepAgent Code Zen aus und fügst deinen API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner DeepAgent Code-Konfiguration verwendet das Format `deepagent-code/<model-id>`. Für GPT 5.5 würdest du zum Beispiel `deepagent-code/gpt-5.5` in deiner Konfiguration verwenden.
...
- DeepSeek V4 Flash Free ist für begrenzte Zeit auf DeepAgent Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo-V2.5 Free ist für begrenzte Zeit auf DeepAgent Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Ultra Free ist für begrenzte Zeit auf DeepAgent Code verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf DeepAgent Code verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben DeepAgent Code Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit DeepAgent Code auch jeden anderen Provider zu verwenden.
