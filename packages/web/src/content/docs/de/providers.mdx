...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie DeepAgent Code aus und gehen Sie zu [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `DeepAgent Code Go` und gehen Sie zu [ai.deepagent.ltd/auth](https://ai.deepagent.ltd/zen).
