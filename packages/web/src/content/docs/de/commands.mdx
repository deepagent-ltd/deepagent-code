...
Erstellen Sie `.deepagent-code/commands/test.md`:

```md title=".deepagent-code/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die DeepAgent Code-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem DeepAgent Code [config](/docs/config):

```json title="deepagent-code.jsonc" {4-12}
{
...
- Global: `~/.config/deepagent-code/commands/`
- Pro Projekt: `.deepagent-code/commands/`

```markdown title="~/.config/deepagent-code/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".deepagent-code/commands/component.md"
---
...
```md title=".deepagent-code/commands/create-file.md"
---
...
```md title=".deepagent-code/commands/analyze-coverage.md"
---
...
```md title=".deepagent-code/commands/review-changes.md"
---
...
```md title=".deepagent-code/commands/review-component.md"
---
...
DeepAgent Code enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
