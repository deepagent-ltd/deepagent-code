...
Sie können den MCP-Server in Ihrem [DeepAgent Code Config](https://ai.deepagent.ltd/docs/config/) unter `mcp` definieren. Fügen Sie jedem MCP einen eindeutigen Namen hinzu. Sie können bei der Eingabe von LLM namentlich auf diesen MCP verweisen.
