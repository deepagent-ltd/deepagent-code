---
title: Teilen
description: Teile DeepAgent Code-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu DeepAgent Code-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht DeepAgent Code Folgendes:
...
DeepAgent Code hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt DeepAgent Code den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`deepagent-code.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du deepagent-code in deiner Organisation einsetzt.
