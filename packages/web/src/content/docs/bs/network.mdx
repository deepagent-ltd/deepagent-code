...
DeepAgent Code podržava standardne proxy varijable okruženja i prilagođene certifikate za enterprise mrežna okruženja.

## Proksi

DeepAgent Code poštuje standardne varijable proxy okruženja.
...
Ako vaše preduzeće koristi prilagođene CA-ove za HTTPS veze, konfigurirajte DeepAgent Code da im vjeruje.
