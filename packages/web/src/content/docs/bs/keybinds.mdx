...
DeepAgent Code ima listu veza tipki koje možete prilagoditi putem `tui.json`.
...
DeepAgent Code koristi `leader` (vodeću) tipku za većinu povezivanja tipki. Ovo izbjegava sukobe u vašem terminalu.
...
Unos prompta aplikacije DeepAgent Code za desktop podržava uobičajene prečice u stilu Readline/Emacs za uređivanje teksta. One su ugrađene i trenutno se ne mogu konfigurirati putem `deepagent-code.json`.
