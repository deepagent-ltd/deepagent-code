...
Konfiguracijski fajl ima šemu koja je definirana u [**`ai.deepagent.ltd/config.schema.json`**](https://ai.deepagent.ltd/config.schema.json).

TUI konfiguracija koristi [**`ai.deepagent.ltd/tui.json`**](https://ai.deepagent.ltd/tui.json).
