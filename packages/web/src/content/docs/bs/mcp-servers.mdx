...
Možete definirati MCP servere u vašoj [DeepAgent Code Config](https://ai.deepagent.ltd/docs/config/) pod `mcp`. Dodajte svaki MCP sa jedinstvenim imenom. Možete se pozvati na taj MCP po imenu kada tražite LLM.
