...
Kreiraj `.deepagent-code/commands/test.md`:
...
Možete dodati prilagođene komande kroz DeepAgent Code konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom DeepAgent Code [config](/docs/config):
...
- Globalno: `~/.config/deepagent-code/commands/`
- Po projektu: `.deepagent-code/commands/`
...
DeepAgent Code uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
