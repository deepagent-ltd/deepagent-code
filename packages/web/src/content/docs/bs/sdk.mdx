---
title: SDK
description: Type-safe JS klijent za deepagent-code server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

deepagent-code JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
Koristite ga za izradu integracija i programsko upravljanje deepagent-code-om.
...
Kreirajte instancu deepagent-code:
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `deepagent-code.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu deepagent-code instancu, mozete napraviti klijentsku instancu i povezati se na nju:
