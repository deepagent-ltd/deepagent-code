...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite deepagent-code i idite na [deepagent-code.ai/auth](https://deepagent-code.ai/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `DeepAgent Code Go` i idite na [deepagent-code.ai/auth](https://deepagent-code.ai/zen).
