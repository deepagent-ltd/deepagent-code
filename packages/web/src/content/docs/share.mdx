---
title: Share
description: Share your DeepAgent Code conversations.
---

DeepAgent Code's share feature allows you to create public links to your DeepAgent Code conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, DeepAgent Code:
...
DeepAgent Code supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, DeepAgent Code uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `deepagent-code.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using deepagent-code in your organization.
