---
title: Compartilhar
description: Compartilhe suas conversas do deepagent-code.
---

O recurso de compartilhamento do deepagent-code permite que você crie links públicos para suas conversas do deepagent-code, para que você possa colaborar com colegas de equipe ou obter ajuda de outros.
...
Quando você compartilha uma conversa, o deepagent-code:
...
O deepagent-code suporta três modos de compartilhamento que controlam como as conversas são compartilhadas:

---

### Manual (padrão)

Por padrão, o deepagent-code usa o modo de compartilhamento manual. As sessões não são compartilhadas automaticamente, mas você pode compartilhá-las manualmente usando o comando `/share`:
...
Para impor isso em sua equipe para um determinado projeto, adicione-o ao `deepagent-code.json` em seu projeto e faça o check-in no Git.
...
[Saiba mais](/docs/enterprise) sobre como usar o deepagent-code em sua organização.
