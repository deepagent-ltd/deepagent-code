...
Crie `.deepagent-code/commands/test.md`:
...
Você pode adicionar comandos personalizados através da configuração do deepagent-code ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do deepagent-code:
...
- Por projeto: `.deepagent-code/commands/`
...
deepagent-code inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
