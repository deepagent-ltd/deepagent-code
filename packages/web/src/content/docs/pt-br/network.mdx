...
O deepagent-code suporta variáveis de ambiente de proxy padrão e certificados personalizados para ambientes de rede corporativa.

---

## Proxy

O deepagent-code respeita variáveis de ambiente de proxy padrão.
...
Se sua empresa usa CAs personalizadas para conexões HTTPS, configure o deepagent-code para confiá-las.
