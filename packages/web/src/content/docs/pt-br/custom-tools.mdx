...
description: Crie ferramentas que o LLM pode chamar no deepagent-code.
---

Ferramentas personalizadas são funções que você cria e que o LLM pode chamar durante as conversas. Elas funcionam junto com as [ferramentas integradas](/docs/tools) do deepagent-code, como `read`, `write` e `bash`.
...
- Localmente, colocando-as no diretório `.deepagent-code/tools/` do seu projeto.
- Ou globalmente, colocando-as em `~/.config/deepagent-code/tools/`.
