...
O esquema de configuração do servidor/tempo de execução é definido em [**`deepagent-code.ai/config.json`**](https://deepagent-code.ai/config.json).

A configuração do TUI usa [**`deepagent-code.ai/tui.json`**](https://deepagent-code.ai/tui.json).
