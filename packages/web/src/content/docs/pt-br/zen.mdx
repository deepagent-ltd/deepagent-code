---
title: Zen
description: Lista selecionada de modelos fornecidos pelo DeepAgent Code.
---
...
O DeepAgent Code Zen é uma lista de modelos testados e verificados fornecidos pela equipe do DeepAgent Code.

O Zen funciona como qualquer outro provedor no DeepAgent Code. Você faz login no DeepAgent Code Zen e recebe sua chave de API. É **completamente opcional** e você não precisa usá-lo para usar o DeepAgent Code.
...
:::tip
Testamos um grupo selecionado de modelos e provedores que funcionam bem com o DeepAgent Code.
:::
...
O DeepAgent Code Zen é um gateway de AI que dá a você acesso a esses modelos.

---

## Como funciona

O DeepAgent Code Zen funciona como qualquer outro provedor no DeepAgent Code.

1. Você faz login no **<a href={console}>DeepAgent Code Zen</a>**, adiciona seus dados de cobrança e copia sua chave de API.
2. Você executa o comando `/connect` no TUI, seleciona DeepAgent Code Zen e cola sua chave de API.
...
O [model id](/docs/config/#models) na sua configuração do DeepAgent Code usa o formato `deepagent-code/<model-id>`. Por exemplo, para GPT 5.5, você usaria `deepagent-code/gpt-5.5` na sua configuração.
...
- DeepSeek V4 Flash Free está disponível no DeepAgent Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- MiMo-V2.5 Free está disponível no DeepAgent Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Nemotron 3 Ultra Free está disponível no DeepAgent Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
- Big Pickle é um modelo stealth que está gratuito no DeepAgent Code por tempo limitado. A equipe está usando esse período para coletar feedback e melhorar o modelo.
...
Criamos o DeepAgent Code Zen para:
...
4. Não ter **lock-in**, permitindo que você o use com qualquer outro agente de codificação. E sempre permitir que você use qualquer outro provedor com o DeepAgent Code também.
