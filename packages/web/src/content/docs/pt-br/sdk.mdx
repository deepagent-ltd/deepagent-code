---
title: SDK
description: Cliente JS seguro em tipos para o servidor deepagent-code.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do deepagent-code fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o deepagent-code programaticamente.
...
Crie uma instância do deepagent-code:
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `deepagent-code.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do deepagent-code em execução, pode criar uma instância de cliente para se conectar a ela:
