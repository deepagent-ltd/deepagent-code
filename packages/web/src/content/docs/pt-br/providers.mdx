...
1. Execute o comando `/connect` no TUI, selecione `DeepAgent Code Zen` e acesse [ai.deepagent.ltd/zen](https://ai.deepagent.ltd/zen).
...
1. Execute o comando `/connect` no TUI, selecione `DeepAgent Code Go` e acesse [ai.deepagent.ltd/zen](https://ai.deepagent.ltd/zen).
