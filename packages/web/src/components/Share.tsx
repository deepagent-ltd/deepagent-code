...
import type { MessageV2 } from "deepagent-code/session/message-v2"
import type { Message } from "deepagent-code/session/message"
import type { Session } from "deepagent-code/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.deepagent_code_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.deepagent_code_name}>
