...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "DeepAgent Code Documentation", href: "https://deepagent-code.ai/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/lessweb/deepagent-code/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/lessweb/deepagent-code/issues/new?template=bug_report.yml",
      },
    ],
  },
]
