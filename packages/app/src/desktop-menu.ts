...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "DeepAgent Code Documentation", href: "https://ai.deepagent.ltd/" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/deepagent-code" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/deepagent-ltd/deepagent-code/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/deepagent-ltd/deepagent-code/issues/new?template=bug_report.yml",
      },
    ],
  },
]
