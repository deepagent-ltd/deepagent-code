...
import { isSelectableCollaborationMode } from "@/utils/collaboration-mode"
...
export const { use: useLocal, provider: LocalProvider } = createSimpleContext({
  ...
  init: () => {
    ...
    // The composer exposes only the built-in collaboration modes. Custom agents remain a
    // server-side compatibility surface, but must not enter this frontend selection port.
    const list = createMemo(() => sync.data.agent.filter(isSelectableCollaborationMode))
