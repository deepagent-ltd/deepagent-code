/**
 * activity progress projection — spec §7.2 App projection deterministic regression tests (scenarios 20-25,
...
describe("activity progress projection §7.2 App projection — reducer monotonicity (scenarios 20-22)", () => {
  test("20: revision 8 arrives via SSE first, revision 9 after — latest revision 9 is established", () => {
    ...
    // removed in commit 1ae96499 — see message-timeline.activity_progress_projection.test.ts scenario 18 for the
...
describe("activity progress projection §7.2 App projection — trailing forced sync (scenarios 23-24)", () => {
...
describe("activity progress projection §7.2 App projection — pagination determinism (scenario 25)", () => {
