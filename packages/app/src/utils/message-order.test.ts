...
// Regression fixture from BUG-407-012: the 26th wrap of the 6-byte ID time field happened on
...
describe("message order (BUG-407-012 root cause B)", () => {
...
describe("part order (BUG-407-012 root cause B)", () => {
