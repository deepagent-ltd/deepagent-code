...
import { ProjectAvatar } from "@deepagent-code/ui/v2/project-avatar-v2"
        ...
        <Match when={useV2Titlebar()}>
          {(_) => {
            ...
            const openNewTab = async () => {
              ...
              serverSync.createDirSyncContext(directory)
              tabsStoreActions.addSessionTab({
                server: server.key,
                dirBase64,
                sessionId: created.id,
              })
              navigate(`/${dirBase64}/session/${created.id}`)
            }
        ...
        <Match when>
          ...
          >
              ...
              <div class="flex items-center gap-1 shrink-0">
                ...
                <div class="hidden xl:flex items-center shrink-0">
                  ...
                  >
                    ...
                    <div id="deepagent-code-titlebar-left" class="flex items-center gap-3 min-w-0 px-2" />
                    <ChannelIndicator />
                  </div>
                </div>
              </div>
            ...
            <div class="min-w-0 flex items-center justify-center pointer-events-none">
              <div
                id="deepagent-code-titlebar-center"
            ...
            <div
              ...
              onMouseDown={drag}
            >
              <div id="deepagent-code-titlebar-right" class="flex items-center gap-1 shrink-0 justify-end" />
              <Show when={windows()}>
...
function TitlebarV2Right(props: { state: TitlebarV2RightState }) {
  return (
    <div class="relative z-20 flex shrink-0 items-center justify-end gap-0 overflow-visible">
      ...
      <div id="deepagent-code-titlebar-right" class="flex shrink-0 items-center justify-end gap-0" />
    </div>
  )
}
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_DEEPAGENT_CODE_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_DEEPAGENT_CODE_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
