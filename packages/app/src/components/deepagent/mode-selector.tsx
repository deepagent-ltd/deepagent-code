...
import { isCollaborationModeName, type CollaborationModeName } from "@/utils/collaboration-mode"
...
type ModeName = CollaborationModeName
...
const isModeName = isCollaborationModeName
 ...
 * for stale or externally supplied names that have no composer.mode.* key.
 */
