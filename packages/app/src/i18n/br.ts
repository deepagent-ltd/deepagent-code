export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.deepagent-code.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.deepagentCodeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no DeepAgent Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados em deepagent-code.json",
  ...
  "dialog.server.description": "Trocar para qual servidor DeepAgent Code este aplicativo se conecta.",
  ...
  "context.stats.conversationTokens": "Tokens da conversa",
  ...
  "context.usage.totalTokens": "Tokens da conversa",
  ...
  "toast.update.description": "Uma nova versão do DeepAgent Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do DeepAgent Code",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (deepagent-code.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: DeepAgent Code ainda não suporta autenticação MCP.',
  ...
  "session.export.action": "Exportar snapshot",
  "session.export.success": "Snapshot de sessao exportado",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.appearance.description": "Personalize como o DeepAgent Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description":
    "Escolha se o DeepAgent Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o DeepAgent Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o DeepAgent Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do DeepAgent Code.",
  ...
  "settings.providers.section.consoleAccount": "Conta Console",
  "settings.providers.console.activeOrg": "Organização ativa",
  "settings.providers.console.noOrg": "Nenhuma organização selecionada",
  "settings.providers.console.switchOrg": "Trocar organização",
  "settings.providers.console.empty": "Nenhuma organização Console disponível para troca",
  "settings.providers.console.managedCount": "{{count}} provedores gerenciados pelo Console",
  "settings.providers.console.switch.toast.title": "Organização Console trocada",
  "settings.providers.console.switch.toast.description": "Agora usando {{org}}",
  ...
  "settings.providers.tag.configError": "Erro de configuração",
  "settings.providers.error.json": "Erro de sintaxe JSON",
  "settings.providers.error.schema": "Campo(s) inválido(s)",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.snapshot.file": "Pacote de snapshot",
  "settings.import.snapshot.file.hint": "Escolha um pacote de snapshot de sessao exportado (.json). Ele sera importado como uma nova sessao continuavel.",
  "settings.import.snapshot.noFile": "Escolha primeiro um arquivo de pacote de snapshot",
  "settings.import.snapshot.done": "Snapshot importado como uma nova sessao continuavel",
  "settings.import.bundle.file": "Pacote da sessão",
  "settings.import.bundle.file.hint": "Escolha um ZIP da sessão (.zip) ou um snapshot antigo (.json). A importação será um arquivo somente leitura.",
  "settings.import.bundle.done": "Sessão importada como arquivo somente leitura",
  "settings.import.bundle.link": "Link de compartilhamento",
  "settings.import.bundle.link.hint": "Cole um link de compartilhamento de pacote DeepAgent em vez de escolher um arquivo.",
  ...
  "settings.about.product.title": "Produto",
  "settings.about.product.description": "O nome e a versão do aplicativo.",
  "settings.about.attribution.title": "Criado sobre deepagent-code",
  "settings.about.attribution.description": "DeepAgent Code é criado sobre deepagent-code, usado sob a Licença MIT.",
  "settings.about.license.title": "Licença",
  "settings.about.help.title": "Ajuda",
  "settings.about.help.description": "Documentação, guias e suporte.",
  ...
  "settings.general.deepagent.mode.description": "Escolha a intensidade de trabalho do DeepAgent.",
  ...
  "settings.general.deepagent.selfLearning.manual": "Aprovação manual",
  ...
  "settings.general.deepagent.selfLearning.auto": "Aprovação automática",
