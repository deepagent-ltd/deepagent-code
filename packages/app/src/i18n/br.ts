export const dict = {
  ...
  "settings.about.attribution.title": "Criado sobre opencode",
  "settings.about.attribution.description": "DeepAgent Code é criado sobre opencode, usado sob a Licença MIT.",
