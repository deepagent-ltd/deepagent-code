...
export const dict = {
  ...
  "composer.approval.auto": "自动批准",
  "composer.approval.readOnly": "只读",
  "composer.approval.fullAccess": "完全访问",
  "composer.approval.readOnly.desc": "允许读取和搜索，但拒绝编辑和执行命令",
  "composer.approval.request.desc": "编辑文件或运行命令前先请求批准",
  "composer.approval.fullAccess.desc": "无需询问即可编辑文件和运行命令",
