...
export const dict = {
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 DeepAgent Code 服务器。",
  ...
  "wsl.onboarding.finishingDistro": "正在完成 {{distro}} 设置。",
  "wsl.onboarding.pickDistro": "选择一个发行版，或在下方安装。",
  "wsl.onboarding.checkingDeepagentCode": "正在检查 DeepAgent Code...",
  "wsl.onboarding.checkingDeepagentCodeIn": "正在检查 {{distro}} 中的 DeepAgent Code...",
  "wsl.onboarding.updatingDeepagentCode": "正在更新 DeepAgent Code...",
  "wsl.onboarding.updatingDeepagentCodeIn": "正在更新 {{distro}} 中的 DeepAgent Code...",
  "wsl.onboarding.updateDeepagentCodeIn": "更新 {{distro}} 中的 DeepAgent Code。",
  "wsl.onboarding.updateDeepagentCode": "更新 DeepAgent Code",
  "wsl.onboarding.deepagentCodeReadyIn": "{{distro}} 中的 DeepAgent Code 已就绪。",
  "wsl.onboarding.deepagentCodeReady": "DeepAgent Code 已就绪。",
  "wsl.onboarding.installDeepagentCodeIn": "在 {{distro}} 中安装 DeepAgent Code。",
  "wsl.onboarding.installDeepagentCode": "安装 DeepAgent Code",
  ...
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 DeepAgent Code。",
  "wsl.onboarding.next": "下一步",
  "wsl.onboarding.refresh": "刷新",
  "wsl.onboarding.allDistrosAdded": "所有已安装发行版都已添加。",
  ...
  "wsl.onboarding.desktopVersion": "桌面端 {{version}}",
