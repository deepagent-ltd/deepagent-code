...
export const dict = {
  ...
  "prompt.scenario.wish": "许愿",
  "prompt.scenario.direct.tooltip": "直接发送您的提示",
  "prompt.scenario.wish.tooltip": "DeepAgent为您准备提示",
  ...
  "settings.general.deepagent.mode.ultraRequiresWish": "ultra 需要许愿情景模式。",
  ...
  "settings.general.deepagent.prompt.wish": "许愿模式",
  "settings.general.deepagent.prompt.wish.description": "DeepAgent 会先准备完整提示，再由您确认和编辑。",
  "settings.general.deepagent.wishModel.title": "许愿模式模型",
  "settings.general.deepagent.wishModel.description": "选择仅用于准备许愿模式提示草稿的模型。",
