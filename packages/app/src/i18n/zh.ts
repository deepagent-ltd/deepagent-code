...
export const dict = {
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 DeepAgent Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 DeepAgent Code 中使用 {{provider}} 模型。",
  ...
  "review.title": "知识审阅",
  "review.description": "批准或拒绝 DeepAgent 从你的会话中学到的知识。批准后即可被检索；拒绝的知识不参与检索，之后仍可重新批准。",
