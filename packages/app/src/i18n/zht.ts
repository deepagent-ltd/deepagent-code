...
export const dict = {
  ...
  "session.subagents.background": "將執行中的轉為背景",
  "session.subagents.background.done": "子代理已移至背景",
  "session.subagents.background.none": "沒有可背景化的前景子代理",
  ...
  "command.session.export": "匯出會話為 Markdown",
  "command.session.export.description": "下載完整會話記錄為可讀的 .md 檔案",
  "command.session.export.empty": "還沒有可匯出的內容",
  "command.session.fork": "從訊息分支",
  "command.session.fork.description": "從先前的訊息建立新工作階段",
  "command.prompt.stash": "暫存輸入草稿",
  "command.prompt.stash.description": "將目前輸入框草稿暫存，稍後恢復",
  "command.prompt.stash.pop": "恢復最近暫存",
  "command.prompt.stash.pop.description": "恢復最近一次暫存的草稿",
  "command.prompt.stash.list": "瀏覽暫存草稿",
  "command.prompt.stash.list.description": "開啟暫存清單以恢復或刪除草稿",
  "dialog.stash.title": "暫存的草稿",
  "dialog.stash.empty": "暫存為空",
  "dialog.stash.noText": "沒有可暫存的內容",
  "dialog.stash.restore": "恢復到輸入框",
  ...
  "dialog.provider.deepagent-code.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.deepagent-code.tagline": "可靠的優化模型",
  "dialog.provider.deepagent.promptConfirm.title": "確認提示草稿",
  "dialog.provider.deepagent.promptConfirm.mode": "模式",
  "dialog.provider.deepagent.promptConfirm.preview": "草稿預覽",
  "dialog.provider.deepagent.promptConfirm.edit.label": "最終提示",
  "dialog.provider.deepagent.promptConfirm.edit.description": "任務開始前可以編輯這段提示。",
  "dialog.provider.deepagentCodeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "DeepAgent Code 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 DeepAgent Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " 取得授權碼，以連線你的帳戶並在 DeepAgent Code 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 DeepAgent Code 中使用 {{provider}} 模型。",
  ...
  "provider.custom.edit.title": "編輯自訂提供方",
  "provider.custom.specWarning":
    "模型規格（上下文視窗、推理能力）是根據公開目錄自動補全的預設值，僅供參考。若您修改它們，我們無法保證模型仍能正常使用。",
  ...
  "provider.custom.models.temperature.label": "溫度",
  ...
  "composer.mode.loop": "目標",
  "composer.mode.design": "設計",
  "composer.mode.auto.desc": "智能體自行定目標、做計劃並執行到完成",
  "composer.mode.loop.desc": "你說需求，智能體生成 goal+plan.md，再由監督循環自主執行到達成",
  "composer.mode.design.desc": "你自己寫好 goal+plan.md，智能體讀取並忠實執行你的方案",
  "composer.panel.label": "專家團",
  "composer.panel.off": "關閉",
  "composer.panel.single": "單輪評審",
  "composer.panel.multi": "多輪辯論",
  "composer.panel.verdict.title": "專家團裁定",
  "composer.panel.verdict.approve": "批准",
  "composer.panel.verdict.revise": "修訂",
  "composer.panel.verdict.block": "阻止",
  "composer.panel.verdict.needsHuman": "需人工介入",
  "composer.panel.verdict.meta.one": "{{confidence}}% 置信度 · {{rounds}} 輪",
  "composer.panel.verdict.meta.other": "{{confidence}}% 置信度 · {{rounds}} 輪",
  "composer.panel.verdict.evidence": "依據",
  "composer.panel.verdict.dissent": "異議（已被否決）",
  "composer.goal.phase.running": "執行中",
  "composer.goal.phase.paused": "已暫停",
  "composer.goal.phase.done": "已完成",
  "composer.goal.phase.needsHuman": "需你處理",
  "composer.goal.phase.rolledBack": "已回滾",
  ...
  "composer.goal.pause": "暫停",
  "composer.goal.resume": "繼續",
  "composer.goal.stop": "停止",
  "composer.goal.dismiss": "忽略",
  "composer.goal.editPlan": "編輯計劃",
  "composer.goal.editPlan.title": "編輯目標計劃",
  "composer.goal.editPlan.desc": "修改正在執行的目標計劃。變更將在下一個 tick 生效。",
  "composer.goal.editPlan.goalLabel": "目標",
  "composer.goal.editPlan.stepsLabel": "步驟",
  "composer.goal.editPlan.addStep": "新增步驟",
  "composer.goal.editPlan.removeStep": "刪除步驟",
  "composer.goal.editPlan.stepPlaceholder": "步驟描述",
  "composer.goal.editPlan.blockedNotePlaceholder": "說明該步驟受阻的原因",
  "composer.goal.editPlan.save": "套用變更",
  "composer.goal.editPlan.confirm": "確認替換",
  "composer.goal.editPlan.cancel": "取消",
  "composer.goal.editPlan.challenge": "這次修改移除了大量計劃細節。請確認要替換目前計劃。",
  "composer.goal.editPlan.saved": "計劃已更新——下一個 tick 生效",
  "composer.goal.editPlan.failed": "無法更新計劃（目標未在執行？）",
  "composer.goal.editPlan.status.pending": "待處理",
  "composer.goal.editPlan.status.active": "進行中",
  ...
  "composer.steer.hint": "工作階段正在執行——你的訊息將引導目前回合",
  ...
  "dialog.plugins.empty": "在 deepagent-code.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 DeepAgent Code 伺服器。",
  ...
  "dialog.server.add.menu.http": "新增 HTTP 伺服器",
  "dialog.server.connect.button": "連線到伺服器",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 DeepAgent Code 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (deepagent-code.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: DeepAgent Code 暫不支援 MCP 認證。',
  ...
  "session.files.heading": "檔案",
  "session.files.newFile": "新增檔案",
  "session.files.newFolder": "新增資料夾",
  "session.files.newFile.placeholder": "檔案名稱",
  "session.files.newFolder.placeholder": "資料夾名稱",
  "session.files.create.confirm": "確認",
  "session.files.create.cancel": "取消",
  "session.files.create.failed": "建立失敗",
  "session.files.createFolder.failed": "建立資料夾失敗",
  "session.panel.oversight": "監督",
  "session.panel.debug": "偵錯",
  "session.panel.profile": "效能分析",
  "session.panel.dev": "開發",
  "oversight.common.refresh": "重新整理",
  "oversight.dashboard.title": "Agent 儀表板",
  "oversight.dashboard.loading": "正在載入指標…",
  "oversight.dashboard.empty": "暫無可用指標。",
  "oversight.metric.taskSuccessRate": "任務成功率",
  "oversight.metric.conflictRate": "衝突率",
  "oversight.metric.dlqEvents": "死信事件",
  "oversight.metric.pushRejected": "推送被拒",
  "oversight.metric.tasksCompleted": "已完成任務",
  "oversight.metric.tasksFailed": "失敗任務",
  "oversight.metric.publishLatencyP50": "發布延遲 P50",
  "oversight.metric.publishLatencyP95": "發布延遲 P95",
  "oversight.metric.eventToAgentP50": "事件→Agent P50",
  "oversight.metric.eventToAgentP95": "事件→Agent P95",
  "oversight.metric.humanTakeovers": "人工接管次數",
  "oversight.metric.rollbacks": "回滾次數",
  "oversight.metric.pushRejectedByReason": "按原因統計的推送拒絕",
  "oversight.metric.window": "時間視窗：{{from}} → {{to}}",
  "oversight.approvals.title": "審批佇列",
  "oversight.approvals.empty": "沒有待審批項。",
  "oversight.approvals.approve": "批准",
  "oversight.approvals.reject": "拒絕",
  "oversight.approvals.acknowledge": "知悉",
  "oversight.approvals.viewTrace": "檢視軌跡",
  "oversight.approvals.resolveFailed": "處理失敗",
  "oversight.trace.title": "事件軌跡",
  "oversight.trace.placeholder": "correlationID…",
  "oversight.trace.action": "追蹤",
  "oversight.trace.loading": "正在載入軌跡…",
  "oversight.trace.empty": "該 correlationID 沒有事件。",
  "oversight.trace.source": "來源：",
  "oversight.trace.causedBy": "起因：",
  "oversight.takeover.title": "人工接管",
  "oversight.takeover.description": "記錄由人工從自主 Agent 處接管（暫停自主性升級）。",
  "oversight.takeover.placeholder": "接管原因…",
  "oversight.takeover.action": "接管",
  "oversight.takeover.recorded": "接管已記錄。",
  ...
  "oversight.rollback.noop": "無內容可回滾——已記錄為空操作。",
  "oversight.rollback.applied": "已回滾——工作階段已還原。",
  "oversight.rollback.notFound": "本工作區內無此工作階段。",
  "oversight.rollback.failed": "失敗：{{error}}",
  ...
  "session.export.action": "匯出快照",
  "session.export.success": "工作階段快照已匯出",
  ...
  "wiki.search": "搜尋頁面與符號",
  "wiki.searchEmpty": "沒有符合的頁面",
  "wiki.empty": "暫無頁面",
  "wiki.loading": "載入中…",
  "wiki.selectPrompt": "選擇一個頁面閱讀",
  "wiki.readOnly": "唯讀",
  ...
  "settings.general.row.language.description": "變更 DeepAgent Code 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 DeepAgent Code 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 DeepAgent Code 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 DeepAgent Code 的主題。",
  ...
  "settings.general.row.expertPanelDefault.title": "預設啟用專家團",
  "settings.general.row.expertPanelDefault.description": "新工作階段預設啟用專家團，其按鈕可隨時對目前上下文發起會診",
  ...
  "settings.updates.row.startup.description": "在 DeepAgent Code 啟動時自動檢查更新",
  ...
  "settings.providers.section.consoleAccount": "Console 帳號",
  "settings.providers.console.activeOrg": "目前組織",
  "settings.providers.console.noOrg": "未選擇組織",
  "settings.providers.console.switchOrg": "切換組織",
  "settings.providers.console.empty": "沒有可切換的 Console 組織",
  "settings.providers.console.managedCount": "{{count}} 個 Console 託管的供應商",
  "settings.providers.console.switch.toast.title": "已切換 Console 組織",
  "settings.providers.console.switch.toast.description": "目前使用 {{org}}",
  ...
  "settings.providers.tag.configError": "設定錯誤",
  "settings.providers.error.json": "JSON 語法錯誤",
  "settings.providers.error.schema": "欄位驗證失敗",
  "settings.models.title": "模型",
  "settings.models.description": "模型設定將在此處可設定。",

  "settings.capabilities.title": "能力",
  "settings.capabilities.catalogTitle": "能力目錄",
  "settings.capabilities.receiptsTitle": "載入收據",
  "settings.capabilities.snapshotTitle": "系統上下文快照",
  "settings.capabilities.empty": "目錄中沒有能力",
  "settings.capabilities.receiptsEmpty": "暫無載入收據",
  "settings.capabilities.loadFailed": "能力目錄載入失敗",
  "settings.capabilities.retry": "重試",
  "settings.capabilities.receiptsState": "已載入",
  "settings.capabilities.snapshotUnavailable": "系統上下文快照不可用",
  "settings.capabilities.digest": "目錄摘要：{{digest}}",
  "settings.capabilities.l0lineCount": "L0 行數：{{count}}",
  "settings.capabilities.digestConsistent": "摘要一致",
  "settings.capabilities.digestInconsistent": "摘要漂移",
  "settings.capabilities.availability.stable": "穩定",
  "settings.capabilities.availability.maintenance_only": "僅維護",
  "settings.capabilities.availability.disabled": "已停用",
  ...
  "settings.general.deepagent.mode.general": "通用",
  "settings.general.deepagent.mode.high": "高",
  "settings.general.deepagent.mode.xhigh": "超高",
  "settings.general.deepagent.mode.max": "最大",
  "settings.general.deepagent.mode.ultra": "極限",
  "settings.section.about": "關於",
  "settings.tab.about": "關於",
  "settings.import.section": "匯入歷史",
  "settings.import.source": "資料來源",
  "settings.import.source.hint": "選擇預設來源，或選擇「自訂」手動輸入路徑。",
  "settings.import.preset.codex": "Codex",
  "settings.import.preset.claude": "Claude Code",
  "settings.import.preset.custom": "自訂",
  "settings.import.preset.deepagent": "DeepAgent Code（快照）",
  "settings.import.snapshot.file": "快照包",
  "settings.import.snapshot.file.hint": "選擇匯出的工作階段快照包（.json），將匯入為新的可接續工作階段。",
  "settings.import.snapshot.noFile": "請先選擇快照包檔案",
  "settings.import.snapshot.done": "快照已匯入為新的可接續工作階段",
  "settings.import.bundle.file": "工作階段封裝檔",
  "settings.import.bundle.file.hint": "選擇工作階段 ZIP（.zip）或舊版快照（.json）；匯入後將成為唯讀封存。",
  "settings.import.bundle.done": "工作階段已匯入為唯讀封存",
  "settings.import.bundle.link": "分享連結",
  "settings.import.bundle.link.hint": "貼上 DeepAgent 封裝檔的分享連結，無須選擇檔案。",
  "settings.import.customPath": "路徑",
  "settings.import.customPath.hint": "Agent 資料目錄的絕對路徑。",
  "settings.import.scope": "匯入內容",
  "settings.import.scope.hint": "選擇一個或多個類別。",
  "settings.import.scope.session": "聊天歷史",
  "settings.import.scope.memory": "記憶",
  "settings.import.scope.skill": "技能",
  "settings.import.dryRun": "試執行",
  "settings.import.dryRun.hint": "僅解析與映射，不寫入任何內容。",
  "settings.import.copyLiveDb": "快照主庫",
  "settings.import.copyLiveDb.hint": "寫入主庫的副本（推薦），而非直接寫主庫。",
  "settings.import.cwdFilter": "目錄過濾",
  "settings.import.cwdFilter.hint": "僅匯入目錄以該前綴開頭的工作階段。",
  "settings.import.run.btn": "匯入",
  "settings.import.running": "匯入中…",
  "settings.import.cancel": "取消",
  "settings.import.result": "結果",
  "settings.import.log": "進度",
  "settings.about.product.title": "產品",
  "settings.about.product.description": "應用程式名稱與版本。",
  "settings.about.attribution.title": "基於 deepagent-code 建置",
  "settings.about.attribution.description": "DeepAgent Code 基於 deepagent-code 建置，並依 MIT 授權條款使用。",
  "settings.about.license.title": "授權",
  "settings.about.help.title": "說明",
  "settings.about.help.description": "文件、指南與支援。",
  "settings.general.section.advanced": "進階",
  "settings.general.section.deepagent": "DeepAgent",
  "settings.general.deepagent.mode.title": "智能體",
  "settings.general.deepagent.mode.description": "選擇 DeepAgent 的工作強度。",
  "settings.general.deepagent.mode.ultraRequiresIntelligence": "ultra 需要使用智能場景模式。",
  "settings.general.deepagent.subagentMode.title": "子智能體",
  "settings.general.deepagent.subagentMode.description": "選擇子智能體相對於主智能體的工作強度。",
  "settings.general.deepagent.subagentMode.inherit": "繼承父級",
  "settings.general.deepagent.subagentMode.downgrade": "降低一級",
  "settings.general.deepagent.prompt.title": "場景模式",
  "settings.general.deepagent.prompt.description": "選擇傳送前輸入器如何處理你的提示。",
  "settings.general.deepagent.prompt.direct": "直接模式",
  "settings.general.deepagent.prompt.direct.description": "依原文傳送提示，不讓 DeepAgent 先準備草稿。",
  "settings.general.deepagent.prompt.intelligence": "智能模式",
  "settings.general.deepagent.prompt.intelligence.description": "DeepAgent 先準備完整提示，再讓你審閱和編輯。",
  "settings.general.deepagent.intelligenceModel.title": "智能模式模型",
  "settings.general.deepagent.intelligenceModel.description": "選擇只用於準備智能模式提示草稿的模型。",
  "settings.general.deepagent.selfLearning.title": "自學習審批",
  "settings.general.deepagent.selfLearning.description": "決定 DeepAgent 從會話學到的知識如何變成可檢索內容。",
  "settings.general.deepagent.selfLearning.manual": "手動審批",
  "settings.general.deepagent.selfLearning.manual.description": "學到的知識會等待你在審閱中批准。",
  "settings.general.deepagent.selfLearning.auto": "自動審批",
  "settings.general.deepagent.selfLearning.auto.description": "學到的知識會立即變成可檢索內容，無需審閱。",
  "settings.general.row.shell.title": "終端 Shell",
  "settings.general.row.shell.description": "選擇終端使用的 shell。相容的 shell 也會用於智能體工具呼叫。",
  ...
  "settings.general.row.showFileTree.description": "在桌面會話中顯示檔案樹面板",
  "settings.general.row.showNavigation.title": "導覽控制",
  "settings.general.row.showNavigation.description": "在桌面標題列顯示返回和前進按鈕",
  "settings.general.row.showSearch.title": "命令面板",
  "settings.general.row.showSearch.description": "在桌面標題列顯示搜尋和命令面板按鈕",
  "settings.general.row.showTerminal.title": "終端",
  "settings.general.row.showTerminal.description": "在桌面標題列顯示終端按鈕",
  "settings.general.row.showStatus.title": "伺服器狀態",
  "settings.general.row.showStatus.description": "在桌面標題列顯示伺服器狀態按鈕",
  "settings.general.row.showCustomAgents.title": "自訂智能體",
  "settings.general.row.showCustomAgents.description": "在 v2 桌面輸入器中顯示智能體選擇器",
  "settings.general.row.newLayoutDesigns.title": "新版布局和設計",
  ...
  "session.context.title": "上下文證據",
  "session.stats.title": "用量與成本",
  "session.stats.currentSession": "目前會話",
  "session.stats.allSessions": "全部會話",
  "session.context.status": "四圖狀態",
  "session.context.artifact": "稽核製品",
  "session.context.evidence": "本輪證據",
  "session.context.metrics": "圖診斷",
  "session.context.shadow": "影子對比",
  "session.context.noSelection": "此工作階段尚無聯邦上下文選擇。",
  "session.context.noEvidence": "本輪未選擇證據。",
  "session.context.loadFailed": "無法載入上下文診斷。",
  "session.context.resolveFailed": "處理 Provider attempt 失敗",
  "session.context.indeterminate": "Provider 結果不確定",
  "session.context.reason": "稽核原因",
  "session.context.replayRisk": "我確認 replay 可能重複外部副作用。",
  "session.context.abandon": "放棄 attempt",
  "session.context.settle": "根據持久化證據標記已完成",
  "session.context.replay": "確認風險並 replay",
  "session.context.copyRef": "複製穩定引用",
  "session.context.provenance": "來源",
  "session.context.relations": "關聯",
  ...
  "session.context.artifact.degraded_unavailable": "稽核不可用",
  "session.context.artifact.expired": "已過期",
  "session.context.artifact.unavailable": "不可用",
  "session.context.state.ready": "就緒",
  "session.context.state.empty": "無命中",
  "session.context.state.current": "目前",
  "session.context.state.historical": "歷史",
  "session.context.state.expired": "已過期",
  "session.context.state.superseded": "已取代",
  "session.context.state.conflict": "衝突",
  "session.context.state.unknown": "未知",
  "session.context.state.cold": "冷啟動",
  "session.context.state.indexing": "索引中",
  "session.context.state.stale": "陳舊",
  "session.context.state.degraded": "降級",
  ...
  // W-02 M-6 — 遷移進行中的維護殼視圖（相位進度 + 復原指引）。
  "maintenance.migration.title": "資料遷移進行中",
  "maintenance.migration.progress": "已完成 {{done}}/{{total}} 個階段",
  "maintenance.migration.pending": "正在取得遷移狀態…",
  "maintenance.migration.completed.title": "遷移已完成",
  "maintenance.migration.failed.title": "遷移已停止 — 需要處理",
  "maintenance.migration.unavailable": "遷移狀態未知",
  "maintenance.migration.resume": "恢復遷移",
  "maintenance.migration.resuming": "恢復中…",
  "maintenance.migration.readonly.title": "遷移已暫停 — 唯讀維護",
  "maintenance.migration.readonly.description": "此檢視不允許寫入會話或執行模型。可檢查備份，也可返回遷移狀態。",
  "maintenance.migration.readonly.exit": "進入唯讀維護",
  "maintenance.migration.readonly.return": "返回遷移狀態",
  "maintenance.migration.phase.md_export": "匯出會話記錄（Markdown）",
  "maintenance.migration.phase.backup_create": "建立一致性備份",
  "maintenance.migration.phase.backup_verify": "驗證備份",
  "maintenance.migration.phase.migration_apply": "套用資料庫遷移",
  "maintenance.migration.phase.post_verify": "遷移後驗證",
  "maintenance.migration.phase.archive": "寫入封存記錄",
  "maintenance.migration.phase.disk_advisory": "磁碟用量建議",
  "maintenance.migration.state.pending": "待執行",
  "maintenance.migration.state.running": "進行中…",
  "maintenance.migration.state.completed": "已完成",
  "maintenance.migration.state.failed": "失敗",
