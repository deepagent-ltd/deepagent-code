...
export const dict = {
  ...
  "settings.general.deepagent.mode.ultraRequiresWish": "ultra 需要使用許願場景模式。",
  ...
  "settings.general.deepagent.prompt.wish": "許願模式",
  "settings.general.deepagent.prompt.wish.description": "DeepAgent 先準備完整提示，再讓你審閱和編輯。",
  "settings.general.deepagent.wishModel.title": "許願模式模型",
  "settings.general.deepagent.wishModel.description": "選擇只用於準備許願模式提示草稿的模型。",
