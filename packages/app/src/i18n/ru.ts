export const dict = {
  ...
  "settings.about.attribution.title": "Создано на базе opencode",
  "settings.about.attribution.description": "DeepAgent Code создан на базе opencode, используемого по лицензии MIT.",
  ...
  "settings.general.deepagent.mode.ultraRequiresWish": "ultra требует режима сценария wish.",
  ...
  "settings.general.deepagent.wishModel.title": "Модель режима wish",
