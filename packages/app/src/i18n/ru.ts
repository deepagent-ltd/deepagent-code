export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.deepagent-code.tagline": "Надежные оптимизированные модели",
  "dialog.provider.deepagentCodeGo.tagline": "Доступная подписка для всех",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в DeepAgent Code.",
  ...
  "dialog.plugins.empty": "Плагины настроены в deepagent-code.json",
  ...
  "dialog.server.description": "Переключите сервер DeepAgent Code к которому подключается приложение.",
  ...
  "context.stats.conversationTokens": "Токены беседы",
  ...
  "context.usage.totalTokens": "Токены беседы",
  ...
  "toast.update.description": "Новая версия DeepAgent Code ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде DeepAgent Code",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (deepagent-code.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что DeepAgent Code пока не поддерживает MCP авторизацию.',
  ...
  "session.export.action": "Экспортировать снапшот",
  "session.export.success": "Снапшот сессии экспортирован",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.appearance.description": "Настройте как DeepAgent Code выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description":
    "Выберите, следует ли DeepAgent Code системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление DeepAgent Code.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске DeepAgent Code",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию DeepAgent Code.",
  ...
  "settings.providers.section.consoleAccount": "Аккаунт Console",
  "settings.providers.console.activeOrg": "Активная организация",
  "settings.providers.console.noOrg": "Организация не выбрана",
  "settings.providers.console.switchOrg": "Сменить организацию",
  "settings.providers.console.empty": "Нет доступных для переключения организаций Console",
  "settings.providers.console.managedCount": "Провайдеров под управлением Console: {{count}}",
  "settings.providers.console.switch.toast.title": "Организация Console изменена",
  "settings.providers.console.switch.toast.description": "Теперь используется {{org}}",
  ...
  "settings.providers.tag.configError": "Ошибка конфигурации",
  "settings.providers.error.json": "Ошибка синтаксиса JSON",
  "settings.providers.error.schema": "Недопустимые поля",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code (снапшот)",
  "settings.import.snapshot.file": "Пакет снапшота",
  "settings.import.snapshot.file.hint": "Выберите экспортированный пакет снапшота сессии (.json). Он будет импортирован как новая возобновляемая сессия.",
  "settings.import.snapshot.noFile": "Сначала выберите файл пакета снапшота",
  "settings.import.snapshot.done": "Снапшот импортирован как новая возобновляемая сессия",
  "settings.import.bundle.file": "Пакет сеанса",
  "settings.import.bundle.file.hint": "Выберите ZIP сеанса (.zip) или старый снимок (.json). Импорт создаст архив только для чтения.",
  "settings.import.bundle.done": "Сеанс импортирован как архив только для чтения",
  "settings.import.bundle.link": "Ссылка для доступа",
  "settings.import.bundle.link.hint": "Вставьте ссылку на пакет DeepAgent вместо выбора файла.",
  ...
  "settings.about.product.description": "Название и версия приложения.",
  ...
  "settings.general.deepagent.mode.description": "Выберите интенсивность работы DeepAgent.",
  ...
  "settings.general.deepagent.mode.ultraRequiresIntelligence": "ultra требует режима сценария intelligence.",
  ...
  "settings.general.deepagent.prompt.title": "Режим сценария",
  "settings.general.deepagent.prompt.description": "Выберите, как композер обрабатывает ваш промпт перед отправкой.",
  "settings.general.deepagent.prompt.direct": "Прямой режим",
  ...
  "settings.general.deepagent.intelligenceModel.title": "Модель режима intelligence",
  ...
  "settings.general.deepagent.selfLearning.title": "Одобрение самообучения",
  ...
  "settings.general.deepagent.selfLearning.manual": "Ручное одобрение",
  "settings.general.deepagent.selfLearning.manual.description":
    "Изученные знания ожидают в Review, пока вы их не одобрите.",
  "settings.general.deepagent.selfLearning.auto": "Автоматическое одобрение",
  ...
  "settings.general.row.shell.description":
    "Выберите оболочку терминала. Совместимые оболочки также используются для вызовов инструментов агента.",
  ...
  "settings.general.row.showFileTree.description": "Показывать панель дерева файлов в desktop-сессиях",
  "settings.general.row.showNavigation.title": "Элементы навигации",
  "settings.general.row.showNavigation.description": "Показывать кнопки назад и вперед в заголовке desktop-окна",
  "settings.general.row.showSearch.title": "Палитра команд",
  "settings.general.row.showSearch.description": "Показывать кнопку поиска и палитры команд в заголовке desktop-окна",
  "settings.general.row.showTerminal.title": "Терминал",
  "settings.general.row.showTerminal.description": "Показывать кнопку терминала в заголовке desktop-окна",
  "settings.general.row.showStatus.title": "Статус сервера",
  "settings.general.row.showStatus.description": "Показывать кнопку статуса сервера в заголовке desktop-окна",
  ...
  "settings.providers.section.deepagentBackends": "Бэкенды моделей DeepAgent",
}
