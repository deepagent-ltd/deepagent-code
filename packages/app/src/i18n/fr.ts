export const dict = {
  ...
  "settings.about.attribution.title": "Basé sur opencode",
  "settings.about.attribution.description": "DeepAgent Code est basé sur opencode, utilisé sous licence MIT.",
