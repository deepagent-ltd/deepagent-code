export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.deepagent-code.tagline": "Modèles optimisés et fiables",
  "dialog.provider.deepagentCodeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans DeepAgent Code.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans deepagent-code.json",
  ...
  "dialog.server.description": "Changez le serveur DeepAgent Code auquel cette application se connecte.",
  ...
  "context.stats.conversationTokens": "Tokens de conversation",
  ...
  "context.usage.totalTokens": "Tokens de conversation",
  ...
  "toast.update.description":
    "Une nouvelle version d'DeepAgent Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe DeepAgent Code",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (deepagent-code.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'DeepAgent Code ne supporte pas encore l'authentification MCP.",
  ...
  "session.export.action": "Exporter le snapshot",
  "session.export.success": "Snapshot de session exporte",
  ...
  "sidebar.gettingStarted.line1":
    "DeepAgent Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.section.sharing": "Partage",
  "settings.general.row.shareUrl.title": "URL du serveur de partage",
  "settings.general.row.shareUrl.description": "URL de base du serveur utilisé pour partager les sessions. Laissez vide pour la valeur par défaut.",
  "settings.general.row.shareUrl.placeholder": "https://opncd.ai",
  "settings.general.row.expertPanelDefault.title": "Activer le panel d'experts par défaut",
  "settings.general.row.expertPanelDefault.description": "Démarrer les nouvelles conversations avec le panel d'experts activé, afin que son bouton examine le contexte actuel à la demande.",
  "settings.general.section.display": "Affichage",
  "settings.general.section.power": "Alimentation",
  "settings.general.row.language.title": "Langue",
  "settings.general.row.language.description": "Changer la langue d'affichage pour DeepAgent Code",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'DeepAgent Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si DeepAgent Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'DeepAgent Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'DeepAgent Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'DeepAgent Code.",
  ...
  "settings.providers.section.consoleAccount": "Compte Console",
  "settings.providers.console.activeOrg": "Organisation active",
  "settings.providers.console.noOrg": "Aucune organisation sélectionnée",
  "settings.providers.console.switchOrg": "Changer d'organisation",
  "settings.providers.console.empty": "Aucune organisation Console commutable",
  "settings.providers.console.managedCount": "{{count}} fournisseurs gérés par Console",
  "settings.providers.console.switch.toast.title": "Organisation Console changée",
  "settings.providers.console.switch.toast.description": "Utilisation de {{org}}",
  ...
  "settings.providers.tag.configError": "Erreur de configuration",
  "settings.providers.error.json": "Erreur de syntaxe JSON",
  "settings.providers.error.schema": "Champs non valides",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.snapshot.file": "Bundle de snapshot",
  "settings.import.snapshot.file.hint": "Choisissez un bundle de snapshot de session exporte (.json). Il sera importe comme une nouvelle session continuable.",
  "settings.import.snapshot.noFile": "Choisissez d'abord un fichier de bundle de snapshot",
  "settings.import.snapshot.done": "Snapshot importe comme une nouvelle session continuable",
  "settings.import.bundle.file": "Archive de session",
  "settings.import.bundle.file.hint": "Choisissez un ZIP de session (.zip) ou un ancien instantané (.json). L’import sera une archive en lecture seule.",
  "settings.import.bundle.done": "Session importée comme archive en lecture seule",
  "settings.import.bundle.link": "Lien de partage",
  "settings.import.bundle.link.hint": "Collez un lien de partage d’archive DeepAgent au lieu de choisir un fichier.",
  ...
  "settings.about.product.title": "Produit",
  "settings.about.product.description": "Le nom et la version de l’application.",
  "settings.about.attribution.title": "Basé sur deepagent-code",
  "settings.about.attribution.description": "DeepAgent Code est basé sur deepagent-code, utilisé sous licence MIT.",
  "settings.about.license.title": "Licence",
  "settings.about.help.title": "Aide",
  "settings.about.help.description": "Documentation, guides et assistance.",
  ...
  "settings.general.deepagent.mode.description": "Choisissez l’intensité de travail de DeepAgent.",
  ...
  "settings.general.deepagent.selfLearning.manual": "Approbation manuelle",
  "settings.general.deepagent.selfLearning.manual.description":
    "Les connaissances apprises attendent dans la revue jusqu’à votre approbation.",
  "settings.general.deepagent.selfLearning.auto": "Approbation automatique",
  "settings.general.deepagent.selfLearning.auto.description":
    "Les connaissances apprises deviennent immédiatement récupérables, sans revue.",
  "settings.general.row.shell.title": "Shell du terminal",
  "settings.general.row.shell.description":
    "Choisissez le shell utilisé par le terminal. Les shells compatibles sont aussi utilisés pour les appels d’outils de l’agent.",
  ...
  "settings.general.row.showFileTree.description": "Afficher le panneau d’arborescence dans les sessions desktop",
  "settings.general.row.showNavigation.title": "Contrôles de navigation",
  "settings.general.row.showNavigation.description":
    "Afficher les boutons retour et suivant dans la barre de titre desktop",
  "settings.general.row.showSearch.title": "Palette de commandes",
  "settings.general.row.showSearch.description":
    "Afficher le bouton de recherche et de palette de commandes dans la barre de titre desktop",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Afficher le bouton du terminal dans la barre de titre desktop",
  "settings.general.row.showStatus.title": "État du serveur",
  "settings.general.row.showStatus.description": "Afficher le bouton d’état du serveur dans la barre de titre desktop",
  "settings.general.row.showCustomAgents.title": "Agents personnalisés",
  "settings.general.row.showCustomAgents.description": "Afficher le sélecteur d’agents dans le compositeur desktop v2",
  ...
  "settings.general.row.preventSleep.title": "Empêcher la mise en veille du système",
  "settings.general.row.preventSleep.description": "Garde le système actif pendant que l'app est en cours d'exécution ; l'écran peut toujours s'éteindre",
