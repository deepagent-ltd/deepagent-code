export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.deepagent-code.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.deepagentCodeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у DeepAgent Code.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в deepagent-code.json",
  ...
  "dialog.server.description": "Перемкніть сервер DeepAgent Code, до якого підключається ця програма.",
  ...
  "toast.update.description": "Нова версія DeepAgent Code ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді DeepAgent Code",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (deepagent-code.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, DeepAgent Code ще не підтримує автентифікацію MCP.',
  ...
  "session.export.action": "Експортувати знімок",
  "session.export.success": "Знімок сеансу експортовано",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.general.section.power": "Живлення",

  "settings.general.row.language.title": "Мова",
  "settings.general.row.language.description": "Змінити мову інтерфейсу DeepAgent Code",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію DeepAgent Code.",
  ...
  "settings.providers.section.consoleAccount": "Обліковий запис Console",
  "settings.providers.console.activeOrg": "Активна організація",
  "settings.providers.console.noOrg": "Організацію не вибрано",
  "settings.providers.console.switchOrg": "Змінити організацію",
  "settings.providers.console.empty": "Немає організацій Console для перемикання",
  "settings.providers.console.managedCount": "Провайдерів під керуванням Console: {{count}}",
  "settings.providers.console.switch.toast.title": "Організацію Console змінено",
  "settings.providers.console.switch.toast.description": "Тепер використовується {{org}}",
  ...
  "settings.providers.tag.configError": "Помилка конфігурації",
  "settings.providers.error.json": "Помилка синтаксису JSON",
  "settings.providers.error.schema": "Недійсні поля",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code (знімок)",
  "settings.import.snapshot.file": "Пакет знімка",
  "settings.import.snapshot.file.hint": "Виберіть експортований пакет знімка сеансу (.json). Його буде імпортовано як нову продовжувану сесію.",
  "settings.import.snapshot.noFile": "Спочатку виберіть файл пакета знімка",
  "settings.import.snapshot.done": "Знімок імпортовано як нову продовжувану сесію",
  "settings.import.bundle.file": "Пакет сеансу",
  "settings.import.bundle.file.hint": "Виберіть ZIP сеансу (.zip) або старий знімок (.json). Імпорт створить архів лише для читання.",
  "settings.import.bundle.done": "Сеанс імпортовано як архів лише для читання",
  "settings.import.bundle.link": "Посилання для поширення",
  "settings.import.bundle.link.hint": "Вставте посилання на пакет DeepAgent замість вибору файлу.",
  ...
  "settings.about.attribution.title": "Побудовано на deepagent-code",
  ...
  "settings.general.row.preventSleep.title": "Запобігати сну системи",
  "settings.general.row.preventSleep.description": "Не давати системі засинати, доки застосунок працює; екран все одно може вимикатися",
