export const dict = {
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, DeepAgent Code does not support MCP authentication yet.',
  ...
  "settings.general.deepagent.prompt.direct.description": "Send your prompt exactly as written, without DeepAgent preparing a draft.",
  "settings.general.deepagent.prompt.wish": "Wish mode",
  "settings.general.deepagent.prompt.wish.description": "DeepAgent prepares a complete prompt first, then lets you review and edit it.",
  ...
  "review.description": "Approve or reject knowledge DeepAgent learned from your sessions. Approved knowledge becomes retrievable; rejected knowledge stays out of retrieval and can be re-approved later.",
  ...
  "settings.general.row.colorScheme.description": "Choose whether DeepAgent Code follows the system, light, or dark theme",
