export const dict = {
  ...
  "provider.custom.description.prefix": "Enter the base URL and API key. We detect the protocol and available models automatically. See the ",
  ...
  "provider.custom.field.protocol.description": "Auto-detects by default. Pick a protocol if detection is wrong or the endpoint has no model list.",
  ...
  "oversight.takeover.description": "Record that a human is taking over from the autonomous agents (pauses autonomy escalation).",
  ...
  "oversight.rollback.description": "Revert an agent-produced change over a session (via SessionRevert). Only affects a session in this workspace. This reverts real changes — use with care.",
  ...
  "wiki.stale": "stale",
  "wiki.type.knowledge": "Knowledge",
  "wiki.type.memory": "Memory",
  "wiki.type.document": "Documents",
  "wiki.type.code": "Code",
  ...
  "sidebar.history.description": "Projects with imported or past sessions that are not currently active. Click one to open it.",
  ...
  "review.envFacts.scope.projectHint": "Saves a local copy for this project. The shared fact stays unchanged for others.",
