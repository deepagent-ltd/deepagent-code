export const dict = {
  ...
  "composer.approval.readOnly.desc": "Agent can read and search, but edits and commands are rejected",
  "composer.approval.request.desc": "Agent asks before editing files or running commands",
  "composer.approval.fullAccess.desc": "Agent edits files and runs commands without asking",
