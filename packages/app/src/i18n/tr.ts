...
export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.deepagent-code.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.deepagentCodeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "DeepAgent Code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve DeepAgent Code'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve DeepAgent Code'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak DeepAgent Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler deepagent-code.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi DeepAgent Code sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "DeepAgent Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı DeepAgent Code ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (deepagent-code.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: DeepAgent Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "session.export.action": "Anlık goruntuyu disa aktar",
  "session.export.success": "Oturum anlık goruntusu disa aktarıldı",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "DeepAgent Code Masaüstü",
  ...
  "settings.general.row.appearance.description": "DeepAgent Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "DeepAgent Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "DeepAgent Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "DeepAgent Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "DeepAgent Code'un en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.section.consoleAccount": "Console hesabı",
  "settings.providers.console.activeOrg": "Etkin kuruluş",
  "settings.providers.console.noOrg": "Kuruluş seçilmedi",
  "settings.providers.console.switchOrg": "Kuruluş değiştir",
  "settings.providers.console.empty": "Değiştirilebilir Console kuruluşu yok",
  "settings.providers.console.managedCount": "Console tarafından yönetilen {{count}} sağlayıcı",
  "settings.providers.console.switch.toast.title": "Console kuruluşu değiştirildi",
  "settings.providers.console.switch.toast.description": "Şimdi {{org}} kullanılıyor",
  ...
  "settings.providers.tag.configError": "Yapılandırma hatası",
  "settings.providers.error.json": "JSON sözdizimi hatası",
  "settings.providers.error.schema": "Geçersiz alan(lar)",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code (anlık goruntu)",
  "settings.import.snapshot.file": "Anlık goruntu paketi",
  "settings.import.snapshot.file.hint": "Disa aktarılmıs bir oturum anlık goruntu paketi (.json) secin. Devam edilebilir yeni bir oturum olarak ice aktarılır.",
  "settings.import.snapshot.noFile": "Once bir anlık goruntu paketi dosyası secin",
  "settings.import.snapshot.done": "Anlık goruntu devam edilebilir yeni bir oturum olarak ice aktarıldı",
  "settings.import.bundle.file": "Oturum paketi",
  "settings.import.bundle.file.hint": "Bir oturum ZIP dosyası (.zip) veya eski anlık görüntü (.json) seçin. İçe aktarım salt okunur arşiv olur.",
  "settings.import.bundle.done": "Oturum salt okunur arşiv olarak içe aktarıldı",
  "settings.import.bundle.link": "Paylaşım bağlantısı",
  "settings.import.bundle.link.hint": "Dosya seçmek yerine DeepAgent paketi paylaşım bağlantısını yapıştırın.",
  ...
  "settings.about.product.title": "Ürün",
  "settings.about.product.description": "Uygulama adı ve sürümü.",
  "settings.about.attribution.title": "deepagent-code üzerine kurulu",
  ...
  "settings.general.deepagent.selfLearning.manual": "Manuel onay",
  "settings.general.deepagent.selfLearning.manual.description":
    "Öğrenilen bilgi, siz onaylayana kadar Review içinde bekler.",
  "settings.general.deepagent.selfLearning.auto": "Otomatik onay",
  "settings.general.deepagent.selfLearning.auto.description":
    "Öğrenilen bilgi inceleme olmadan hemen erişilebilir olur.",
  ...
  "settings.general.row.showCustomAgents.description": "v2 masaüstü oluşturucuda ajan seçiciyi göster",
  "settings.general.row.newLayoutDesigns.title": "Yeni düzen ve tasarımlar",
  "settings.general.row.newLayoutDesigns.description":
    "Yeniden tasarlanan düzeni, ana sayfayı, oluşturucuyu ve oturum arayüzünü etkinleştir",
