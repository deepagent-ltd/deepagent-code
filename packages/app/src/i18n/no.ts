...
export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.deepagent-code.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.deepagentCodeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i DeepAgent Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i deepagent-code.json",
  ...
  "dialog.server.description": "Bytt hvilken DeepAgent Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av DeepAgent Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til DeepAgent Code-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (deepagent-code.json)",
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" mislyktes. Merk at DeepAgent Code ikke støtter MCP-autentisering ennå.',
  ...
  "session.export.action": "Eksporter snapshot",
  "session.export.success": "Okt-snapshot eksportert",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for DeepAgent Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan DeepAgent Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om DeepAgent Code skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan DeepAgent Code er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når DeepAgent Code starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av DeepAgent Code.",
  ...
  "settings.providers.console.activeOrg": "Aktiv organisasjon",
  "settings.providers.console.noOrg": "Ingen organisasjon valgt",
  "settings.providers.console.switchOrg": "Bytt organisasjon",
  "settings.providers.console.empty": "Ingen Console-organisasjoner å bytte mellom",
  "settings.providers.console.managedCount": "{{count}} Console-administrerte leverandører",
  "settings.providers.console.switch.toast.title": "Console-organisasjon byttet",
  "settings.providers.console.switch.toast.description": "Bruker nå {{org}}",
  ...
  "settings.providers.tag.configError": "Konfigurasjonsfeil",
  "settings.providers.error.json": "JSON-syntaksfeil",
  "settings.providers.error.schema": "Ugyldige felt",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.snapshot.file.hint": "Velg en eksportert okt-snapshot-bundle (.json). Den importeres som en ny fortsettbar okt.",
  "settings.import.snapshot.noFile": "Velg foerst en snapshot-bundle-fil",
  "settings.import.snapshot.done": "Snapshot importert som en ny fortsettbar okt",
  "settings.import.bundle.file": "Øktpakke",
  "settings.import.bundle.file.hint": "Velg en ZIP-fil for økten (.zip) eller et eldre øyeblikksbilde (.json). Importen blir et skrivebeskyttet arkiv.",
  "settings.import.bundle.done": "Økten er importert som et skrivebeskyttet arkiv",
  "settings.import.bundle.link": "Delingslenke",
  "settings.import.bundle.link.hint": "Lim inn en delingslenke til en DeepAgent-pakke i stedet for å velge en fil.",
  ...
  "settings.about.product.description": "Applikasjonens navn og versjon.",
  ...
  "settings.about.help.title": "Hjelp",
  "settings.about.help.description": "Dokumentasjon, veiledninger og støtte.",
  ...
  "settings.general.deepagent.mode.description": "Velg arbeidsintensiteten til DeepAgent.",
  ...
  "settings.general.deepagent.selfLearning.manual": "Manuel godkendelse",
  "settings.general.deepagent.selfLearning.manual.description": "Lært viden venter i Review, indtil du godkender den.",
  "settings.general.deepagent.selfLearning.auto": "Automatisk godkendelse",
  "settings.general.deepagent.selfLearning.auto.description": "Lært viden bliver straks søgbar uden review.",
  "settings.general.row.shell.title": "Terminal-shell",
  "settings.general.row.shell.description":
    "Vælg shellen til din terminal. Kompatible shells bruges også til agentværktøjskald.",
  ...
  "settings.general.row.showFileTree.description": "Vis filtræpanelet i desktop-sessioner",
  "settings.general.row.showNavigation.title": "Navigationskontroller",
  "settings.general.row.showNavigation.description": "Vis tilbage- og frem-knapper i desktop-titellinjen",
  "settings.general.row.showSearch.title": "Kommandopalet",
  "settings.general.row.showSearch.description": "Vis søge- og kommandopaletknappen i desktop-titellinjen",
  ...
  "settings.general.row.showStatus.description": "Vis serverstatusknappen i desktop-titellinjen",
  "settings.general.row.showCustomAgents.title": "Brugerdefinerede agenter",
  "settings.general.row.showCustomAgents.description": "Vis agentvælgeren i v2 desktop-composeren",
  ...
  "settings.general.row.preventSleep.title": "Forhindre hvilemodus",
  "settings.general.row.preventSleep.description": "Hold systemet våkent mens appen kjører; skjermen kan fortsatt slås av",
