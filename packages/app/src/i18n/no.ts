...
export const dict = {
  ...
  "settings.about.attribution.title": "Bygget på opencode",
  "settings.about.attribution.description": "DeepAgent Code er bygget på opencode, brugt under MIT-licensen.",
