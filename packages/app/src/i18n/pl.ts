export const dict = {
  ...
  "settings.about.attribution.title": "Zbudowane na opencode",
  "settings.about.attribution.description": "DeepAgent Code jest zbudowany na opencode, używanym na licencji MIT.",
