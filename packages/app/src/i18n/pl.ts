export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.deepagent-code.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.deepagentCodeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w DeepAgent Code.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w deepagent-code.json",
  ...
  "dialog.server.description": "Przełącz serwer DeepAgent Code, z którym łączy się ta aplikacja.",
  ...
  "context.stats.conversationTokens": "Tokeny rozmowy",
  ...
  "context.usage.totalTokens": "Tokeny rozmowy",
  ...
  "toast.update.description": "Nowa wersja DeepAgent Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu DeepAgent Code",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (deepagent-code.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" failed. Note, DeepAgent Code does not support MCP authentication yet.',
  ...
  "session.export.action": "Eksportuj migawke",
  "session.export.success": "Migawka sesji wyeksportowana",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.section.sharing": "Udostępnianie",
  "settings.general.row.shareUrl.title": "URL serwera udostępniania",
  "settings.general.row.shareUrl.description": "Podstawowy adres URL serwera używany podczas udostępniania sesji. Pozostaw puste, aby użyć domyślnego.",
  "settings.general.row.shareUrl.placeholder": "https://opncd.ai",
  "settings.general.row.expertPanelDefault.title": "Domyślnie włącz panel ekspertów",
  "settings.general.row.expertPanelDefault.description": "Rozpoczynaj nowe rozmowy z włączonym panelem ekspertów, aby jego przycisk mógł na żądanie przeglądać bieżący kontekst.",
  "settings.general.section.display": "Ekran",
  "settings.general.section.power": "Zasilanie",
  "settings.general.row.language.title": "Język",
  "settings.general.row.language.description": "Zmień język wyświetlania dla DeepAgent Code",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd DeepAgent Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy DeepAgent Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw DeepAgent Code.",
  ...
  "settings.updates.row.startup.description":
    "Automatycznie sprawdzaj aktualizacje podczas uruchamiania DeepAgent Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji DeepAgent Code.",
  ...
  "settings.providers.section.consoleAccount": "Konto Console",
  "settings.providers.console.activeOrg": "Aktywna organizacja",
  "settings.providers.console.noOrg": "Nie wybrano organizacji",
  "settings.providers.console.switchOrg": "Przełącz organizację",
  "settings.providers.console.empty": "Brak organizacji Console do przełączenia",
  "settings.providers.console.managedCount": "{{count}} dostawców zarządzanych przez Console",
  "settings.providers.console.switch.toast.title": "Przełączono organizację Console",
  "settings.providers.console.switch.toast.description": "Teraz używany jest {{org}}",
  ...
  "settings.providers.tag.configError": "Błąd konfiguracji",
  "settings.providers.error.json": "Błąd składni JSON",
  "settings.providers.error.schema": "Nieprawidłowe pola",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code (migawka)",
  "settings.import.snapshot.file": "Pakiet migawki",
  "settings.import.snapshot.file.hint": "Wybierz wyeksportowany pakiet migawki sesji (.json). Zostanie zaimportowany jako nowa kontynuowalna sesja.",
  "settings.import.snapshot.noFile": "Najpierw wybierz plik pakietu migawki",
  "settings.import.snapshot.done": "Migawka zaimportowana jako nowa kontynuowalna sesja",
  "settings.import.bundle.file": "Pakiet sesji",
  "settings.import.bundle.file.hint": "Wybierz ZIP sesji (.zip) lub starszą migawkę (.json). Import zostanie zapisany jako archiwum tylko do odczytu.",
  "settings.import.bundle.done": "Sesja została zaimportowana jako archiwum tylko do odczytu",
  "settings.import.bundle.link": "Link do udostępnienia",
  "settings.import.bundle.link.hint": "Wklej link do udostępnionego pakietu DeepAgent zamiast wybierać plik.",
  ...
  "settings.about.product.title": "Produkt",
  "settings.about.product.description": "Nazwa i wersja aplikacji.",
  ...
  "settings.about.help.title": "Pomoc",
  "settings.about.help.description": "Dokumentacja, przewodniki i wsparcie.",
  ...
  "settings.general.deepagent.mode.description": "Wybierz intensywność pracy DeepAgent.",
  ...
  "settings.general.deepagent.selfLearning.manual": "Zatwierdzanie ręczne",
  "settings.general.deepagent.selfLearning.manual.description": "Nauczona wiedza czeka w Review, aż ją zatwierdzisz.",
  "settings.general.deepagent.selfLearning.auto": "Zatwierdzanie automatyczne",
  "settings.general.deepagent.selfLearning.auto.description":
    "Nauczona wiedza staje się dostępna natychmiast, bez przeglądu.",
  "settings.general.row.shell.title": "Powłoka terminala",
  "settings.general.row.shell.description":
    "Wybierz powłokę używaną w terminalu. Zgodne powłoki są też używane przez wywołania narzędzi agenta.",
  ...
  "settings.general.row.showFileTree.description": "Pokaż panel drzewa plików w sesjach desktopowych",
  "settings.general.row.showNavigation.title": "Kontrolki nawigacji",
  "settings.general.row.showNavigation.description": "Pokaż przyciski wstecz i dalej na pasku tytułu desktopu",
  "settings.general.row.showSearch.title": "Paleta poleceń",
  "settings.general.row.showSearch.description":
    "Pokaż przycisk wyszukiwania i palety poleceń na pasku tytułu desktopu",
  "settings.general.row.showTerminal.title": "Terminal",
  "settings.general.row.showTerminal.description": "Pokaż przycisk terminala na pasku tytułu desktopu",
  "settings.general.row.showStatus.title": "Status serwera",
  "settings.general.row.showStatus.description": "Pokaż przycisk statusu serwera na pasku tytułu desktopu",
  "settings.general.row.showCustomAgents.title": "Niestandardowi agenci",
  "settings.general.row.showCustomAgents.description": "Pokaż wybór agenta w kompozytorze desktopowym v2",
  "settings.general.row.newLayoutDesigns.title": "Nowy układ i wygląd",
  "settings.general.row.newLayoutDesigns.description":
    "Włącz przeprojektowany układ, ekran główny, kompozytor i interfejs sesji",
  ...
  "settings.general.row.preventSleep.title": "Zapobiegaj uśpieniu systemu",
  "settings.general.row.preventSleep.description": "Utrzymuj system aktywny, gdy aplikacja jest uruchomiona; ekran nadal może się wyłączyć",
