export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.deepagent-code.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.deepagentCodeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في DeepAgent Code.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في deepagent-code.json",
  ...
  "dialog.server.description": "تبديل خادم DeepAgent Code الذي يتصل به هذا التطبيق.",
  ...
  "context.stats.conversationTokens": "رموز المحادثة",
  ...
  "context.usage.totalTokens": "رموز المحادثة",
  ...
  "toast.update.description": "نسخة جديدة من DeepAgent Code ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق DeepAgent Code",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (deepagent-code.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن DeepAgent Code لا يدعم مصادقة MCP بعد.',
  ...
  "session.export.action": "تصدير اللقطة",
  "session.export.success": "تم تصدير لقطة الجلسة",
  ...
  "sidebar.gettingStarted.line1": "يتضمن DeepAgent Code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.section.power": "الطاقة",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور DeepAgent Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان DeepAgent Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة DeepAgent Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل DeepAgent Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من DeepAgent Code.",
  ...
  "settings.providers.section.consoleAccount": "حساب Console",
  "settings.providers.console.activeOrg": "المنظمة النشطة",
  "settings.providers.console.noOrg": "لم يتم اختيار منظمة",
  "settings.providers.console.switchOrg": "تبديل المنظمة",
  "settings.providers.console.empty": "لا توجد مؤسسات Console قابلة للتبديل",
  "settings.providers.console.managedCount": "{{count}} من مزودي الخدمة المدارة عبر Console",
  "settings.providers.console.switch.toast.title": "تم تبديل منظمة Console",
  "settings.providers.console.switch.toast.description": "الآن يتم استخدام {{org}}",
  ...
  "settings.providers.tag.configError": "خطأ في الإعداد",
  "settings.providers.error.json": "خطأ في بناء JSON",
  "settings.providers.error.schema": "حقول غير صالحة",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code (لقطة)",
  "settings.import.snapshot.file": "حزمة اللقطة",
  "settings.import.snapshot.file.hint": "اختر حزمة لقطة الجلسة المصدّرة (.json). سيتم استيرادها كجلسة جديدة قابلة للمتابعة.",
  "settings.import.snapshot.noFile": "اختر ملف حزمة اللقطة أولاً",
  "settings.import.snapshot.done": "تم استيراد اللقطة كجلسة جديدة قابلة للمتابعة",
  "settings.import.bundle.file": "حزمة الجلسة",
  "settings.import.bundle.file.hint": "اختر ملف ZIP للجلسة (.zip) أو لقطة قديمة (.json). يتم الاستيراد كأرشيف للقراءة فقط.",
  "settings.import.bundle.done": "تم استيراد الجلسة كأرشيف للقراءة فقط",
  "settings.import.bundle.link": "رابط المشاركة",
  "settings.import.bundle.link.hint": "الصق رابط مشاركة حزمة DeepAgent بدلاً من اختيار ملف.",
  ...
  "settings.about.product.title": "المنتج",
  "settings.about.product.description": "اسم التطبيق وإصداره.",
  "settings.about.attribution.title": "مبني على deepagent-code",
  "settings.about.attribution.description": "تم بناء DeepAgent Code على deepagent-code المستخدم بموجب ترخيص MIT.",
  "settings.about.license.title": "الترخيص",
  "settings.about.help.title": "مساعدة",
  "settings.about.help.description": "الوثائق والأدلة والدعم.",
  "settings.general.section.advanced": "متقدم",
  "settings.general.section.deepagent": "DeepAgent",
  "settings.general.deepagent.mode.title": "الوكيل",
  "settings.general.deepagent.mode.description": "اختر شدة عمل DeepAgent.",
  ...
  "settings.general.deepagent.mode.ultraRequiresIntelligence": "يتطلب ultra وضع سيناريو intelligence.",
  ...
  "settings.general.deepagent.prompt.title": "وضع السيناريو",
  "settings.general.deepagent.prompt.description": "اختر كيف يعالج المحرر الطلب قبل الإرسال.",
  "settings.general.deepagent.prompt.direct": "الوضع المباشر",
  "settings.general.deepagent.prompt.direct.description": "أرسل الطلب كما كتبته بدون أن يحضر DeepAgent مسودة.",
  "settings.general.deepagent.prompt.intelligence": "وضع intelligence",
  "settings.general.deepagent.prompt.intelligence.description": "يحضر DeepAgent طلبا كاملا أولا، ثم يتيح لك مراجعته وتعديله.",
  "settings.general.deepagent.intelligenceModel.title": "نموذج وضع intelligence",
  "settings.general.deepagent.intelligenceModel.description": "اختر النموذج المستخدم فقط لتحضير مسودات الطلبات في وضع intelligence.",
  "settings.general.deepagent.selfLearning.title": "اعتماد التعلم الذاتي",
  "settings.general.deepagent.selfLearning.description":
    "حدد كيف تصبح المعرفة التي يتعلمها DeepAgent من جلساتك قابلة للاسترجاع.",
  "settings.general.deepagent.selfLearning.manual": "اعتماد يدوي",
  "settings.general.deepagent.selfLearning.manual.description": "تنتظر المعرفة المتعلمة في المراجعة حتى توافق عليها.",
  "settings.general.deepagent.selfLearning.auto": "اعتماد تلقائي",
  "settings.general.deepagent.selfLearning.auto.description": "تصبح المعرفة المتعلمة قابلة للاسترجاع فورا دون مراجعة.",
  "settings.general.row.shell.title": "صدفة الطرفية",
  "settings.general.row.shell.description":
    "اختر الصدفة المستخدمة في الطرفية. تستخدم الصدف المتوافقة أيضا لاستدعاءات أدوات الوكيل.",
  ...
  "settings.general.row.showFileTree.description": "إظهار لوحة شجرة الملفات في جلسات سطح المكتب",
  ...
  "settings.general.row.showCustomAgents.description": "إظهار محدد الوكيل في محرر سطح المكتب v2",
  "settings.general.row.newLayoutDesigns.title": "تخطيط وتصميمات جديدة",
  ...
  "settings.general.row.preventSleep.title": "منع سكون النظام",
  "settings.general.row.preventSleep.description": "إبقاء النظام مستيقظًا أثناء تشغيل التطبيق؛ ويمكن أن تنطفئ الشاشة",
