export const dict = {
  ...
  "settings.general.deepagent.mode.ultraRequiresWish": "يتطلب ultra وضع سيناريو wish.",
  ...
  "settings.general.deepagent.prompt.wish": "وضع wish",
  "settings.general.deepagent.prompt.wish.description": "يحضر DeepAgent طلبا كاملا أولا، ثم يتيح لك مراجعته وتعديله.",
  "settings.general.deepagent.wishModel.title": "نموذج وضع wish",
  "settings.general.deepagent.wishModel.description": "اختر النموذج المستخدم فقط لتحضير مسودات الطلبات في وضع wish.",
