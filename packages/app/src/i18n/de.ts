...
export const dict = {
  ...
  "settings.about.attribution.title": "Auf opencode aufgebaut",
  "settings.about.attribution.description": "DeepAgent Code basiert auf opencode und nutzt es unter der MIT-Lizenz.",
