...
export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.deepagent-code.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.deepagentCodeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in DeepAgent Code zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in DeepAgent Code zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in DeepAgent Code zu nutzen.",
  ...
  "dialog.plugins.empty": "In deepagent-code.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den DeepAgent Code-Server, mit dem sich diese App verbindet.",
  ...
  "context.stats.conversationTokens": "Konversations-Tokens",
  ...
  "context.usage.totalTokens": "Konversations-Tokens",
  ...
  "toast.update.description": "Eine neue Version von DeepAgent Code ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem DeepAgent Code-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (deepagent-code.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: DeepAgent Code unterstützt noch keine MCP-Authentifizierung.',
  ...
  "session.export.action": "Snapshot exportieren",
  "session.export.success": "Session-Snapshot exportiert",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.section.sharing": "Teilen",
  "settings.general.row.shareUrl.title": "Server-URL für Freigabe",
  "settings.general.row.shareUrl.description": "Basis-URL des Servers, der beim Teilen von Sitzungen verwendet wird. Leer lassen für Standard.",
  "settings.general.row.shareUrl.placeholder": "https://opncd.ai",
  "settings.general.row.expertPanelDefault.title": "Expertengremium standardmäßig aktivieren",
  "settings.general.row.expertPanelDefault.description": "Neue Unterhaltungen mit aktiviertem Expertengremium starten, damit dessen Schaltfläche den aktuellen Kontext bei Bedarf prüft.",
  "settings.general.section.display": "Anzeige",
  "settings.general.section.power": "Energie",
  "settings.general.row.language.title": "Sprache",
  "settings.general.row.language.description": "Die Anzeigesprache für DeepAgent Code ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie DeepAgent Code auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob DeepAgent Code dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von DeepAgent Code anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von DeepAgent Code automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von DeepAgent Code.",
  ...
  "settings.providers.section.consoleAccount": "Console-Konto",
  "settings.providers.console.activeOrg": "Aktive Organisation",
  "settings.providers.console.noOrg": "Keine Organisation ausgewählt",
  "settings.providers.console.switchOrg": "Organisation wechseln",
  "settings.providers.console.empty": "Keine wechselbaren Console-Organisationen",
  "settings.providers.console.managedCount": "{{count}} Console-verwaltete Anbieter",
  "settings.providers.console.switch.toast.title": "Console-Organisation gewechselt",
  "settings.providers.console.switch.toast.description": "Jetzt wird {{org}} verwendet",
  ...
  "settings.providers.tag.configError": "Konfigurationsfehler",
  "settings.providers.error.json": "JSON-Syntaxfehler",
  "settings.providers.error.schema": "Ungültige Felder",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.snapshot.file.hint": "Waehlen Sie ein exportiertes Session-Snapshot-Bundle (.json). Es wird als neue fortsetzbare Sitzung importiert.",
  "settings.import.snapshot.noFile": "Waehlen Sie zuerst eine Snapshot-Bundle-Datei",
  "settings.import.snapshot.done": "Snapshot als neue fortsetzbare Sitzung importiert",
  "settings.import.bundle.file": "Sitzungspaket",
  "settings.import.bundle.file.hint": "Wähle eine Sitzungs-ZIP-Datei (.zip) oder einen älteren Snapshot (.json). Der Import ist ein schreibgeschütztes Archiv.",
  "settings.import.bundle.done": "Sitzung als schreibgeschütztes Archiv importiert",
  "settings.import.bundle.link": "Freigabelink",
  "settings.import.bundle.link.hint": "Füge statt einer Datei einen Freigabelink für ein DeepAgent-Paket ein.",
  ...
  "settings.about.product.description": "Name und Version der Anwendung.",
  "settings.about.attribution.title": "Auf deepagent-code aufgebaut",
  "settings.about.attribution.description": "DeepAgent Code basiert auf deepagent-code und nutzt es unter der MIT-Lizenz.",
  "settings.about.license.title": "Lizenz",
  "settings.about.help.title": "Hilfe",
  "settings.about.help.description": "Dokumentation, Anleitungen und Support.",
  ...
  "settings.general.deepagent.selfLearning.manual": "Manuelle Freigabe",
  "settings.general.deepagent.selfLearning.manual.description":
    "Gelerntes Wissen wartet in der Prüfung, bis du es freigibst.",
  "settings.general.deepagent.selfLearning.auto": "Automatische Freigabe",
  "settings.general.deepagent.selfLearning.auto.description": "Gelerntes Wissen wird ohne Prüfung sofort abrufbar.",
  "settings.general.row.shell.title": "Terminal-Shell",
  "settings.general.row.shell.description":
    "Wähle die Shell für dein Terminal. Kompatible Shells werden auch für Agent-Toolaufrufe genutzt.",
  ...
  "settings.general.row.showFileTree.description": "Dateibaum in Desktop-Sitzungen anzeigen",
  ...
  "settings.general.row.showSearch.description":
    "Such- und Befehlspaletten-Schaltfläche in der Desktop-Titelleiste anzeigen",
  ...
  "settings.general.row.showCustomAgents.title": "Benutzerdefinierte Agents",
  "settings.general.row.showCustomAgents.description": "Agent-Auswahl im v2-Desktop-Composer anzeigen",
  ...
  "settings.general.row.preventSleep.description": "Hält das System wach, solange die App läuft; der Bildschirm kann sich weiterhin ausschalten",
