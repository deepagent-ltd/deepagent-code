export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.deepagent-code.tagline": "Modelos optimizados y fiables",
  "dialog.provider.deepagentCodeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en DeepAgent Code.",
  ...
  "dialog.plugins.empty": "Plugins configurados en deepagent-code.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de DeepAgent Code se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de DeepAgent Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de DeepAgent Code",
  ...
  "session.export.action": "Exportar instantanea",
  "session.export.success": "Instantanea de sesion exportada",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.section.power": "Energía",

  "settings.general.row.language.title": "Idioma",
  "settings.general.row.language.description": "Cambiar el idioma de visualización para DeepAgent Code",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve DeepAgent Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si DeepAgent Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de DeepAgent Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia DeepAgent Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de DeepAgent Code.",
  ...
  "settings.providers.section.consoleAccount": "Cuenta de Console",
  "settings.providers.console.activeOrg": "Organización activa",
  "settings.providers.console.noOrg": "Ninguna organización seleccionada",
  "settings.providers.console.switchOrg": "Cambiar organización",
  "settings.providers.console.empty": "No hay organizaciones de Console intercambiables",
  "settings.providers.console.managedCount": "{{count}} proveedores gestionados por Console",
  "settings.providers.console.switch.toast.title": "Organización de Console cambiada",
  "settings.providers.console.switch.toast.description": "Ahora usando {{org}}",
  ...
  "settings.providers.tag.configError": "Error de configuración",
  "settings.providers.error.json": "Error de sintaxis JSON",
  "settings.providers.error.schema": "Campos no válidos",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code (instantanea)",
  "settings.import.snapshot.file": "Paquete de instantanea",
  "settings.import.snapshot.file.hint": "Elija un paquete de instantanea de sesion exportado (.json). Se importara como una nueva sesion continuable.",
  "settings.import.snapshot.noFile": "Elija primero un archivo de paquete de instantanea",
  "settings.import.snapshot.done": "Instantanea importada como una nueva sesion continuable",
  "settings.import.bundle.file": "Paquete de sesión",
  "settings.import.bundle.file.hint": "Elige un ZIP de sesión (.zip) o una instantánea antigua (.json). Se importará como archivo de solo lectura.",
  "settings.import.bundle.done": "Sesión importada como archivo de solo lectura",
  "settings.import.bundle.link": "Enlace para compartir",
  "settings.import.bundle.link.hint": "Pega un enlace para compartir un paquete de DeepAgent en lugar de elegir un archivo.",
  ...
  "settings.general.deepagent.intelligenceModel.title": "Modelo del modo intelligence",
  ...
  "settings.general.row.preventSleep.title": "Evitar la suspensión del sistema",
  "settings.general.row.preventSleep.description": "Mantener el sistema activo mientras la app está en ejecución; la pantalla aún puede apagarse",
