export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.deepagent-code.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.deepagentCodeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "DeepAgent Codeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、DeepAgent Codeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してDeepAgent Codeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、DeepAgent Codeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "deepagent-code.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するDeepAgent Codeサーバーを切り替えます。",
  ...
  "context.stats.conversationTokens": "会話の総トークン",
  ...
  "context.usage.totalTokens": "会話の総トークン",
  ...
  "toast.update.description": "DeepAgent Codeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをDeepAgent Codeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (deepagent-code.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: DeepAgent CodeはまだMCP認証をサポートしていません。',
  ...
  "session.export.action": "スナップショットをエクスポート",
  "session.export.success": "セッションスナップショットをエクスポートしました",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Codeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.section.sharing": "共有",
  "settings.general.row.shareUrl.title": "共有サーバー URL",
  "settings.general.row.shareUrl.description": "セッション共有時に使用するサーバーのベース URL。空欄でデフォルトを使用します。",
  "settings.general.row.shareUrl.placeholder": "https://opncd.ai",
  "settings.general.row.expertPanelDefault.title": "エキスパートパネルをデフォルトで有効化",
  "settings.general.row.expertPanelDefault.description": "新しい会話をエキスパートパネル有効の状態で開始し、ボタンで現在のコンテキストをいつでも会議レビューできるようにします。",
  "settings.general.section.display": "ディスプレイ",
  "settings.general.section.power": "電源",
  "settings.general.row.language.title": "言語",
  "settings.general.row.language.description": "DeepAgent Codeの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのDeepAgent Codeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description":
    "DeepAgent Codeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "DeepAgent Codeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "DeepAgent Code の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "DeepAgent Code は最新バージョンです。",
  ...
  "settings.providers.section.consoleAccount": "Console アカウント",
  "settings.providers.console.activeOrg": "アクティブな組織",
  "settings.providers.console.noOrg": "組織が選択されていません",
  "settings.providers.console.switchOrg": "組織を切り替え",
  "settings.providers.console.empty": "切り替え可能な Console 組織がありません",
  "settings.providers.console.managedCount": "Console 管理のプロバイダー {{count}} 件",
  "settings.providers.console.switch.toast.title": "Console 組織を切り替えました",
  "settings.providers.console.switch.toast.description": "現在 {{org}} を使用中",
  ...
  "settings.providers.tag.configError": "設定エラー",
  "settings.providers.error.json": "JSON 構文エラー",
  "settings.providers.error.schema": "無効なフィールド",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code（スナップショット）",
  "settings.import.snapshot.file": "スナップショットバンドル",
  "settings.import.snapshot.file.hint": "エクスポートされたセッションスナップショットバンドル（.json）を選択してください。継続可能な新しいセッションとしてインポートされます。",
  "settings.import.snapshot.noFile": "先にスナップショットバンドルファイルを選択してください",
  "settings.import.snapshot.done": "スナップショットは継続可能な新しいセッションとしてインポートされました",
  "settings.import.bundle.file": "セッションバンドル",
  "settings.import.bundle.file.hint": "セッションの ZIP（.zip）または旧形式のスナップショット（.json）を選択してください。読み取り専用のアーカイブとして取り込みます。",
  "settings.import.bundle.done": "セッションを読み取り専用のアーカイブとして取り込みました",
  "settings.import.bundle.link": "共有リンク",
  "settings.import.bundle.link.hint": "ファイルを選ぶ代わりに、DeepAgent バンドルの共有リンクを貼り付けてください。",
  ...
  "settings.about.product.title": "製品",
  "settings.about.product.description": "アプリケーション名とバージョン。",
  "settings.about.attribution.title": "deepagent-codeを基盤に構築",
  "settings.about.attribution.description": "DeepAgent CodeはMITライセンスの下でdeepagent-codeを基盤に構築されています。",
  "settings.about.license.title": "ライセンス",
  "settings.about.help.title": "ヘルプ",
  "settings.about.help.description": "ドキュメント、ガイド、サポート。",
  "settings.general.section.advanced": "詳細",
  "settings.general.section.deepagent": "DeepAgent",
  "settings.general.deepagent.mode.title": "エージェント",
  "settings.general.deepagent.mode.description": "DeepAgentの作業強度を選択します。",
  ...
  "settings.general.deepagent.selfLearning.manual": "手動承認",
  "settings.general.deepagent.selfLearning.manual.description": "学習した知識は承認するまでレビューで待機します。",
  "settings.general.deepagent.selfLearning.auto": "自動承認",
  "settings.general.deepagent.selfLearning.auto.description": "学習した知識はレビューなしですぐ検索可能になります。",
  "settings.general.row.shell.title": "ターミナルシェル",
  "settings.general.row.shell.description":
    "ターミナルで使用するシェルを選択します。互換シェルはエージェントのツール呼び出しにも使用されます。",
  ...
  "settings.general.row.showFileTree.description": "デスクトップセッションにファイルツリーパネルを表示します",
  "settings.general.row.showNavigation.title": "ナビゲーションコントロール",
  "settings.general.row.showNavigation.description": "デスクトップタイトルバーに戻る/進むボタンを表示します",
  "settings.general.row.showSearch.title": "コマンドパレット",
  "settings.general.row.showSearch.description": "デスクトップタイトルバーに検索とコマンドパレットボタンを表示します",
  "settings.general.row.showTerminal.title": "ターミナル",
  "settings.general.row.showTerminal.description": "デスクトップタイトルバーにターミナルボタンを表示します",
  "settings.general.row.showStatus.title": "サーバーステータス",
  "settings.general.row.showStatus.description": "デスクトップタイトルバーにサーバーステータスボタンを表示します",
  "settings.general.row.showCustomAgents.title": "カスタムエージェント",
  "settings.general.row.showCustomAgents.description": "v2デスクトップコンポーザーにエージェント選択を表示します",
  ...
  "settings.general.row.preventSleep.title": "システムのスリープを防止",
  "settings.general.row.preventSleep.description": "アプリの実行中はシステムをスリープさせません。ディスプレイはオフにできます",
