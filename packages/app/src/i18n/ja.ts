export const dict = {
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: DeepAgent CodeはまだMCP認証をサポートしていません。',
  ...
  "settings.general.row.colorScheme.description": "DeepAgent Codeがシステム、ライト、またはダークテーマに従うかを選択します",
