export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.deepagent-code.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.deepagentCodeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i DeepAgent Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i DeepAgent Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i DeepAgent Code.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i deepagent-code.json",
  ...
  "dialog.server.description": "Skift hvilken DeepAgent Code-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af DeepAgent Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til DeepAgent Code-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (deepagent-code.json) udbyder/modelnavne",
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, DeepAgent Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "session.export.success": "Sessions-snapshot eksporteret",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.shareUrl.title": "Delings-server-URL",
  "settings.general.row.shareUrl.description": "Basis-URL for serveren, der bruges ved deling af sessioner. Lad stå tomt for standard.",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan DeepAgent Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om DeepAgent Code følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan DeepAgent Code er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når DeepAgent Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af DeepAgent Code.",
  ...
  "settings.providers.console.activeOrg": "Aktiv organisation",
  "settings.providers.console.noOrg": "Ingen organisation valgt",
  "settings.providers.console.switchOrg": "Skift organisation",
  "settings.providers.console.empty": "Ingen Console-organisationer at skifte mellem",
  "settings.providers.console.managedCount": "{{count}} Console-administrerede udbydere",
  "settings.providers.console.switch.toast.title": "Console-organisation skiftet",
  "settings.providers.console.switch.toast.description": "Bruger nu {{org}}",
  ...
  "settings.providers.tag.configError": "Konfigurationsfejl",
  "settings.providers.error.json": "JSON-syntaksfejl",
  "settings.providers.error.schema": "Ugyldige felter",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.snapshot.file.hint": "Vaelg en eksporteret sessions-snapshot-bundle (.json). Den importeres som en ny fortsaetbar session.",
  "settings.import.snapshot.noFile": "Vaelg foerst en snapshot-bundle-fil",
  "settings.import.snapshot.done": "Snapshot importeret som en ny fortsaetbar session",
  "settings.import.bundle.file": "Sessionspakke",
  "settings.import.bundle.file.hint": "Vælg en sessions-ZIP (.zip) eller et ældre snapshot (.json). Importen er et skrivebeskyttet arkiv.",
  "settings.import.bundle.done": "Sessionen er importeret som et skrivebeskyttet arkiv",
  "settings.import.bundle.link": "Delingslink",
  "settings.import.bundle.link.hint": "Indsæt et delingslink til en DeepAgent-pakke i stedet for at vælge en fil.",
  ...
  "settings.about.product.description": "Programmets navn og version.",
  ...
  "settings.general.deepagent.mode.description": "Vælg DeepAgents arbejdsintensitet.",
  ...
  "settings.providers.section.deepagentBackends": "DeepAgent-modelbackends",
}
