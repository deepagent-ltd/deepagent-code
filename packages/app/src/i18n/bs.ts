export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.deepagent-code.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.deepagentCodeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u DeepAgent Code-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u DeepAgent Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u DeepAgent Code-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u deepagent-code.json",
  ...
  "dialog.server.description": "Promijeni na koji se DeepAgent Code server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija DeepAgent Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku DeepAgent Code timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (deepagent-code.json) provider/model names",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: DeepAgent Code još ne podržava MCP autentifikaciju.',
  ...
  "session.export.action": "Izvezi snimak",
  "session.export.success": "Snimak sesije izvezen",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako DeepAgent Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description":
    "Odaberi da li DeepAgent Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu DeepAgent Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se DeepAgent Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju DeepAgent Code-a.",
  ...
  "settings.providers.section.consoleAccount": "Console račun",
  "settings.providers.console.activeOrg": "Aktivna organizacija",
  "settings.providers.console.noOrg": "Nije odabrana organizacija",
  "settings.providers.console.switchOrg": "Promijeni organizaciju",
  "settings.providers.console.empty": "Nema Console organizacija za promjenu",
  "settings.providers.console.managedCount": "{{count}} provajdera kojima upravlja Console",
  "settings.providers.console.switch.toast.title": "Console organizacija promijenjena",
  "settings.providers.console.switch.toast.description": "Sada se koristi {{org}}",
  ...
  "settings.providers.tag.configError": "Greška u konfiguraciji",
  "settings.providers.error.json": "Greška u JSON sintaksi",
  "settings.providers.error.schema": "Nevažeća polja",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code (snimak)",
  "settings.import.snapshot.file": "Paket snimka",
  "settings.import.snapshot.file.hint": "Odaberite izvezeni paket snimka sesije (.json). Bice uvezen kao nova nastavljiva sesija.",
  "settings.import.snapshot.noFile": "Prvo odaberite datoteku paketa snimka",
  "settings.import.snapshot.done": "Snimak uvezen kao nova nastavljiva sesija",
  "settings.import.bundle.file": "Paket sesije",
  "settings.import.bundle.file.hint": "Odaberite ZIP sesije (.zip) ili stariji snimak (.json). Uvoz je arhiva samo za čitanje.",
  "settings.import.bundle.done": "Sesija je uvezena kao arhiva samo za čitanje",
  "settings.import.bundle.link": "Link za dijeljenje",
  "settings.import.bundle.link.hint": "Zalijepite link za dijeljenje DeepAgent paketa umjesto odabira datoteke.",
  ...
  "settings.about.product.description": "Naziv i verzija aplikacije.",
  ...
  "settings.general.deepagent.mode.description": "Odaberite intenzitet rada DeepAgenta.",
  ...
  "settings.general.row.shell.autoDefault": "Auto (zadano)",
  ...
  "settings.providers.section.deepagentBackends": "DeepAgent model backendi",
}
