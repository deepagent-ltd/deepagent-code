export const dict = {
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: DeepAgent Code još ne podržava MCP autentifikaciju.',
  ...
  "settings.general.row.colorScheme.description": "Odaberi da li DeepAgent Code prati sistemsku, svijetlu ili tamnu temu",
