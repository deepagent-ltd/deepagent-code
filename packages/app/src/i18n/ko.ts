export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "Claude, GPT, Gemini 등을 포함한 엄선된 모델",
  "dialog.provider.deepagent-code.tagline": "신뢰할 수 있는 최적화 모델",
  "dialog.provider.deepagentCodeGo.tagline": "모두를 위한 저렴한 구독",
  ...
  "dialog.model.unpaid.freeModels.title": "DeepAgent Code에서 제공하는 무료 모델",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 DeepAgent Code에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 DeepAgent Code에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 DeepAgent Code에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.plugins.empty": "deepagent-code.json에 구성된 플러그인",
  ...
  "dialog.server.description": "이 앱이 연결할 DeepAgent Code 서버를 전환합니다.",
  ...
  "context.stats.conversationTokens": "대화 총 토큰",
  ...
  "context.usage.totalTokens": "대화 총 토큰",
  ...
  "toast.update.description": "DeepAgent Code의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 DeepAgent Code 팀에 제보해 주세요: ",
  ...
  "error.chain.checkConfig": "구성(deepagent-code.json)의 공급자/모델 이름을 확인하세요",
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: DeepAgent Code는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "session.export.action": "스냅샷 내보내기",
  "session.export.success": "세션 스냅샷을 내보냈습니다",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.general.section.sharing": "공유",
  "settings.general.row.shareUrl.title": "공유 서버 URL",
  "settings.general.row.shareUrl.description": "세션 공유 시 사용하는 서버의 기본 URL입니다. 비워 두면 기본값을 사용합니다.",
  "settings.general.row.shareUrl.placeholder": "https://opncd.ai",
  "settings.general.row.expertPanelDefault.title": "전문가 패널을 기본으로 활성화",
  "settings.general.row.expertPanelDefault.description": "새 대화를 전문가 패널이 활성화된 상태로 시작하여 버튼으로 현재 컨텍스트를 필요할 때 검토할 수 있게 합니다.",
  "settings.general.section.display": "디스플레이",
  "settings.general.section.power": "전원",
  "settings.general.row.language.title": "언어",
  "settings.general.row.language.description": "DeepAgent Code 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 DeepAgent Code가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "DeepAgent Code가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "DeepAgent Code 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "DeepAgent Code를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 DeepAgent Code를 사용 중입니다.",
  ...
  "settings.providers.section.consoleAccount": "Console 계정",
  "settings.providers.console.activeOrg": "활성 조직",
  "settings.providers.console.noOrg": "선택된 조직 없음",
  "settings.providers.console.switchOrg": "조직 전환",
  "settings.providers.console.empty": "전환 가능한 Console 조직 없음",
  "settings.providers.console.managedCount": "Console 관리 공급자 {{count}}개",
  "settings.providers.console.switch.toast.title": "Console 조직 전환됨",
  "settings.providers.console.switch.toast.description": "현재 {{org}} 사용 중",
  ...
  "settings.providers.tag.configError": "구성 오류",
  "settings.providers.error.json": "JSON 구문 오류",
  "settings.providers.error.schema": "잘못된 필드",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code(스냅샷)",
  "settings.import.snapshot.file": "스냅샷 번들",
  "settings.import.snapshot.file.hint": "내보낸 세션 스냅샷 번들(.json)을 선택하세요. 계속할 수 있는 새 세션으로 가져옵니다.",
  "settings.import.snapshot.noFile": "먼저 스냅샷 번들 파일을 선택하세요",
  "settings.import.snapshot.done": "스냅샷을 계속할 수 있는 새 세션으로 가져왔습니다",
  "settings.import.bundle.file": "세션 번들",
  "settings.import.bundle.file.hint": "세션 ZIP(.zip) 또는 이전 스냅샷(.json)을 선택하세요. 읽기 전용 보관함으로 가져옵니다.",
  "settings.import.bundle.done": "세션을 읽기 전용 보관함으로 가져왔습니다",
  "settings.import.bundle.link": "공유 링크",
  "settings.import.bundle.link.hint": "파일을 선택하는 대신 DeepAgent 번들 공유 링크를 붙여넣으세요.",
  ...
  "settings.about.product.title": "제품",
  "settings.about.product.description": "애플리케이션 이름과 버전입니다.",
  ...
  "settings.general.deepagent.mode.description": "DeepAgent의 작업 강도를 선택하세요.",
  ...
  "settings.general.deepagent.selfLearning.manual": "수동 승인",
  "settings.general.deepagent.selfLearning.manual.description": "학습한 지식은 승인할 때까지 검토에 대기합니다.",
  "settings.general.deepagent.selfLearning.auto": "자동 승인",
  "settings.general.deepagent.selfLearning.auto.description": "학습한 지식은 검토 없이 즉시 검색 가능해집니다.",
  ...
  "settings.general.row.showFileTree.description": "데스크톱 세션에서 파일 트리 패널을 표시합니다",
  "settings.general.row.showNavigation.title": "탐색 컨트롤",
  "settings.general.row.showNavigation.description": "데스크톱 제목 표시줄에 뒤로/앞으로 버튼을 표시합니다",
  ...
  "settings.general.row.showCustomAgents.description": "v2 데스크톱 작성기에 에이전트 선택기를 표시합니다",
  ...
  "settings.general.row.preventSleep.title": "시스템 절전 방지",
  "settings.general.row.preventSleep.description": "앱이 실행되는 동안 시스템을 절전 상태로 전환하지 않습니다. 디스플레이는 꺼질 수 있습니다",
