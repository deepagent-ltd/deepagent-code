export const dict = {
  ...
  "settings.about.attribution.title": "สร้างบน opencode",
  "settings.about.attribution.description": "DeepAgent Code สร้างบน opencode และใช้งานภายใต้สัญญาอนุญาต MIT",
  ...
  "settings.general.deepagent.mode.ultraRequiresWish": "ultra ต้องใช้โหมดสถานการณ์ wish",
  ...
  "settings.general.deepagent.prompt.wish": "โหมด wish",
  "settings.general.deepagent.prompt.wish.description":
    "DeepAgent เตรียมพรอมป์ฉบับสมบูรณ์ก่อน แล้วให้คุณตรวจทานและแก้ไข",
  "settings.general.deepagent.wishModel.title": "โมเดลโหมด wish",
  "settings.general.deepagent.wishModel.description": "เลือกโมเดลที่ใช้เฉพาะเพื่อเตรียมฉบับร่างพรอมป์ในโหมด wish",
