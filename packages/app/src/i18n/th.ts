export const dict = {
  ...
  "dialog.provider.deepagent-code.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.deepagent-code.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.deepagentCodeGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย DeepAgent Code",
  ...
  "provider.connect.apiKey.description":
    "ป้อนคีย์ API ของ {{provider}} เพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน DeepAgent Code",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " เพื่อรวบรวมรหัสการอนุญาตของคุณเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน DeepAgent Code",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " และป้อนรหัสด้านล่างเพื่อเชื่อมต่อบัญชีและใช้โมเดล {{provider}} ใน DeepAgent Code",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน deepagent-code.json",
  ...
  "dialog.server.description": "สลับเซิร์ฟเวอร์ DeepAgent Code ที่แอปนี้เชื่อมต่อด้วย",
  ...
  "toast.update.description": "เวอร์ชันใหม่ของ DeepAgent Code ({{version}}) พร้อมใช้งานสำหรับติดตั้ง",
  ...
  "error.page.report.prefix": "โปรดรายงานข้อผิดพลาดนี้ให้ทีม DeepAgent Code",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (deepagent-code.json) ชื่อผู้ให้บริการ/โมเดล",
  "error.chain.mcpFailed":
    'เซิร์ฟเวอร์ MCP "{{name}}" ล้มเหลว โปรดทราบว่า DeepAgent Code ยังไม่รองรับการตรวจสอบสิทธิ์ MCP',
  ...
  "session.export.action": "ส่งออกสแนปชอต",
  "session.export.success": "ส่งออกสแนปชอตเซสชันแล้ว",
  ...
  "sidebar.gettingStarted.line1": "DeepAgent Code รวมถึงโมเดลฟรีเพื่อให้คุณเริ่มต้นได้ทันที",
  ...
  "settings.general.row.appearance.description": "ปรับแต่งวิธีการที่ DeepAgent Code มีลักษณะบนอุปกรณ์ของคุณ",
  "settings.general.row.colorScheme.title": "โทนสี",
  "settings.general.row.colorScheme.description": "เลือกว่าจะให้ DeepAgent Code ใช้ธีมตามระบบ สว่าง หรือมืด",
  "settings.general.row.theme.title": "ธีม",
  "settings.general.row.theme.description": "ปรับแต่งวิธีการที่ DeepAgent Code มีธีม",
  ...
  "settings.updates.row.startup.description": "ตรวจสอบการอัปเดตโดยอัตโนมัติเมื่อ DeepAgent Code เปิดใช้งาน",
  ...
  "settings.updates.toast.latest.description": "คุณกำลังใช้งาน DeepAgent Code เวอร์ชันล่าสุด",
  ...
  "settings.providers.section.consoleAccount": "บัญชี Console",
  "settings.providers.console.activeOrg": "องค์กรที่ใช้งาน",
  "settings.providers.console.noOrg": "ยังไม่ได้เลือกองค์กร",
  "settings.providers.console.switchOrg": "สลับองค์กร",
  "settings.providers.console.empty": "ไม่มีองค์กร Console ที่สลับได้",
  "settings.providers.console.managedCount": "ผู้ให้บริการที่จัดการโดย Console {{count}} ราย",
  "settings.providers.console.switch.toast.title": "สลับองค์กร Console แล้ว",
  "settings.providers.console.switch.toast.description": "กำลังใช้ {{org}}",
  ...
  "settings.providers.tag.configError": "ข้อผิดพลาดการตั้งค่า",
  "settings.providers.error.json": "ข้อผิดพลาดไวยากรณ์ JSON",
  "settings.providers.error.schema": "ฟิลด์ไม่ถูกต้อง",
...
"settings.capabilities.availability.unavailable": "Unavailable",
  ...
  "settings.import.preset.deepagent": "DeepAgent Code (สแนปชอต)",
  "settings.import.snapshot.file": "ชุดสแนปชอต",
  "settings.import.snapshot.file.hint": "เลือกชุดสแนปชอตเซสชันที่ส่งออก (.json) จะนำเข้าเป็นเซสชันใหม่ที่ทำงานต่อได้",
  "settings.import.snapshot.noFile": "เลือกไฟล์ชุดสแนปชอตก่อน",
  "settings.import.snapshot.done": "นำเข้าสแนปชอตเป็นเซสชันใหม่ที่ทำงานต่อแล้ว",
  "settings.import.bundle.file": "ชุดข้อมูลเซสชัน",
  "settings.import.bundle.file.hint": "เลือกไฟล์ ZIP ของเซสชัน (.zip) หรือสแนปชอตรุ่นเก่า (.json) โดยจะนำเข้าเป็นคลังข้อมูลแบบอ่านอย่างเดียว",
  "settings.import.bundle.done": "นำเข้าเซสชันเป็นคลังข้อมูลแบบอ่านอย่างเดียวแล้ว",
  "settings.import.bundle.link": "ลิงก์แชร์",
  "settings.import.bundle.link.hint": "วางลิงก์แชร์ชุดข้อมูล DeepAgent แทนการเลือกไฟล์",
  ...
  "settings.about.product.title": "ผลิตภัณฑ์",
  "settings.about.product.description": "ชื่อและเวอร์ชันของแอปพลิเคชัน",
  ...
  "settings.general.deepagent.mode.description": "เลือกความเข้มข้นในการทำงานของ DeepAgent",
  ...
  "settings.general.deepagent.mode.ultraRequiresIntelligence": "ultra ต้องใช้โหมดสถานการณ์ intelligence",
  ...
  "settings.general.deepagent.prompt.title": "โหมดสถานการณ์",
  "settings.general.deepagent.prompt.description": "เลือกวิธีที่ตัวเขียนจัดการพรอมป์ก่อนส่ง",
  "settings.general.deepagent.prompt.direct": "โหมดส่งตรง",
  "settings.general.deepagent.prompt.direct.description": "ส่งพรอมป์ตามที่เขียน โดยไม่ให้ DeepAgent เตรียมฉบับร่าง",
  "settings.general.deepagent.prompt.intelligence": "โหมด intelligence",
  "settings.general.deepagent.prompt.intelligence.description":
    "DeepAgent เตรียมพรอมป์ฉบับสมบูรณ์ก่อน แล้วให้คุณตรวจทานและแก้ไข",
  "settings.general.deepagent.intelligenceModel.title": "โมเดลโหมด intelligence",
  "settings.general.deepagent.intelligenceModel.description": "เลือกโมเดลที่ใช้เฉพาะเพื่อเตรียมฉบับร่างพรอมป์ในโหมด intelligence",
  "settings.general.deepagent.selfLearning.title": "การอนุมัติการเรียนรู้ด้วยตนเอง",
  "settings.general.deepagent.selfLearning.description":
    "กำหนดว่าความรู้ที่ DeepAgent เรียนรู้จากเซสชันของคุณจะค้นคืนได้อย่างไร",
  "settings.general.deepagent.selfLearning.manual": "อนุมัติด้วยตนเอง",
  "settings.general.deepagent.selfLearning.manual.description":
    "ความรู้ที่เรียนรู้จะรออยู่ใน Review จนกว่าคุณจะอนุมัติ",
  "settings.general.deepagent.selfLearning.auto": "อนุมัติอัตโนมัติ",
  "settings.general.deepagent.selfLearning.auto.description": "ความรู้ที่เรียนรู้จะค้นคืนได้ทันทีโดยไม่ต้องตรวจทาน",
  "settings.general.row.shell.title": "เชลล์เทอร์มินัล",
  "settings.general.row.shell.description":
    "เลือกเชลล์ที่ใช้ในเทอร์มินัล เชลล์ที่เข้ากันได้จะใช้กับการเรียกเครื่องมือของเอเจนต์ด้วย",
  "settings.general.row.shell.autoDefault": "อัตโนมัติ (ค่าเริ่มต้น)",
  "settings.general.row.shell.terminalOnly": "เฉพาะเทอร์มินัล",
  "settings.general.row.showFileTree.title": "ผังไฟล์",
  "settings.general.row.showFileTree.description": "แสดงแผงผังไฟล์ในเซสชันเดสก์ท็อป",
  "settings.general.row.showNavigation.title": "ตัวควบคุมการนำทาง",
  "settings.general.row.showNavigation.description": "แสดงปุ่มย้อนกลับและไปข้างหน้าในแถบชื่อเดสก์ท็อป",
  "settings.general.row.showSearch.title": "พาเล็ตคำสั่ง",
  "settings.general.row.showSearch.description": "แสดงปุ่มค้นหาและพาเล็ตคำสั่งในแถบชื่อเดสก์ท็อป",
  "settings.general.row.showTerminal.title": "เทอร์มินัล",
  "settings.general.row.showTerminal.description": "แสดงปุ่มเทอร์มินัลในแถบชื่อเดสก์ท็อป",
  "settings.general.row.showStatus.title": "สถานะเซิร์ฟเวอร์",
  "settings.general.row.showStatus.description": "แสดงปุ่มสถานะเซิร์ฟเวอร์ในแถบชื่อเดสก์ท็อป",
  "settings.general.row.showCustomAgents.title": "เอเจนต์แบบกำหนดเอง",
  "settings.general.row.showCustomAgents.description": "แสดงตัวเลือกเอเจนต์ในตัวเขียนเดสก์ท็อป v2",
