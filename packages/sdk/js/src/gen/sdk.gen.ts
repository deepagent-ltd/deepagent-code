...
import type {
  ...
  SessionContinuationResolutionListErrors,
  SessionContinuationResolutionListResponses,
  SessionContinuationResolutionResolveErrors,
  SessionContinuationResolutionResolveResponses,
  SessionCreateErrors,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new DeepAgentCodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the DeepAgent Code system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the DeepAgent Code system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global DeepAgent Code configuration settings and preferences.
   */
   ...
   *
   * Update global DeepAgent Code configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the DeepAgent Code server.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all DeepAgent Code instances, releasing all resources.
   */
  ...
  /**
   * Upgrade deepagent-code
   *
   * Upgrade deepagent-code to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current DeepAgent Code configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update DeepAgent Code configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Knowledge extends HeyApiClient {
  /**
   * Promote reviewed DeepAgent knowledge
   *
  ...
  /**
   * Reject reviewed DeepAgent knowledge
   *
...
export class Deepagent extends HeyApiClient {
  ...
  public reviews<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<DeepagentReviewsResponses, DeepagentReviewsErrors, ThrowOnError>({
...
export class Messages extends HeyApiClient {
  ...
  public thread<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ImMessagesThreadResponses, ImMessagesThreadErrors, ThrowOnError>({
  ...
  public search<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ImMessagesSearchResponses, ImMessagesSearchErrors, ThrowOnError>({
...
export class Attachments extends HeyApiClient {
  ...
  public list<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ImAttachmentsListResponses, ImAttachmentsListErrors, ThrowOnError>({
  ...
  public upload<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ImAttachmentsUploadResponses, ImAttachmentsUploadErrors, ThrowOnError>(
      {
        ...formDataBodySerializer,
        url: "/api/v1/im/attachments",
        ...options,
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current DeepAgent Code instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the DeepAgent Code system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with DeepAgent Code.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that DeepAgent Code is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by DeepAgent Code.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all DeepAgent Code sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific DeepAgent Code session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
  ...
  /**
   * Resolve a failed compaction continuation
   *
   * Replay only proven undispatched continuations, or abandon with explicit risk acknowledgement.
   */
  public continuationResolutionResolve<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
      directory?: string
      workspace?: string
...
export class Events extends HeyApiClient {
  /**
   * Read the session event journal watermark
   *
   * Returns the durable event journal high-water cursor (null when the journal is empty).
   */
  public cursor<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
    },
    options?: Options<never, ThrowOnError>,
...
export class Session3 extends HeyApiClient {
   ...
   *
   * Durable cursor replay of a session's event journal; reconnect with after=<cursor> to resume.
   */
  public events<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class DeepAgentCodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<DeepAgentCodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    DeepAgentCodeClient.__registry.set(this, args?.key)
  }
