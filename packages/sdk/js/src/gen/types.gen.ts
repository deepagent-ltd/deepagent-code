...
/**
 * Server configuration for deepagent-code serve and web commands
 */
...
export type Path = {
  ...
  agent: {
    ...
    providerExecutedToolPolicy: "deny_by_default" | "allowlist_required"
    ...
    coverage: Array<{
      surface: string
      status: "covered" | "planned" | "blocked"
      note: string
    }>
  }
}
...
export type CapabilityCatalog = {
  ...
  capabilities: Array<{
    ...
    availability: "stable" | "maintenance_only" | "disabled" | "unavailable"
    required_permissions: Array<string>
    required_runtime_features: Array<string>
    entry_tools: Array<string>
    body_ref: string
    body_hash?: string
...
export type CapabilityLoadReceipt = {
  identity: string
  capabilityId: string
  version: string
  bodyRef: string
...
export type CapabilityLoadReceipts = {
  receipts: Array<CapabilityLoadReceipt>
  count: number
}
...
export type ContextReadiness = {
  ...
  ready: boolean
  graphs: Array<{
    graph: "code" | "documents" | "knowledge" | "memory"
    status: "ready" | "empty" | "degraded_unavailable" | "denied" | "timeout"
    revision: string
    adapterVersion: string
    observedMutationEpoch: number
    latencyMs: number
...
export type ContextEventsCursor = {
  watermark: number
  cursor: number
  floor: number
}
...
export type ContextSessionEvents = {
  events: Array<ContextSessionEvent>
  nextCursor?: number
  floor: number
}

export type SystemContextLoadedCapability = {
  capabilityId: string
  bodyHash: string
  state: string
  tokenCount: number
...
export type SystemContextSnapshot = {
  ...
  catalogDigestConsistent: boolean
  l0LineCount: number
  l0TextHash: string
  loadedCapabilityCount: number
  loadedCapabilities: Array<SystemContextLoadedCapability>
}
...
export type ProviderModelDiscoverError = {
  message: string
}
...
export type UpgradeRunUpgradeRun = {
  ...
  pendingMigrationIds: Array<string>
  state: "planned" | "backup_verified" | "applying" | "verifying" | "ready" | "recovery_required"
  failureCode?: string
...
export type RecoveryExactDescriptor = {
  schemaVersion: "recovery-descriptor.v1"
  requestHash: string
  provenance: {
    origin: "recorded" | "reconstructed" | "external"
...
export type RecoveryRepairableDescriptor = {
  schemaVersion: "recovery-descriptor.v1"
  requestHash: string
  provenance: {
    origin: "recorded" | "reconstructed" | "external"
  ...
  repairable: {
    baselineState: "corrupt" | "missing"
    sourceSnapshotRef: string
    canReconstruct: boolean
  }
}

export type RecoveryForkDescriptor = {
  schemaVersion: "recovery-descriptor.v1"
  requestHash: string
  provenance: {
    origin: "recorded" | "reconstructed" | "external"
  ...
  fork: {
    safeBoundaryRef: string
    safeBoundaryHash: string
    reasonCode:
      | "network_unknown"
      | "baseline_missing"
      | "baseline_corrupt"
      ...
      | "cas_lost"
      | "unsupported_state"
    originalSessionReadOnly: boolean
  }
}

export type RecoveryCoordinationDescriptor = {
  schemaVersion: "recovery-descriptor.v1"
  requestHash: string
  provenance: {
    origin: "recorded" | "reconstructed" | "external"
  ...
  coordination: {
    reason:
      ...
      | "cas_lost"
      | "unsupported_state"
    requiredActor: "admin" | "external" | "provider_lookup"
    evidenceExportRef?: string
  }
}

export type RecoveryResolvedDescriptor = {
  schemaVersion: "recovery-descriptor.v1"
  requestHash: string
  provenance: {
    origin: "recorded" | "reconstructed" | "external"
  ...
  resolved: {
    ...
    bridgeRef: string
    terminal: "settled" | "abandoned" | "forked" | "unknown"
  }
}
...
export type DeepagentReviewsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type DeepagentReviewsError = DeepagentReviewsErrors[keyof DeepagentReviewsErrors]

export type DeepagentReviewsResponses = {
  /**
  ...
  200: {
    reviews: Array<{
      ...
      learningCandidates: Array<{
        ...
        status: string
        sourceRunId: string
        sourceRound: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
        summary: string
...
export type DeepagentReviewsResponse = DeepagentReviewsResponses[keyof DeepagentReviewsResponses]

export type DeepagentKnowledgePromoteData = {
  body?: {
    candidate: {
      candidate_id: string
      type: "memory" | "strategy" | "methodology"
      ...
      source_round: number | "NaN" | "Infinity" | "-Infinity" | "Infinity" | "-Infinity" | "NaN"
      summary: string
...
export type DeepagentKnowledgePromoteErrors = {
  /**
...
export type DeepagentKnowledgePromoteError = DeepagentKnowledgePromoteErrors[keyof DeepagentKnowledgePromoteErrors]

export type DeepagentKnowledgePromoteResponses = {
  /**
   * Human-approved promoted DeepAgent knowledge record
   */
  200: {
    promoted: {
      id: string
...
export type DeepagentKnowledgePromoteResponse =
  DeepagentKnowledgePromoteResponses[keyof DeepagentKnowledgePromoteResponses]

export type DeepagentKnowledgeRejectData = {
  body?: {
    candidate: {
      candidate_id: string
      type: "memory" | "strategy" | "methodology"
...
export type DeepagentKnowledgeRejectErrors = {
  /**
   * DeepAgentPromotionError | InvalidRequestError
   */
  400: DeepAgentPromotionError | InvalidRequestError
...
export type DeepagentKnowledgeRejectError = DeepagentKnowledgeRejectErrors[keyof DeepagentKnowledgeRejectErrors]

export type DeepagentKnowledgeRejectResponses = {
  /**
   * Rejected DeepAgent knowledge candidate
   */
  200: {
    rejected: {
      candidateId: string
...
export type CapabilityCatalogError = CapabilityCatalogErrors[keyof CapabilityCatalogErrors]

export type CapabilityCatalogResponses = {
  /**
...
export type CapabilityCatalogResponse = CapabilityCatalogResponses[keyof CapabilityCatalogResponses]
...
export type CapabilitySearchError = CapabilitySearchErrors[keyof CapabilitySearchErrors]

export type CapabilitySearchResponses = {
  /**
   * L1 capability search cards
   */
  200: {
    cards: Array<{
      id: string
...
export type CapabilitySearchResponse = CapabilitySearchResponses[keyof CapabilitySearchResponses]
...
export type CapabilityLoadReceiptsError = CapabilityLoadReceiptsErrors[keyof CapabilityLoadReceiptsErrors]

export type CapabilityLoadReceiptsResponses = {
  /**
   * Capability load receipts
   */
  200: CapabilityLoadReceipts
}

export type CapabilityLoadReceiptsResponse = CapabilityLoadReceiptsResponses[keyof CapabilityLoadReceiptsResponses]

export type ContextReadinessData = {
  body?: never
  path?: never
  query: {
    session_id: string
...
export type ContextReadinessError = ContextReadinessErrors[keyof ContextReadinessErrors]

export type ContextReadinessResponses = {
  /**
   * Four-graph context readiness
   */
  200: ContextReadiness
}

export type ContextReadinessResponse = ContextReadinessResponses[keyof ContextReadinessResponses]

export type ContextEventsCursorData = {
  body?: never
  path?: never
  query: {
    session_id: string
...
export type ContextEventsCursorError = ContextEventsCursorErrors[keyof ContextEventsCursorErrors]

export type ContextEventsCursorResponses = {
  /**
   * Event cursor (snapshot-at-watermark)
   */
  200: ContextEventsCursor
}

export type ContextEventsCursorResponse = ContextEventsCursorResponses[keyof ContextEventsCursorResponses]

export type ContextEventsData = {
  body?: never
  path?: never
  query: {
    session_id: string
...
export type ContextEventsError = ContextEventsErrors[keyof ContextEventsErrors]

export type ContextEventsResponses = {
  /**
   * Durable session events drained after a cursor
   */
  200: ContextSessionEvents
}

export type ContextEventsResponse = ContextEventsResponses[keyof ContextEventsResponses]
...
export type SystemContextSnapshotError = SystemContextSnapshotErrors[keyof SystemContextSnapshotErrors]

export type SystemContextSnapshotResponses = {
  /**
   * System context snapshot diagnostics
   */
  200: SystemContextSnapshot
}

export type SystemContextSnapshotResponse = SystemContextSnapshotResponses[keyof SystemContextSnapshotResponses]
...
export type ProviderModelsDiscoverErrors = {
  /**
   * ProviderModelDiscoverError | InvalidRequestError
   */
  400: ProviderModelDiscoverError | InvalidRequestError
}
...
export type SessionPromptPrepareErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type SessionPromptPrepareResponses = {
  /**
   * Prepared prompt draft
   */
  200: {
...
export type SessionContinuationResolutionListData = {
  ...
  url: "/session/{sessionID}/continuation-resolution"
}

export type SessionContinuationResolutionListErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type SessionContinuationResolutionListError =
  SessionContinuationResolutionListErrors[keyof SessionContinuationResolutionListErrors]

export type SessionContinuationResolutionListResponses = {
  /**
  ...
  200: Array<{
    ...
    runID: string
    sessionID: string
    sourceState: "pending" | "admitted" | "dispatching" | "unknown"
    reason: string
...
export type SessionContinuationResolutionListResponse =
  SessionContinuationResolutionListResponses[keyof SessionContinuationResolutionListResponses]

export type SessionContinuationResolutionResolveData = {
  body: {
    runID: string
    failureID: string
    commandID: string
    decision: "abandoned" | "replay"
    reason: string
    riskAcknowledged?: boolean
  }
  path: {
...
export type SessionContinuationResolutionResolveErrors = {
  /**
   * BadRequest | InvalidRequestError
   */
  400: EffectHttpApiErrorBadRequest | InvalidRequestError
...
export type SessionContinuationResolutionResolveError =
  SessionContinuationResolutionResolveErrors[keyof SessionContinuationResolutionResolveErrors]

export type SessionContinuationResolutionResolveResponses = {
  /**
   * Resolved continuation outcome
   */
  200: {
    resolutionID: string
    failureID: string
...
export type SessionContinuationResolutionResolveResponse =
  SessionContinuationResolutionResolveResponses[keyof SessionContinuationResolutionResolveResponses]
...
export type V2SessionEventsData = {
  ...
  url: "/api/session/{sessionID}/events"
}
...
export type V2SessionEventsCursorData = {
  body?: never
  path: {
    sessionID: string
  }
  query?: never
  url: "/api/session/{sessionID}/events/cursor"
}

export type V2SessionEventsCursorErrors = {
  /**
   * InvalidRequestError
   */
  400: InvalidRequestError
...
export type V2SessionEventsCursorError = V2SessionEventsCursorErrors[keyof V2SessionEventsCursorErrors]

export type V2SessionEventsCursorResponses = {
  /**
   * Success
   */
  200: {
...
export type V2SessionEventsCursorResponse = V2SessionEventsCursorResponses[keyof V2SessionEventsCursorResponses]
