...
const samples = [
  {
    tool: "apply_patch",
    error:
      "apply_patch verification failed: Failed to find expected lines in /Users/example/Projects/deepagent-code/packages/ui/src/components/session-turn.tsx",
  },
  {
    tool: "bash",
  ...
  },
  {
    tool: "read",
    error:
      "read File not found: /Users/example/Projects/deepagent-code/packages/ui/src/components/does-not-exist.tsx",
  },
  {
    tool: "glob",
