...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "En iyi açık kaynak modellere güvenilir erişim için DeepAgent Code Go'ya abone olun. Aylık $5'tan başlar.",
  ...
  "ui.message.duration.hoursMinutes": "{{hours}}sa {{minutes}}dk",
