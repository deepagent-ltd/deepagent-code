...
export const dict = {
  ...
  "ui.sessionTurn.retry.noChannel": "网关列出了该模型，但当前分组没有可用渠道——请换一个模型，或修正网关的分组配置",
  ...
  "dialog.usageExceeded.freeTier.description": "订阅 DeepAgent Code Go，可靠地使用最佳开源模型，每月 $5 起。",
  ...
  "ui.message.duration.hoursMinutes": "{{hours}}时 {{minutes}}分",
