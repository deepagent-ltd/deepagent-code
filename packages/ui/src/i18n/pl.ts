export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subskrybuj DeepAgent Code Go, aby uzyskać niezawodny dostęp do najlepszych modeli open source, od $5/miesiąc.",
  ...
  "ui.message.duration.hoursMinutes": "{{hours}}g {{minutes}}m",
}
