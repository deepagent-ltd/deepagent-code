...
const STORAGE_KEYS = {
  THEME_ID: "deepagent-code-theme-id",
  COLOR_SCHEME: "deepagent-code-color-scheme",
  THEME_CSS_LIGHT: "deepagent-code-theme-css-light",
  THEME_CSS_DARK: "deepagent-code-theme-css-dark",
} as const
