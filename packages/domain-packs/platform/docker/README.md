...
Dockerfiles, container build context, image contents, compose dev services, secrets, and reproducible container validation.

## Out of Scope

Does not approve production Kubernetes or cloud IAM changes.
