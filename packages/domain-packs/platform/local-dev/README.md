...
Local dev server startup, workspace dependencies, ports, env files, watchers, and quick smoke validation.

## Out of Scope

Does not mutate production services or secrets.
...
Depends on: code.environment. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
