...
Cloud resource planning, IAM-sensitive configuration review, deployment prerequisites, diagnostics, and cloud environment validation.

## Out of Scope

Does not create or mutate cloud resources without explicit user approval and runtime permission.
...
Depends on: risk.security, code.environment. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
