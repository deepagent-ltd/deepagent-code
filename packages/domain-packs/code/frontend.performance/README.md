...
Browser runtime performance, bundle cost, render timing, layout shift, hydration, and frontend profiling.

## Out of Scope

Does not replace general backend/database performance packs.
...
Depends on: code.frontend.web, code.performance. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
