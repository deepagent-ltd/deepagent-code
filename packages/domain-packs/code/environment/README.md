...
Local setup, runtime readiness, smoke tests, dependency drift, environment diagnostics, and reproducible developer workflows.

## Out of Scope

Does not provision production infrastructure or approve cloud access.
