...
Developer documentation, README/API docs, ADRs, changelogs, onboarding, diagrams, and evidence-linked reports.

## Out of Scope

Does not invent product claims or replace legal/compliance text.
