...
Module boundaries, ownership, architectural decisions, dependency direction, ADR-style tradeoffs, and system shape review.

## Out of Scope

Does not replace domain-specific implementation packs or organization governance approval.
...
Depends on: code.core. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
