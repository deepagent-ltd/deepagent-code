...
Version upgrades, API migrations, compatibility windows, codemods, staged rollout, and migration validation.

## Out of Scope

Does not own database destructive migration policy or production rollout approval.
