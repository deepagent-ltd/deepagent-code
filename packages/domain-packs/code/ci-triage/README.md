...
CI failure normalization, first failing command extraction, workflow-log evidence, and regression classification.

## Out of Scope

Does not own production deployment or provider-specific cloud authorization.
