...
Keyboard access, accessible names, ARIA state, focus management, contrast, and a11y regression checks.

## Out of Scope

Does not certify legal compliance; it supplies engineering checks and risk evidence.
...
Depends on: code.frontend.web. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
