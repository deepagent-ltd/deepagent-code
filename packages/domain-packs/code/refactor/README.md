...
Behavior-preserving structure changes, API consolidation, call graph checks, and regression validation.

## Out of Scope

Does not justify behavior changes under a refactor label.
