...
Performance diagnosis, profiling evidence, bottleneck attribution, latency/throughput tradeoffs, and regression-safe optimization.

## Out of Scope

Does not own GPU-specific kernel optimization or database-specific query tuning when those packs are active.
...
Depends on: code.testing. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
