...
Logs, metrics, traces, correlation IDs, diagnostic queries, and telemetry safety for code tasks.

## Out of Scope

Does not own vendor-specific cloud operations or privacy/legal approval.
...
Depends on: code.debugging. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
