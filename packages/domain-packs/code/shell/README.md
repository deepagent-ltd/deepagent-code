...
Shell Scripting language-specific build, test, package, idiom, and diagnostics guidance.

## Out of Scope

Framework, platform, database, and security-specific behavior belongs to more specific packs when active.
