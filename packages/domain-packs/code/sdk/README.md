...
Generated clients, SDK surface compatibility, examples, semantic versioning, and contract tests.

## Out of Scope

Does not own server API semantics beyond client contract evidence.
...
Depends on: code.backend.api, code.testing. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
