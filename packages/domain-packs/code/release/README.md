...
Release evidence, changelog, versioning, artifact validation, rollback readiness, and pre-ship risk review.

## Out of Scope

Does not deploy production or approve regulated release decisions automatically.
...
Depends on: code.testing, risk.supply-chain. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
