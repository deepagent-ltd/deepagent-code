...
Benchmark harness hygiene, repeated-run protocols, baseline comparison, variance and outlier handling.

## Out of Scope

Does not choose product performance priorities; it supplies evidence discipline.
...
Depends on: code.performance. This pack should compose with more specific language, framework, risk, or platform packs; it does not override them.
