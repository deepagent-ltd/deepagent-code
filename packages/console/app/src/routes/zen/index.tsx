...
import compareVideo from "../../asset/lander/deepagent-code-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/deepagent-code-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="deepagent-code:auth" content={loggedin() ? "true" : "false"} />
