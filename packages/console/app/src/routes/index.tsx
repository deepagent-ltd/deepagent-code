...
import video from "../asset/lander/deepagent-code-min.mp4"
import videoPoster from "../asset/lander/deepagent-code-poster.png"
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="npm">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">deepagent-code</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
                  ...
                  <Tabs.Content as="pre" data-slot="panel" value="brew">
                    <button data-copy data-slot="command" onClick={handleCopyClick}>
                      <span>
                        ...
                        <span data-slot="highlight">anomalyco/tap/deepagent-code</span>
                      </span>
                      <CopyStatus />
                    </button>
                  </Tabs.Content>
