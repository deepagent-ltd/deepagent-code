...
import { Database, eq, and, isNull } from "@deepagent-code/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@deepagent-code/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#deepagent-code-go")} target="_blank" rel="noopener noreferrer">
