...
import desktopAppIcon from "../../asset/lander/deepagent-code-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://deepagent-code.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>deepagentCode.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g deepagent-code")}>
                <code>
                  npm i -g <strong>deepagent-code</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g deepagent-code")}>
                <code>
                  bun add -g <strong>deepagent-code</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/deepagent-code")}>
                <code>
                  brew install <strong>anomalyco/tap/deepagent-code</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S deepagent-code")}>
                <code>
                  paru -S <strong>deepagent-code</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask deepagent-code-desktop")}>
                <code>
                  brew install --cask <strong>deepagent-code-desktop</strong>
                </code>
                <CopyStatus />
              </button>
