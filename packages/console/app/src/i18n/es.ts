...
export const dict = {
  ...
  "notFound.title": "No encontrado | deepagent-code",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "deepagent-code logo claro",
  "notFound.logoDarkAlt": "deepagent-code logo oscuro",
  ...
  "app.meta.description": "DeepAgent Code - El agente de codificación de código abierto.",

  "home.title": "DeepAgent Code | El agente de codificación IA de código abierto",

  "temp.title": "deepagent-code | Agente de codificación IA creado para la terminal",
  ...
  "temp.feature.zen.afterLink": "proporcionada por deepagent-code",
  ...
  "temp.screenshot.caption": "deepagent-code TUI con el tema tokyonight",
  "temp.screenshot.alt": "deepagent-code TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de deepagent-code claro",
  "temp.logoDarkAlt": "logo de deepagent-code oscuro",
  ...
  "home.what.title": "¿Qué es DeepAgent Code?",
  "home.what.body":
    "DeepAgent Code es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, DeepAgent Code es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "DeepAgent Code no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso DeepAgent Code?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar DeepAgent Code?",
  "home.faq.a3.p1":
    "No necesariamente, DeepAgent Code viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, DeepAgent Code también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con DeepAgent Code?",
  "home.faq.a4.p1":
    "Sí, DeepAgent Code soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar DeepAgent Code en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! DeepAgent Code ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es DeepAgent Code de código abierto?",
  "home.faq.a8.p1": "Sí, DeepAgent Code es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que DeepAgent Code ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "DeepAgent Code Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que DeepAgent Code ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es DeepAgent Code Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá DeepAgent Code negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, DeepAgent Code añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con DeepAgent Code, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de DeepAgent Code.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con DeepAgent Code, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "DeepAgent Code Go | Modelos de programación de bajo coste para todos",
  "go.meta.description":
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de DeepAgent Code a tantas personas como sea posible. DeepAgent Code Go es una suscripción de bajo coste: $5 el primer mes, luego 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.faq.q1": "¿Qué es DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "black.workspace.title": "DeepAgent Code Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de DeepAgent Code Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con deepagent-code cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona deepagent-code",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia deepagent-code y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de deepagentCode.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de deepagent-code Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a DeepAgent Code Black por ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a DeepAgent Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "DeepAgent Code Go" como proveedor en tu configuración de deepagent-code para usar los modelos Go.',
  "workspace.lite.black.message":
    "Actualmente estás suscrito a DeepAgent Code Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a DeepAgent Code Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go comienza en {{price}}, luego $10/mes, y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.title": "DeepAgent Code | Descargar",
  "download.meta.description": "Descarga DeepAgent Code para macOS, Windows y Linux",
  "download.hero.title": "Descargar DeepAgent Code",
  ...
  "download.section.extensions": "Extensiones DeepAgent Code",
  "download.section.integrations": "Integraciones DeepAgent Code",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar DeepAgent Code a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", DeepAgent Code funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "DeepAgent Code es 100% gratuito de usar.",
  ...
  "enterprise.title": "DeepAgent Code | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a DeepAgent Code para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "DeepAgent Code opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. DeepAgent Code por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con DeepAgent Code Enterprise?",
  "enterprise.faq.a4":
    "Sí. DeepAgent Code no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "DeepAgent Code | Marca",
  "brand.meta.description": "Guías de marca de DeepAgent Code",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca DeepAgent Code.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "DeepAgent Code | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de DeepAgent Code",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para DeepAgent Code",
