...
export const dict = {
  ...
  "notFound.title": "غير موجود | deepagent-code",
  "notFound.heading": "404 - الصفحة غير موجودة",
  "notFound.home": "الرئيسية",
  "notFound.docs": "الوثائق",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "شعار deepagent-code الفاتح",
  "notFound.logoDarkAlt": "شعار deepagent-code الداكن",
  ...
  "app.meta.description": "DeepAgent Code - وكيل البرمجة مفتوح المصدر.",

  "home.title": "DeepAgent Code | وكيل برمجة بالذكاء الاصطناعي مفتوح المصدر",

  "temp.title": "deepagent-code | وكيل برمجة بالذكاء الاصطناعي مبني للطرفية",
  ...
  "temp.feature.zen.afterLink": "مقدمة من deepagent-code",
  "temp.feature.models.beforeLink": "يدعم أكثر من 75 مزود LLM من خلال",
  "temp.feature.models.afterLink": "، بما في ذلك النماذج المحلية",
  "temp.screenshot.caption": "واجهة DeepAgent Code الطرفية مع سمة tokyonight",
  "temp.screenshot.alt": "واجهة DeepAgent Code الطرفية بسمة tokyonight",
  "temp.logoLightAlt": "شعار deepagent-code الفاتح",
  "temp.logoDarkAlt": "شعار deepagent-code الداكن",
  ...
  "home.what.title": "ما هو DeepAgent Code؟",
  "home.what.body": "DeepAgent Code وكيل مفتوح المصدر يساعدك على كتابة الكود في الطرفية، IDE، أو سطح المكتب.",
  ...
  "home.growth.body":
    "مع أكثر من <strong>{{stars}}</strong> نجمة على GitHub، و<strong>{{contributors}}</strong> مساهمًا، وأكثر من <strong>{{commits}}</strong> Commit، يستخدم DeepAgent Code ويثق به أكثر من <strong>{{monthlyUsers}}</strong> مطوّر كل شهر.",
  ...
  "home.privacy.body": "لا يخزّن DeepAgent Code أي كود أو بيانات سياق، ليتمكن من العمل في بيئات حساسة للخصوصية.",
  "home.privacy.learnMore": "اعرف المزيد عن",
  "home.privacy.link": "الخصوصية",

  "home.faq.q1": "ما هو DeepAgent Code؟",
  "home.faq.a1":
    "DeepAgent Code وكيل مفتوح المصدر يساعدك على كتابة وتشغيل الكود مع أي نموذج ذكاء اصطناعي. متاح كواجهة طرفية، وتطبيق سطح مكتب، أو امتداد IDE.",
  "home.faq.q2": "كيف أستخدم DeepAgent Code؟",
  "home.faq.a2.before": "أسهل طريقة للبدء هي قراءة",
  "home.faq.a2.link": "المقدمة",
  "home.faq.q3": "هل أحتاج لاشتراكات ذكاء اصطناعي إضافية لاستخدام DeepAgent Code؟",
  "home.faq.a3.p1":
    "ليس بالضرورة، فـ DeepAgent Code يأتي مع مجموعة من النماذج المجانية التي تستطيع استخدامها دون إنشاء حساب.",
  "home.faq.a3.p2.beforeZen": "وبخلاف ذلك، يمكنك استخدام أي من نماذج البرمجة الشائعة بإنشاء حساب",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "مع أننا نشجّع المستخدمين على استخدام Zen، فإن DeepAgent Code يعمل أيضًا مع كل المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",
  "home.faq.a3.p4.beforeLocal": "ويمكنك أيضًا ربط",
  "home.faq.a3.p4.localLink": "النماذج المحلية",
  "home.faq.q4": "هل يمكنني استخدام اشتراكاتي الحالية مع DeepAgent Code؟",
  "home.faq.a4.p1":
    "نعم، يدعم DeepAgent Code خطط الاشتراك من كل المزودين الرئيسيين. يمكنك استخدام اشتراكات Claude Pro/Max، ChatGPT Plus/Pro، أو GitHub Copilot.",
  "home.faq.q5": "هل يمكنني استخدام DeepAgent Code في الطرفية فقط؟",
  "home.faq.a5.beforeDesktop": "ليس بعد الآن! DeepAgent Code متاح الآن كتطبيق لـ",
  "home.faq.a5.desktop": "سطح المكتب",
  "home.faq.a5.and": "و",
  "home.faq.a5.web": "الويب",
  "home.faq.q6": "كم تكلفة DeepAgent Code؟",
  "home.faq.a6":
    "DeepAgent Code مجاني 100% للاستخدام. كما يأتي مع مجموعة من النماذج المجانية. قد توجد تكاليف إضافية إذا ربطت مزوّدًا آخر.",
  ...
  "home.faq.q8": "هل DeepAgent Code مفتوح المصدر؟",
  "home.faq.a8.p1": "نعم، DeepAgent Code مفتوح المصدر بالكامل. الكود المصدري متاح علنًا على",
  ...
  "home.zenCta.body":
    "يمنحك Zen الوصول إلى مجموعة مختارة بعناية من نماذج الذكاء الاصطناعي التي اختبرها DeepAgent Code وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة بين المزودين، استخدم نماذج محققة تعمل بكفاءة.",
  "home.zenCta.link": "تعرف على Zen",

  "zen.title": "DeepAgent Code Zen | مجموعة منسقة من النماذج المحسنة والموثوقة لوكلاء البرمجة",
  "zen.hero.title": "نماذج محسنة وموثوقة لوكلاء البرمجة",
  "zen.hero.body":
    "يمنحك Zen الوصول إلى مجموعة منسقة من نماذج الذكاء الاصطناعي التي اختبرها DeepAgent Code وقاس أداءها خصيصًا لوكلاء البرمجة. لا حاجة للقلق بشأن اختلاف الأداء والجودة، استخدم نماذج محققة تعمل بكفاءة.",

  "zen.faq.q1": "ما هو DeepAgent Code Zen؟",
  "zen.faq.a1":
    "Zen هو مجموعة منسقة من نماذج الذكاء الاصطناعي التي تم اختبارها وقياس أدائها لوكلاء البرمجة، أنشأها الفريق المطور لـ DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen ليس للربح. يمرر Zen التكاليف من مزودي النماذج إليك مباشرة. كلما زاد استخدام Zen، تمكن DeepAgent Code من التفاوض على أسعار أفضل وتمريرها إليك.",
  ...
  "zen.faq.a4.p3":
    "لتغطية التكاليف، يضيف DeepAgent Code فقط رسومًا صغيرة لمعالجة الدفع قدرها 1.23 دولار لكل إعادة شحن رصيد بقيمة 20 دولارًا.",
  ...
  "zen.faq.a8":
    "بينما يعمل Zen بشكل رائع مع DeepAgent Code، يمكنك استخدام Zen مع أي وكيل. اتبع تعليمات الإعداد في وكيل البرمجة المفضل لديك.",
  ...
  "zen.problem.subtitle": "نحن نعمل على إصلاح هذا للجميع، وليس فقط لمستخدمي DeepAgent Code.",
  ...
  "zen.how.body": "بينما نقترح عليك استخدام Zen مع DeepAgent Code، يمكنك استخدام Zen مع أي وكيل.",
  ...
  "go.title": "DeepAgent Code Go | نماذج برمجة منخفضة التكلفة للجميع",
  "go.meta.description":
  ...
  "go.problem.body":
    "نحن نركز على تقديم تجربة DeepAgent Code لأكبر عدد ممكن من الناس. DeepAgent Code Go هو اشتراك منخفض التكلفة: $5 للشهر الأول، ثم $10/شهر. يوفر حدودا سخية ووصولا موثوقا إلى نماذج المصدر المفتوح الأكثر قدرة.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "يبدأ Go من $5 للشهر الأول، ثم $10/شهر. يمكنك استخدامه مع DeepAgent Code أو أي وكيل.",
  ...
  "go.faq.q1": "ما هو DeepAgent Code Go؟",
  ...
  "zen.api.error.trialEnded":
    "انتهى العرض المجاني لـ {{model}}. يمكنك مواصلة استخدام النموذج بالاشتراك في DeepAgent Code Go - {{link}}",

  "black.meta.title": "DeepAgent Code Black | الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.meta.description": "احصل على وصول إلى Claude، GPT، Gemini والمزيد مع خطط اشتراك DeepAgent Code Black.",
  "black.hero.title": "الوصول إلى أفضل نماذج البرمجة في العالم",
  "black.hero.subtitle": "بما في ذلك Claude، GPT، Gemini والمزيد",
  "black.title": "DeepAgent Code Black | الأسعار",
  ...
  "black.workspace.title": "DeepAgent Code Black | اختر مساحة العمل",
  "black.workspace.selectPlan": "اختر مساحة عمل لهذه الخطة",
  "black.workspace.name": "مساحة العمل {{n}}",
  "black.subscribe.title": "اشترك في DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "أنت في قائمة انتظار DeepAgent Code Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "استخدم Zen مع أي وكيل برمجة، واستمر في استخدام موفرين آخرين مع deepagent-code وقتما تشاء.",
  ...
  "workspace.newUser.step.login.after": "واختر deepagent-code",
  "workspace.newUser.step.pasteKey": "الصق مفتاح API الخاص بك",
  "workspace.newUser.step.models.before": "ابدأ deepagent-code ثم نفّذ",
  ...
  "workspace.keys.subtitle": "إدارة مفاتيح API الخاصة بك للوصول إلى خدمات deepagentCode.",
  "workspace.keys.create": "إنشاء مفتاح API",
  "workspace.keys.placeholder": "أدخل اسم المفتاح",
  "workspace.keys.empty": "أنشئ مفتاح API لبوابة deepagent-code",
  ...
  "workspace.black.subscription.message": "أنت مشترك في DeepAgent Code Black مقابل ${{plan}} شهريًا.",
  ...
  "workspace.black.waitlist.joined": "أنت في قائمة الانتظار لخطة DeepAgent Code Black بقيمة ${{plan}} شهريًا.",
  "workspace.black.waitlist.ready": "نحن مستعدون لتسجيلك في خطة DeepAgent Code Black بقيمة ${{plan}} شهريًا.",
  ...
  "workspace.lite.subscription.message": "أنت مشترك في DeepAgent Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'اختر "DeepAgent Code Go" كمزود في إعدادات deepagent-code الخاصة بك لاستخدام نماذج Go.',
  "workspace.lite.black.message":
    "أنت مشترك حاليًا في DeepAgent Code Black أو في قائمة الانتظار. يرجى إلغاء الاشتراك أولاً إذا كنت ترغب في التبديل إلى Go.",
  "workspace.lite.other.message":
    "عضو آخر في مساحة العمل هذه مشترك بالفعل في DeepAgent Code Go. يمكن لعضو واحد فقط لكل مساحة عمل الاشتراك.",
  "workspace.lite.promo.description":
    "يبدأ DeepAgent Code Go بسعر {{price}}، ثم $10/شهر، ويوفر وصولا موثوقا لنماذج البرمجة المفتوحة الشهيرة مع حدود استخدام سخية.",
  ...
  "download.title": "DeepAgent Code | تنزيل",
  "download.meta.description": "نزّل DeepAgent Code لـ macOS، Windows، وLinux",
  "download.hero.title": "تنزيل DeepAgent Code",
  "download.hero.subtitle": "متاح في نسخة تجريبية لـ macOS، Windows، وLinux",
  "download.hero.button": "تنزيل لـ {{os}}",
  "download.section.terminal": "DeepAgent Code للطرفية",
  "download.section.desktop": "DeepAgent Code لسطح المكتب (Beta)",
  "download.section.extensions": "امتدادات DeepAgent Code",
  "download.section.integrations": "تكاملات DeepAgent Code",
  ...
  "download.faq.a3.beforeLocal":
    "ليس بالضرورة، ولكن على الأرجح. ستحتاج إلى اشتراك ذكاء اصطناعي إذا كنت تريد ربط DeepAgent Code بمزوّد مدفوع، رغم أنه يمكنك العمل مع",
  "download.faq.a3.localLink": "النماذج المحلية",
  "download.faq.a3.afterLocal.beforeZen": "مجانًا. بينما نشجع المستخدمين على استخدام",
  "download.faq.a3.afterZen": "، فإن DeepAgent Code يعمل مع جميع المزودين الشائعين مثل OpenAI، Anthropic، xAI إلخ.",

  "download.faq.a5.p1": "DeepAgent Code مجاني 100% للاستخدام.",
  "download.faq.a5.p2.beforeZen":
    "أي تكاليف إضافية ستأتي من اشتراكك لدى مزود النماذج. بينما يعمل DeepAgent Code مع أي مزود نماذج، نوصي باستخدام",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "يتم حفظ بياناتك ومعلوماتك فقط عند إنشاء روابط قابلة للمشاركة في DeepAgent Code.",
  "download.faq.a6.p2.beforeShare": "اعرف المزيد عن",
  "download.faq.a6.shareLink": "صفحات المشاركة",

  "enterprise.title": "DeepAgent Code | حلول المؤسسات لمنظمتك",
  "enterprise.meta.description": "تواصل مع DeepAgent Code لحلول المؤسسات",
  "enterprise.hero.title": "كودك ملكك",
  "enterprise.hero.body1":
    "يعمل DeepAgent Code بأمان داخل مؤسستك دون تخزين أي بيانات أو سياق، ودون قيود ترخيص أو مطالبات ملكية. ابدأ تجربة مع فريقك، ثم انشره عبر مؤسستك من خلال دمجه مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  ...
  "enterprise.faq.q1": "ما هو DeepAgent Code Enterprise؟",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise مخصص للمؤسسات التي تريد التأكد من أن الكود والبيانات لا تغادر بنيتها التحتية أبدًا. يتحقق ذلك عبر استخدام تكوين مركزي يندمج مع SSO وبوابة الذكاء الاصطناعي الداخلية لديك.",
  "enterprise.faq.q2": "كيف أبدأ مع DeepAgent Code Enterprise؟",
  "enterprise.faq.a2":
    "ابدأ ببساطة بتجربة داخلية مع فريقك. افتراضيًا، لا يقوم DeepAgent Code بتخزين الكود أو بيانات السياق، مما يجعل البدء سهلاً. ثم اتصل بنا لمناقشة الأسعار وخيارات التنفيذ.",
  ...
  "enterprise.faq.q4": "هل بياناتي آمنة مع DeepAgent Code Enterprise؟",
  "enterprise.faq.a4":
    "نعم. لا يقوم DeepAgent Code بتخزين الكود أو بيانات السياق. تتم جميع المعالجة محليًا أو عبر استدعاءات API مباشرة إلى مزود الذكاء الاصطناعي لديك. مع التكوين المركزي وتكامل SSO، تظل بياناتك آمنة داخل البنية التحتية لمؤسستك.",

  "brand.title": "DeepAgent Code | العلامة التجارية",
  "brand.meta.description": "إرشادات العلامة التجارية لـ DeepAgent Code",
  "brand.heading": "إرشادات العلامة التجارية",
  "brand.subtitle": "موارد وأصول لمساعدتك في العمل مع العلامة التجارية لـ DeepAgent Code.",
  "brand.downloadAll": "تنزيل جميع الأصول",

  "changelog.title": "DeepAgent Code | سجل التغييرات",
  "changelog.meta.description": "ملاحظات الإصدار وسجل التغييرات لـ DeepAgent Code",
  "changelog.hero.title": "سجل التغييرات",
  "changelog.hero.subtitle": "تحديثات وتحسينات جديدة لـ DeepAgent Code",
