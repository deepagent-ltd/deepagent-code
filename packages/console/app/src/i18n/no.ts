...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | deepagent-code",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "deepagent-code logo lys",
  "notFound.logoDarkAlt": "deepagent-code logo mørk",
  ...
  "app.meta.description": "DeepAgent Code - Den åpne kildekode kodingsagenten.",

  "home.title": "DeepAgent Code | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "deepagent-code | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av deepagent-code",
  ...
  "temp.screenshot.caption": "deepagent-code TUI med tokyonight-tema",
  "temp.screenshot.alt": "deepagent-code TUI med tokyonight-tema",
  "temp.logoLightAlt": "deepagent-code logo lys",
  "temp.logoDarkAlt": "deepagent-code logo mørk",
  ...
  "home.what.title": "Hva er DeepAgent Code?",
  "home.what.body": "DeepAgent Code er en åpen kildekode-agent som hjelper deg å skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes DeepAgent Code av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "DeepAgent Code lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg DeepAgent Code?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke DeepAgent Code?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. DeepAgent Code kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men DeepAgent Code fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med DeepAgent Code?",
  "home.faq.a4.p1":
    "Ja, DeepAgent Code støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke DeepAgent Code i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! DeepAgent Code er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er DeepAgent Code åpen kildekode?",
  "home.faq.a8.p1": "Ja, DeepAgent Code er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som DeepAgent Code har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "DeepAgent Code Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som DeepAgent Code har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er DeepAgent Code Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan DeepAgent Code forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger DeepAgent Code til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med DeepAgent Code, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare DeepAgent Code-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med DeepAgent Code, kan du bruke Zen med hvilken som helst agent.",
  ...
  "go.title": "DeepAgent Code Go | Rimelige kodemodeller for alle",
  "go.meta.description":
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe DeepAgent Code-opplevelsen til så mange som mulig. DeepAgent Code Go er et rimelig abonnement: $5 for den første måneden, deretter $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter på $5 for den første måneden, deretter $10/måned. Du kan bruke det med DeepAgent Code eller hvilken som helst agent.",
  ...
  "go.faq.q1": "Hva er DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampanjen for {{model}} er avsluttet. Du kan fortsette å bruke modellen ved å abonnere på DeepAgent Code Go - {{link}}",

  "black.meta.title": "DeepAgent Code Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med DeepAgent Code Black-abonnementer.",
  "black.hero.title": "Få tilgang til verdens beste kodemodeller",
  "black.hero.subtitle": "Inkludert Claude, GPT, Gemini og mer",
  "black.title": "DeepAgent Code Black | Priser",
  ...
  "black.workspace.title": "DeepAgent Code Black | Velg arbeidsområde",
  "black.workspace.selectPlan": "Velg et arbeidsområde for denne planen",
  "black.workspace.name": "Arbeidsområde {{n}}",
  "black.subscribe.title": "Abonner på DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for DeepAgent Code Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med deepagent-code når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg deepagent-code",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start deepagent-code og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til deepagent-code-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en deepagent-code Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på DeepAgent Code Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du står på venteliste for DeepAgent Code Black-planen til ${{plan}} per måned.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på DeepAgent Code Black-planen til ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.message": "Du abonnerer på DeepAgent Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "DeepAgent Code Go" som leverandør i deepagent-code-konfigurasjonen din for å bruke Go-modeller.',
  "workspace.lite.black.message":
    "Du abonnerer for øyeblikket på DeepAgent Code Black eller står på venteliste. Vennligst avslutt abonnementet først hvis du vil bytte til Go.",
  "workspace.lite.other.message":
    "Et annet medlem i dette arbeidsområdet abonnerer allerede på DeepAgent Code Go. Kun ett medlem per arbeidsområde kan abonnere.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go starter på {{price}}, deretter $10/måned, og gir pålitelig tilgang til populære åpne kodingsmodeller med sjenerøse bruksgrenser.",
  ...
  "download.title": "DeepAgent Code | Last ned",
  "download.meta.description": "Last ned DeepAgent Code for macOS, Windows og Linux",
  "download.hero.title": "Last ned DeepAgent Code",
  ...
  "download.section.extensions": "DeepAgent Code Extensions",
  "download.section.integrations": "DeepAgent Code Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble DeepAgent Code til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer DeepAgent Code med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "DeepAgent Code er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om DeepAgent Code fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i DeepAgent Code.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "DeepAgent Code | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt DeepAgent Code for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "DeepAgent Code opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. DeepAgent Code lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med DeepAgent Code Enterprise?",
  "enterprise.faq.a4":
    "Ja. DeepAgent Code lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "DeepAgent Code | Merkevare",
  "brand.meta.description": "DeepAgent Code retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med DeepAgent Code-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "DeepAgent Code | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for DeepAgent Code",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for DeepAgent Code",
