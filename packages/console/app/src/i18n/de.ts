...
export const dict = {
  ...
  "notFound.title": "Nicht gefunden | DeepAgent Code",
  "notFound.heading": "404 - Seite nicht gefunden",
  "notFound.home": "Startseite",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "DeepAgent Code Logo hell",
  "notFound.logoDarkAlt": "DeepAgent Code Logo dunkel",
  ...
  "app.meta.description": "DeepAgent Code - Der Open-Source Coding-Agent.",

  "home.title": "DeepAgent Code | Der Open-Source AI-Coding-Agent",

  "temp.title": "DeepAgent Code | Für das Terminal gebauter AI-Coding-Agent",
  ...
  "temp.feature.zen.afterLink": "bereitgestellt von DeepAgent Code",
  ...
  "temp.screenshot.caption": "DeepAgent Code TUI mit dem Tokyonight-Theme",
  "temp.screenshot.alt": "DeepAgent Code TUI mit Tokyonight-Theme",
  "temp.logoLightAlt": "DeepAgent Code Logo hell",
  "temp.logoDarkAlt": "DeepAgent Code Logo dunkel",
  ...
  "home.what.title": "Was ist DeepAgent Code?",
  "home.what.body":
    "DeepAgent Code ist ein Open-Source-Agent, der dir hilft, Code in deinem Terminal, deiner IDE oder auf dem Desktop zu schreiben.",
  ...
  "home.growth.body":
    "Mit über <strong>{{stars}}</strong> GitHub-Stars, <strong>{{contributors}}</strong> Contributors und über <strong>{{commits}}</strong> Commits wird DeepAgent Code von über <strong>{{monthlyUsers}}</strong> Entwickler:innen jeden Monat genutzt und geschätzt.",
  ...
  "home.privacy.body":
    "DeepAgent Code speichert keinen deiner Codes oder Kontextdaten, sodass es in datenschutzsensiblen Umgebungen arbeiten kann.",
  "home.privacy.learnMore": "Erfahre mehr über",
  "home.privacy.link": "Datenschutz",

  "home.faq.q1": "Was ist DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code ist ein Open-Source-Agent, der dir hilft, Code mit jedem KI-Modell zu schreiben und auszuführen. Er ist als Terminal-Interface, Desktop-App oder IDE-Erweiterung verfügbar.",
  "home.faq.q2": "Wie nutze ich DeepAgent Code?",
  "home.faq.a2.before": "Der einfachste Weg zu starten ist, die",
  "home.faq.a2.link": "Einführung zu lesen",
  "home.faq.q3": "Brauche ich zusätzliche AI-Abos, um DeepAgent Code zu nutzen?",
  "home.faq.a3.p1":
    "Nicht unbedingt, DeepAgent Code kommt mit einer Reihe kostenloser Modelle, die du ohne Account nutzen kannst.",
  ...
  "home.faq.a3.p3":
    "Während wir dazu raten, Zen zu nutzen, funktioniert DeepAgent Code auch mit allen beliebten Anbietern wie OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Du kannst sogar deine",
  "home.faq.a3.p4.localLink": "lokalen Modelle verbinden",
  "home.faq.q4": "Kann ich meine bestehenden AI-Abos mit DeepAgent Code nutzen?",
  "home.faq.a4.p1":
    "Ja, DeepAgent Code unterstützt Abos von allen großen Anbietern. Du kannst deine Claude Pro/Max, ChatGPT Plus/Pro oder GitHub Copilot Abos nutzen.",
  "home.faq.q5": "Kann ich DeepAgent Code nur im Terminal nutzen?",
  "home.faq.a5.beforeDesktop": "Nicht mehr! DeepAgent Code ist jetzt als App für",
  "home.faq.a5.desktop": "Desktop",
  "home.faq.a5.and": "und",
  "home.faq.a5.web": "Web verfügbar",
  "home.faq.q6": "Wie viel kostet DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code ist zu 100% kostenlos. Es enthält auch eine Reihe kostenloser Modelle. Zusätzliche Kosten können entstehen, wenn du andere Anbieter verbindest.",
  ...
  "home.faq.q8": "Ist DeepAgent Code Open Source?",
  "home.faq.a8.p1": "Ja, DeepAgent Code ist vollständig Open Source. Der Quellcode ist öffentlich auf",
  ...
  "home.zenCta.body":
    "Zen gibt dir Zugriff auf ein handverlesenes Set an AI-Modellen, die DeepAgent Code speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität bei verschiedenen Anbietern – nutze validierte Modelle, die funktionieren.",
  "home.zenCta.link": "Erfahre mehr über Zen",

  "zen.title": "DeepAgent Code Zen | Ein kuratiertes Set zuverlässiger, optimierter Modelle für Coding-Agents",
  "zen.hero.title": "Zuverlässige, optimierte Modelle für Coding-Agents",
  "zen.hero.body":
    "Zen gibt dir Zugriff auf ein kuratiertes Set an AI-Modellen, die DeepAgent Code speziell für Coding-Agents getestet und bewertet hat. Keine Sorge wegen inkonsistenter Leistung und Qualität – nutze validierte Modelle, die funktionieren.",

  "zen.faq.q1": "Was ist DeepAgent Code Zen?",
  "zen.faq.a1":
    "Zen ist ein kuratiertes Set an AI-Modellen, getestet und bewertet für Coding-Agents, erstellt vom Team hinter DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen ist nicht gewinnorientiert. Zen gibt die Kosten der Modellanbieter an dich weiter. Je höher die Nutzung von Zen, desto besser kann DeepAgent Code Preise verhandeln und diese an dich weitergeben.",
  ...
  "zen.faq.a4.p3":
    "Um die Kosten zu decken, fügt DeepAgent Code nur eine kleine Bearbeitungsgebühr von $1.23 pro $20 Guthabenaufladung hinzu.",
  ...
  "zen.faq.a8":
    "Während Zen großartig mit DeepAgent Code funktioniert, kannst du Zen mit jedem Agent nutzen. Folge den Einrichtungsanweisungen in deinem bevorzugten Coding-Agent.",
  ...
  "zen.problem.subtitle": "Wir beheben das für alle, nicht nur für DeepAgent Code-Nutzer.",
  ...
  "zen.how.body": "Während wir dir raten, Zen mit DeepAgent Code zu nutzen, kannst du Zen mit jedem Agent nutzen.",
  ...
  "go.title": "DeepAgent Code Go | Kostengünstige Coding-Modelle für alle",
  "go.meta.description":
  ...
  "go.problem.body":
    "Wir konzentrieren uns darauf, die DeepAgent Code-Erfahrung so vielen Menschen wie möglich zugänglich zu machen. DeepAgent Code Go ist ein kostengünstiges Abonnement: $5 im ersten Monat, danach $10/Monat. Es bietet großzügige Limits und zuverlässigen Zugang zu den leistungsfähigsten Open-Source-Modellen.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go beginnt bei $5 für den ersten Monat, danach $10/Monat. Du kannst es mit DeepAgent Code oder jedem Agenten nutzen.",
  ...
  "go.faq.q1": "Was ist DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Die kostenlose Aktion für {{model}} ist beendet. Du kannst das Modell weiterhin nutzen, indem du DeepAgent Code Go abonnierst - {{link}}",

  "black.meta.title": "DeepAgent Code Black | Zugriff auf die weltweit besten Coding-Modelle",
  "black.meta.description": "Erhalte Zugriff auf Claude, GPT, Gemini und mehr mit DeepAgent Code Black Abos.",
  ...
  "black.title": "DeepAgent Code Black | Preise",
  ...
  "black.workspace.title": "DeepAgent Code Black | Workspace wählen",
  "black.workspace.selectPlan": "Wähle einen Workspace für diesen Plan",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "DeepAgent Code Black abonnieren",
  ...
  "black.subscribe.success.title": "Du bist auf der DeepAgent Code Black Warteliste",
  ...
  "workspace.newUser.feature.lockin.body":
    "Nutze Zen mit jedem Coding-Agent und nutze weiterhin andere Anbieter mit DeepAgent Code, wann immer du willst.",
  ...
  "workspace.newUser.step.login.after": "aus und wähle DeepAgent Code",
  "workspace.newUser.step.pasteKey": "Füge deinen API Key ein",
  "workspace.newUser.step.models.before": "Starte DeepAgent Code und führe",
  ...
  "workspace.keys.subtitle": "Verwalte deine API Keys für den Zugriff auf DeepAgent Code-Dienste.",
  "workspace.keys.create": "API Key erstellen",
  "workspace.keys.placeholder": "Key-Namen eingeben",
  "workspace.keys.empty": "Erstelle einen DeepAgent Code Gateway API Key",
  ...
  "workspace.black.subscription.message": "Du hast DeepAgent Code Black für ${{plan}} pro Monat abonniert.",
  ...
  "workspace.lite.subscription.message": "Du hast DeepAgent Code Go abonniert.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wähle "DeepAgent Code Go" als Anbieter in deiner deepagent-code-Konfiguration, um Go-Modelle zu verwenden.',
  "workspace.lite.black.message":
    "Du hast derzeit DeepAgent Code Black abonniert oder stehst auf der Warteliste. Bitte kündige zuerst, wenn du zu Go wechseln möchtest.",
  "workspace.lite.other.message":
    "Ein anderes Mitglied in diesem Workspace hat DeepAgent Code Go bereits abonniert. Nur ein Mitglied pro Workspace kann abonnieren.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go startet bei {{price}}, danach $10/Monat, und bietet zuverlässigen Zugang zu beliebten offenen Coding-Modellen mit großzügigen Nutzungslimits.",
  ...
  "download.meta.description": "Lade DeepAgent Code für macOS, Windows und Linux herunter",
  "download.hero.title": "DeepAgent Code herunterladen",
  ...
  "download.section.integrations": "DeepAgent Code Integrationen",
  ...
  "download.faq.a3.beforeLocal":
    "Nicht unbedingt, aber wahrscheinlich. Du brauchst ein AI-Abo, wenn du DeepAgent Code mit einem bezahlten Anbieter verbinden willst, obwohl du mit",
  ...
  "download.faq.a3.afterZen":
    " zu nutzen, funktioniert DeepAgent Code mit allen populären Anbietern wie OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "DeepAgent Code ist 100% kostenlos.",
  "download.faq.a5.p2.beforeZen":
    "Zusätzliche Kosten entstehen durch dein Abo bei einem Modellanbieter. Während DeepAgent Code mit jedem Modellanbieter funktioniert, empfehlen wir",
  "download.faq.a5.p2.afterZen": " zu nutzen.",

  "download.faq.a6.p1":
    "Deine Daten und Informationen werden nur gespeichert, wenn du teilbare Links in DeepAgent Code erstellst.",
  "download.faq.a6.p2.beforeShare": "Erfahre mehr über",
  "download.faq.a6.shareLink": "Share-Pages",

  "enterprise.title": "DeepAgent Code | Enterprise-Lösungen für Ihre Organisation",
  "enterprise.meta.description": "Kontaktieren Sie DeepAgent Code für Enterprise-Lösungen",
  "enterprise.hero.title": "Ihr Code gehört Ihnen",
  "enterprise.hero.body1":
    "DeepAgent Code arbeitet sicher innerhalb Ihrer Organisation, ohne dass Daten oder Kontext gespeichert werden und ohne Lizenzbeschränkungen oder Eigentumsansprüche. Starten Sie einen Testlauf mit Ihrem Team, dann rollen Sie es in Ihrer Organisation aus, indem Sie es in Ihr SSO und internes AI-Gateway integrieren.",
  ...
  "enterprise.faq.q1": "Was ist DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise ist für Organisationen, die sicherstellen wollen, dass Code und Daten niemals ihre Infrastruktur verlassen. Dies geschieht durch eine zentrale Konfiguration, die in Ihr SSO und internes AI-Gateway integriert wird.",
  "enterprise.faq.q2": "Wie starte ich mit DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Starten Sie einfach mit einem internen Testlauf mit Ihrem Team. DeepAgent Code speichert standardmäßig weder Code noch Kontextdaten, was den Einstieg erleichtert. Kontaktieren Sie uns dann, um Preise und Implementierungsoptionen zu besprechen.",
  ...
  "enterprise.faq.q4": "Sind meine Daten mit DeepAgent Code Enterprise sicher?",
  "enterprise.faq.a4":
    "Ja. DeepAgent Code speichert weder Ihren Code noch Kontextdaten. Alle Verarbeitungen finden lokal oder über direkte API-Aufrufe an Ihren AI-Anbieter statt. Mit zentraler Konfiguration und SSO-Integration bleiben Ihre Daten sicher innerhalb der Infrastruktur Ihrer Organisation.",

  "brand.title": "DeepAgent Code | Marke",
  "brand.meta.description": "DeepAgent Code Markenrichtlinien",
  "brand.heading": "Markenrichtlinien",
  "brand.subtitle": "Ressourcen und Assets, die dir helfen, mit der DeepAgent Code-Marke zu arbeiten.",
  "brand.downloadAll": "Alle Assets herunterladen",

  "changelog.title": "DeepAgent Code | Changelog",
  "changelog.meta.description": "DeepAgent Code Release Notes und Changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Neue Updates und Verbesserungen für DeepAgent Code",
