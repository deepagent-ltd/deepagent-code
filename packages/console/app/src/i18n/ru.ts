...
export const dict = {
  ...
  "notFound.title": "Не найдено | deepagent-code",
  "notFound.heading": "404 - Страница не найдена",
  "notFound.home": "Главная",
  "notFound.docs": "Документация",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "светлый логотип deepagent-code",
  "notFound.logoDarkAlt": "темный логотип deepagent-code",
  ...
  "app.meta.description": "DeepAgent Code - AI-агент с открытым кодом для программирования.",

  "home.title": "DeepAgent Code | AI-агент с открытым кодом для программирования",

  "temp.title": "deepagent-code | AI-агент для программирования в терминале",
  ...
  "temp.feature.zen.afterLink": "от deepagent-code",
  ...
  "temp.screenshot.caption": "DeepAgent Code TUI с темой tokyonight",
  "temp.screenshot.alt": "DeepAgent Code TUI с темой tokyonight",
  "temp.logoLightAlt": "светлый логотип deepagent-code",
  "temp.logoDarkAlt": "темный логотип deepagent-code",
  ...
  "home.what.title": "Что такое DeepAgent Code?",
  "home.what.body":
    "DeepAgent Code — это агент с открытым исходным кодом, который помогает писать код в терминале, IDE или на десктопе.",
  ...
  "home.growth.body":
    "С более чем <strong>{{stars}}</strong> звезд на GitHub, <strong>{{contributors}}</strong> контрибьюторов и <strong>{{commits}}</strong> коммитов, DeepAgent Code доверяют более <strong>{{monthlyUsers}}</strong> разработчиков ежемесячно.",
  ...
  "home.privacy.body":
    "DeepAgent Code не хранит ваш код или контекстные данные, поэтому он может работать в средах, чувствительных к приватности.",
  "home.privacy.learnMore": "Подробнее о",
  "home.privacy.link": "приватности",

  "home.faq.q1": "Что такое DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code — это агент с открытым исходным кодом, который помогает писать и запускать код с любой AI-моделью. Доступен как терминальный интерфейс, десктопное приложение или расширение для IDE.",
  "home.faq.q2": "Как использовать DeepAgent Code?",
  "home.faq.a2.before": "Проще всего начать с чтения",
  "home.faq.a2.link": "введения",
  "home.faq.q3": "Нужны ли дополнительные подписки на AI для использования DeepAgent Code?",
  "home.faq.a3.p1":
    "Не обязательно, DeepAgent Code поставляется с набором бесплатных моделей, которые можно использовать без создания аккаунта.",
  "home.faq.a3.p2.beforeZen":
    "Помимо этого, вы можете использовать любые популярные модели для кодинга, создав аккаунт",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хотя мы рекомендуем использовать Zen, DeepAgent Code также работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",
  "home.faq.a3.p4.beforeLocal": "Вы даже можете подключить ваши",
  "home.faq.a3.p4.localLink": "локальные модели",
  "home.faq.q4": "Могу ли я использовать мои существующие AI-подписки с DeepAgent Code?",
  "home.faq.a4.p1":
    "Да, DeepAgent Code поддерживает подписки всех основных провайдеров. Вы можете использовать ваши подписки Claude Pro/Max, ChatGPT Plus/Pro или GitHub Copilot.",
  "home.faq.q5": "Можно ли использовать DeepAgent Code только в терминале?",
  "home.faq.a5.beforeDesktop": "Больше нет! DeepAgent Code теперь доступен как приложение для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "и",
  "home.faq.a5.web": "веба",
  "home.faq.q6": "Сколько стоит DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code на 100% бесплатен. Он также включает набор бесплатных моделей. Дополнительные расходы могут возникнуть, если вы подключите другого провайдера.",
  ...
  "home.faq.q8": "DeepAgent Code — это open source?",
  "home.faq.a8.p1": "Да, DeepAgent Code полностью open source. Исходный код доступен публично на",
  "home.faq.a8.p2": "под",
  ...
  "home.zenCta.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые DeepAgent Code протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве разных провайдеров, используйте проверенные модели, которые работают.",
  "home.zenCta.link": "Узнать о Zen",

  "zen.title": "DeepAgent Code Zen | Набор надежных оптимизированных моделей для кодинг-агентов",
  "zen.hero.title": "Надежные оптимизированные модели для кодинг-агентов",
  "zen.hero.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые DeepAgent Code протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве, используйте проверенные модели, которые работают.",

  "zen.faq.q1": "Что такое DeepAgent Code Zen?",
  "zen.faq.a1":
    "Zen — это отобранный набор AI-моделей, протестированных и проверенных для кодинг-агентов командой, стоящей за DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen — некоммерческий проект. Zen транслирует расходы от провайдеров моделей вам. Чем больше использование Zen, тем лучшие тарифы DeepAgent Code может согласовать и передать вам.",
  ...
  "zen.faq.a4.p3":
    "Для покрытия расходов DeepAgent Code добавляет лишь небольшую комиссию за обработку платежа в размере $1.23 при пополнении баланса на $20.",
  ...
  "zen.faq.a8":
    "Хотя Zen отлично работает с DeepAgent Code, вы можете использовать Zen с любым агентом. Следуйте инструкциям по настройке в вашем любимом агенте.",
  ...
  "zen.problem.subtitle": "Мы исправляем это для всех, а не только для пользователей DeepAgent Code.",
  ...
  "zen.how.body": "Хотя мы предлагаем использовать Zen с DeepAgent Code, вы можете использовать его с любым агентом.",
  ...
  "go.title": "DeepAgent Code Go | Недорогие модели для кодинга для всех",
  "go.meta.description":
  ...
  "go.problem.body":
    "Мы стремимся сделать DeepAgent Code доступным для как можно большего числа людей. DeepAgent Code Go - это недорогая подписка: $5 за первый месяц, затем $10/месяц. Она предоставляет щедрые лимиты и надежный доступ к самым мощным моделям с открытым исходным кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go начинается с $5 за первый месяц, затем $10/месяц. Вы можете использовать его с DeepAgent Code или любым агентом.",
  ...
  "go.faq.q1": "Что такое DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Бесплатная акция для {{model}} завершена. Вы можете продолжить использование модели, подписавшись на DeepAgent Code Go - {{link}}",

  "black.meta.title": "DeepAgent Code Black | Доступ к лучшим моделям для кодинга в мире",
  "black.meta.description": "Получите доступ к Claude, GPT, Gemini и другим моделям с подпиской DeepAgent Code Black.",
  "black.hero.title": "Доступ к лучшим моделям для кодинга в мире",
  "black.hero.subtitle": "Включая Claude, GPT, Gemini и другие",
  "black.title": "DeepAgent Code Black | Цены",
  ...
  "black.workspace.title": "DeepAgent Code Black | Выбор рабочего пространства",
  "black.workspace.selectPlan": "Выберите рабочее пространство для этого плана",
  "black.workspace.name": "Рабочее пространство {{n}}",
  "black.subscribe.title": "Подписаться на DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "Вы в списке ожидания DeepAgent Code Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Используйте Zen с любым кодинг-агентом и продолжайте использовать других провайдеров с deepagent-code, когда захотите.",
  ...
  "workspace.newUser.step.login.after": "и выберите deepagent-code",
  "workspace.newUser.step.pasteKey": "Вставьте ваш API ключ",
  "workspace.newUser.step.models.before": "Запустите deepagent-code и выполните",
  ...
  "workspace.keys.subtitle": "Управляйте вашими API ключами для доступа к сервисам deepagentCode.",
  "workspace.keys.create": "Создать API ключ",
  "workspace.keys.placeholder": "Введите название ключа",
  "workspace.keys.empty": "Создайте API ключ для шлюза deepagent-code",
  ...
  "workspace.black.subscription.message": "Вы подписаны на DeepAgent Code Black за ${{plan}} в месяц.",
  ...
  "workspace.black.waitlist.joined": "Вы в списке ожидания плана DeepAgent Code Black за ${{plan}} в месяц.",
  "workspace.black.waitlist.ready": "Мы готовы подключить вас к плану DeepAgent Code Black за ${{plan}} в месяц.",
  ...
  "workspace.lite.subscription.message": "Вы подписаны на DeepAgent Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Выберите "DeepAgent Code Go" в качестве провайдера в настройках deepagent-code для использования моделей Go.',
  "workspace.lite.black.message":
    "Вы подписаны на DeepAgent Code Black или находитесь в списке ожидания. Пожалуйста, сначала отмените подписку, если хотите перейти на Go.",
  "workspace.lite.other.message":
    "Другой участник в этом рабочем пространстве уже подписан на DeepAgent Code Go. Только один участник в рабочем пространстве может оформить подписку.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go начинается с {{price}}, затем $10/месяц и предоставляет надежный доступ к популярным открытым моделям кодирования с щедрыми лимитами использования.",
  ...
  "download.title": "DeepAgent Code | Скачать",
  "download.meta.description": "Скачать DeepAgent Code для macOS, Windows и Linux",
  "download.hero.title": "Скачать DeepAgent Code",
  "download.hero.subtitle": "Доступна бета для macOS, Windows и Linux",
  "download.hero.button": "Скачать для {{os}}",
  "download.section.terminal": "DeepAgent Code Terminal",
  "download.section.desktop": "DeepAgent Code Desktop (Beta)",
  "download.section.extensions": "Расширения DeepAgent Code",
  "download.section.integrations": "Интеграции DeepAgent Code",
  ...
  "download.faq.a3.beforeLocal":
    "Не обязательно, но возможно. Вам понадобится AI подписка, если вы хотите подключить DeepAgent Code к платному провайдеру, хотя вы можете работать с",
  ...
  "download.faq.a3.afterZen":
    ", DeepAgent Code работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",

  "download.faq.a5.p1": "DeepAgent Code на 100% бесплатен.",
  "download.faq.a5.p2.beforeZen":
    "Любые дополнительные расходы будут связаны с вашей подпиской у провайдера моделей. Хотя DeepAgent Code работает с любым провайдером моделей, мы рекомендуем использовать",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваши данные и информация сохраняются только при создании ссылок для шеринга в DeepAgent Code.",
  "download.faq.a6.p2.beforeShare": "Подробнее о",
  "download.faq.a6.shareLink": "страницах шеринга",

  "enterprise.title": "DeepAgent Code | Корпоративные решения для вашей организации",
  "enterprise.meta.description": "Свяжитесь с DeepAgent Code для корпоративных решений",
  "enterprise.hero.title": "Ваш код принадлежит вам",
  "enterprise.hero.body1":
    "DeepAgent Code безопасно работает внутри вашей организации: не хранит данные и контекст, без лицензионных ограничений и претензий на собственность. Начните пробный период с командой, затем разверните по всей организации, интегрировав с SSO и внутренним AI-шлюзом.",
  ...
  "enterprise.faq.q1": "Что такое DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise предназначен для организаций, которые хотят гарантировать, что их код и данные никогда не покинут их инфраструктуру. Это достигается за счет централизованной конфигурации, интегрированной с вашим SSO и внутренним AI-шлюзом.",
  "enterprise.faq.q2": "Как начать работу с DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Просто начните с внутреннего триала с вашей командой. DeepAgent Code по умолчанию не хранит ваш код или контекстные данные, поэтому начать легко. Затем свяжитесь с нами, чтобы обсудить цены и варианты внедрения.",
  ...
  "enterprise.faq.q4": "Безопасны ли мои данные с DeepAgent Code Enterprise?",
  "enterprise.faq.a4":
    "Да. DeepAgent Code не хранит ваш код или контекстные данные. Вся обработка происходит локально или через прямые вызовы API к вашему AI-провайдеру. Благодаря централизованной конфигурации и интеграции SSO ваши данные остаются защищенными внутри инфраструктуры вашей организации.",

  "brand.title": "DeepAgent Code | Бренд",
  "brand.meta.description": "Гайдлайны бренда DeepAgent Code",
  "brand.heading": "Гайдлайны бренда",
  "brand.subtitle": "Ресурсы и активы, которые помогут вам работать с брендом DeepAgent Code.",
  "brand.downloadAll": "Скачать все ресурсы",

  "changelog.title": "DeepAgent Code | Список изменений",
  "changelog.meta.description": "Примечания к релизам и список изменений DeepAgent Code",
  "changelog.hero.title": "Список изменений",
  "changelog.hero.subtitle": "Новые обновления и улучшения DeepAgent Code",
