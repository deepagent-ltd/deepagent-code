...
export const dict = {
  ...
  "notFound.title": "Não encontrado | deepagent-code",
  "notFound.heading": "404 - Página não encontrada",
  "notFound.home": "Início",
  "notFound.docs": "Documentação",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo deepagent-code claro",
  "notFound.logoDarkAlt": "logo deepagent-code escuro",
  ...
  "app.meta.description": "DeepAgent Code - O agente de codificação de código aberto.",

  "home.title": "DeepAgent Code | O agente de codificação de código aberto com IA",

  "temp.title": "deepagent-code | Agente de codificação com IA feito para o terminal",
  ...
  "temp.feature.zen.afterLink": "fornecida pela deepagent-code",
  ...
  "temp.screenshot.caption": "DeepAgent Code TUI com o tema tokyonight",
  "temp.screenshot.alt": "DeepAgent Code TUI com tema tokyonight",
  "temp.logoLightAlt": "logo deepagent-code claro",
  "temp.logoDarkAlt": "logo deepagent-code escuro",
  ...
  "home.what.title": "O que é DeepAgent Code?",
  "home.what.body":
    "DeepAgent Code é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, DeepAgent Code é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "DeepAgent Code não armazena nenhum código seu nem dados de contexto, para que possa operar em ambientes sensíveis à privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que é DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o DeepAgent Code?",
  "home.faq.a2.before": "A maneira mais fácil de começar é ler a",
  "home.faq.a2.link": "introdução",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o DeepAgent Code?",
  "home.faq.a3.p1":
    "Não necessariamente, DeepAgent Code vem com um conjunto de modelos grátis que você pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen":
    "Além disso, você pode usar qualquer um dos modelos de codificação populares criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuários a usar o Zen, DeepAgent Code também funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Você pode até conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o DeepAgent Code?",
  "home.faq.a4.p1":
    "Sim, DeepAgent Code suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o DeepAgent Code apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! DeepAgent Code agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code é 100% gratuito para usar. Ele também vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se você conectar qualquer outro provedor.",
  ...
  "home.faq.q8": "DeepAgent Code é código aberto?",
  "home.faq.a8.p1": "Sim, DeepAgent Code é totalmente open source. O código-fonte é público no",
  ...
  "zen.faq.q1": "O que é DeepAgent Code Zen?",
  "zen.faq.a1":
    "Zen é um conjunto selecionado de modelos de IA testados e avaliados para agentes de codificação, criado pela equipe por trás do DeepAgent Code.",
  ...
  "zen.faq.a3":
    "O Zen não tem fins lucrativos. O Zen repassa os custos dos provedores de modelos para você. Quanto maior o uso do Zen, mais a DeepAgent Code pode negociar melhores taxas e repassá-las para você.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a DeepAgent Code adiciona apenas uma pequena taxa de processamento de pagamento de $1,23 por recarga de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o DeepAgent Code, você pode usar o Zen com qualquer agente. Siga as instruções de configuração no seu agente de codificação preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários do DeepAgent Code.",
  ...
  "zen.how.body": "Embora sugerimos que você use o Zen com o DeepAgent Code, você pode usá-lo com qualquer agente.",
  ...
  "go.title": "DeepAgent Code Go | Modelos de codificação de baixo custo para todos",
  "go.meta.description":
  ...
  "go.problem.body":
    "Estamos focados em levar a experiência do DeepAgent Code para o maior número de pessoas possível. DeepAgent Code Go é uma assinatura de baixo custo: $5 no primeiro mês, depois $10/mês. Oferece limites generosos e acesso confiável aos modelos open source mais capazes.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "O Go começa em $5 no primeiro mês, depois $10/mês. Você pode usá-lo com o DeepAgent Code ou qualquer agente.",
  ...
  "go.faq.q1": "O que é DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "black.workspace.title": "DeepAgent Code Black | Selecionar Workspace",
  "black.workspace.selectPlan": "Selecione um workspace para este plano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Assinar DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "Você está na lista de espera do DeepAgent Code Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use o Zen com qualquer agente de codificação e continue usando outros provedores com deepagent-code sempre que quiser.",
  ...
  "workspace.newUser.step.login.after": "e selecione deepagent-code",
  "workspace.newUser.step.pasteKey": "Cole sua chave de API",
  "workspace.newUser.step.models.before": "Inicie o deepagent-code e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves de API para acessar os serviços deepagentCode.",
  "workspace.keys.create": "Criar Chave de API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave de API do deepagent-code Gateway",
  ...
  "workspace.black.subscription.message": "Você assina o DeepAgent Code Black por ${{plan}} por mês.",
  ...
  "workspace.lite.subscription.message": "Você assina o DeepAgent Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecione "DeepAgent Code Go" como provedor na sua configuração do deepagent-code para usar os modelos Go.',
  "workspace.lite.black.message":
    "Você está atualmente inscrito no DeepAgent Code Black ou na lista de espera. Por favor, cancele a assinatura primeiro se desejar mudar para o Go.",
  "workspace.lite.other.message":
    "Outro membro neste workspace já assina o DeepAgent Code Go. Apenas um membro por workspace pode assinar.",
  "workspace.lite.promo.description":
    "O DeepAgent Code Go começa em {{price}}, depois $10/mês, e oferece acesso confiável a modelos de codificação abertos populares com limites de uso generosos.",
  ...
  "download.title": "DeepAgent Code | Baixar",
  "download.meta.description": "Baixe o DeepAgent Code para macOS, Windows e Linux",
  "download.hero.title": "Baixar DeepAgent Code",
  ...
  "download.section.extensions": "Extensões DeepAgent Code",
  "download.section.integrations": "Integrações DeepAgent Code",
  ...
  "download.faq.a3.beforeLocal":
    "Não necessariamente, mas provavelmente. Você precisará de uma assinatura de IA se quiser conectar o DeepAgent Code a um provedor pago, embora você possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o DeepAgent Code funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "O DeepAgent Code é 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Quaisquer custos adicionais virão da sua assinatura de um provedor de modelo. Embora o DeepAgent Code funcione com qualquer provedor de modelo, recomendamos o uso do",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informações só são armazenados quando você cria links compartilháveis no DeepAgent Code.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "páginas de compartilhamento",

  "enterprise.title": "DeepAgent Code | Soluções empresariais para sua organização",
  "enterprise.meta.description": "Contate a DeepAgent Code para soluções empresariais",
  "enterprise.hero.title": "Seu código é seu",
  "enterprise.hero.body1":
    "O DeepAgent Code opera com segurança dentro da sua organização, sem dados ou contexto armazenados e sem restrições de licenciamento ou reivindicações de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organização integrando-o ao seu SSO e gateway de IA interno.",
  ...
  "enterprise.faq.q1": "O que é DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise é para organizações que desejam garantir que seu código e dados nunca saiam de sua infraestrutura. Isso pode ser feito usando uma configuração centralizada que se integra ao seu SSO e gateway de IA interno.",
  "enterprise.faq.q2": "Como faço para começar com o DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Basta começar com um teste interno com sua equipe. O DeepAgent Code por padrão não armazena seu código ou dados de contexto, facilitando o início. Em seguida, entre em contato conosco para discutir opções de preços e implementação.",
  ...
  "enterprise.faq.q4": "Meus dados estão seguros com o DeepAgent Code Enterprise?",
  "enterprise.faq.a4":
    "Sim. O DeepAgent Code não armazena seu código ou dados de contexto. Todo o processamento acontece localmente ou por meio de chamadas de API diretas para seu provedor de IA. Com configuração centralizada e integração de SSO, seus dados permanecem seguros dentro da infraestrutura de sua organização.",

  "brand.title": "DeepAgent Code | Marca",
  "brand.meta.description": "Diretrizes da marca DeepAgent Code",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca DeepAgent Code.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "DeepAgent Code | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do DeepAgent Code",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no DeepAgent Code",
