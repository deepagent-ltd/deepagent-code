...
export const dict = {
  ...en,
  "app.meta.description": "DeepAgent Code - L'agent de code open source.",
  "nav.github": "GitHub",
  ...
  "notFound.title": "Introuvable | DeepAgent Code",
  ...
  "home.title": "DeepAgent Code | L'agent de code IA open source",

  "temp.title": "DeepAgent Code | Agent de code IA conçu pour le terminal",
  ...
  "temp.feature.zen.afterLink": "fournie par DeepAgent Code",
  ...
  "temp.screenshot.caption": "DeepAgent Code TUI avec le thème tokyonight",
  "temp.screenshot.alt": "DeepAgent Code TUI avec le thème tokyonight",
  ...
  "home.what.title": "Qu'est-ce que DeepAgent Code ?",
  "home.what.body":
    "DeepAgent Code est un agent open source qui vous aide à écrire du code dans votre terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Avec plus de <strong>{{stars}}</strong> étoiles sur GitHub, <strong>{{contributors}}</strong> contributeurs et plus de <strong>{{commits}}</strong> commits, DeepAgent Code est utilisé et approuvé par plus de <strong>{{monthlyUsers}}</strong> développeurs chaque mois.",
  ...
  "home.privacy.body":
    "DeepAgent Code ne stocke ni votre code ni vos données de contexte, afin de pouvoir fonctionner dans des environnements sensibles à la confidentialité.",
  "home.privacy.learnMore": "En savoir plus sur",
  "home.privacy.link": "la confidentialité",

  "home.faq.q1": "Qu'est-ce que DeepAgent Code ?",
  "home.faq.a1":
    "DeepAgent Code est un agent open source qui vous aide à écrire et exécuter du code avec n'importe quel modèle d'IA. Il est disponible en interface terminal, application desktop ou extension IDE.",
  "home.faq.q2": "Comment utiliser DeepAgent Code ?",
  "home.faq.a2.before": "Le moyen le plus simple de commencer est de lire l'",
  "home.faq.a2.link": "intro",
  "home.faq.q3": "Ai-je besoin d'abonnements IA supplémentaires pour utiliser DeepAgent Code ?",
  "home.faq.a3.p1":
    "Pas forcément : DeepAgent Code propose des modèles gratuits que vous pouvez utiliser sans créer de compte.",
  "home.faq.a3.p2.beforeZen": "En plus, vous pouvez utiliser des modèles populaires pour le code en créant un compte",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Nous encourageons l'utilisation de Zen, mais DeepAgent Code fonctionne aussi avec les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Vous pouvez même connecter vos",
  "home.faq.a3.p4.localLink": "modèles locaux",
  "home.faq.q4": "Puis-je utiliser mes abonnements IA existants avec DeepAgent Code ?",
  "home.faq.a4.p1":
    "Oui, DeepAgent Code prend en charge les abonnements des principaux fournisseurs. Vous pouvez utiliser Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Puis-je utiliser DeepAgent Code uniquement dans le terminal ?",
  "home.faq.a5.beforeDesktop": "Plus maintenant ! DeepAgent Code est désormais disponible en application pour",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "et",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Combien coûte DeepAgent Code ?",
  "home.faq.a6":
    "DeepAgent Code est 100% gratuit. Il inclut aussi des modèles gratuits. Des coûts supplémentaires peuvent s'appliquer si vous connectez un autre fournisseur.",
  ...
  "home.faq.q8": "DeepAgent Code est-il open source ?",
  "home.faq.a8.p1": "Oui, DeepAgent Code est entièrement open source. Le code source est public sur",
  ...
  "home.zenCta.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que DeepAgent Code a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",
  "home.zenCta.link": "En savoir plus sur Zen",

  "zen.title": "DeepAgent Code Zen | Un ensemble sélectionné de modèles fiables et optimisés pour les agents de code",
  "zen.hero.title": "Modèles fiables et optimisés pour les agents de code",
  "zen.hero.body":
    "Zen vous donne accès à un ensemble sélectionné de modèles d'IA que DeepAgent Code a testés et benchmarkés spécifiquement pour les agents de code. Plus besoin de vous soucier des variations de performance et de qualité selon les fournisseurs : utilisez des modèles validés qui fonctionnent.",

  "zen.faq.q1": "Qu'est-ce que DeepAgent Code Zen ?",
  "zen.faq.a1":
    "Zen est un ensemble sélectionné de modèles d'IA testés et benchmarkés pour les agents de code, créé par l'équipe derrière DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen n'est pas à but lucratif. Zen vous facture au prix coûtant des fournisseurs de modèles. Plus Zen est utilisé, plus DeepAgent Code peut négocier de meilleurs tarifs et vous les répercuter.",
  ...
  "zen.faq.a4.p3":
    "Pour couvrir les coûts, DeepAgent Code ajoute uniquement de petits frais de traitement de paiement de 1,23 $ par recharge de 20 $.",
  ...
  "zen.faq.a8":
    "Zen fonctionne très bien avec DeepAgent Code, mais vous pouvez utiliser Zen avec n'importe quel agent. Suivez les instructions de configuration dans votre agent préféré.",
  ...
  "zen.problem.subtitle":
    "Nous résolvons ce problème pour tout le monde, pas seulement pour les utilisateurs de DeepAgent Code.",
  ...
  "zen.how.body":
    "Bien que nous vous suggérions d'utiliser Zen avec DeepAgent Code, vous pouvez utiliser Zen avec n'importe quel agent.",
  ...
  "go.title": "DeepAgent Code Go | Modèles de code à faible coût pour tous",
  "go.meta.description":
  ...
  "go.problem.body":
    "Nous nous efforçons d'apporter l'expérience DeepAgent Code au plus grand nombre. DeepAgent Code Go est un abonnement à faible coût : $5 pour le premier mois, puis 10 $/mois. Il offre des limites généreuses et un accès fiable aux modèles open source les plus performants.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go commence à $5 pour le premier mois, puis 10 $/mois. Vous pouvez l'utiliser avec DeepAgent Code ou n'importe quel agent.",
  ...
  "go.faq.q1": "Qu'est-ce que DeepAgent Code Go ?",
  "go.faq.a1":
  ...
  "black.workspace.title": "DeepAgent Code Black | Sélectionner un espace de travail",
  "black.workspace.selectPlan": "Sélectionnez un espace de travail pour ce forfait",
  "black.workspace.name": "Espace de travail {{n}}",
  "black.subscribe.title": "S'abonner à DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "Vous êtes sur la liste d'attente DeepAgent Code Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilisez Zen avec n'importe quel agent de code et continuez à utiliser d'autres fournisseurs avec DeepAgent Code quand vous le souhaitez.",
  ...
  "workspace.newUser.step.login.after": "et sélectionnez DeepAgent Code",
  "workspace.newUser.step.pasteKey": "Collez votre clé API",
  "workspace.newUser.step.models.before": "Démarrez DeepAgent Code et exécutez",
  ...
  "workspace.keys.subtitle": "Gérez vos clés API pour accéder aux services DeepAgent Code.",
  "workspace.keys.create": "Créer une clé API",
  "workspace.keys.placeholder": "Entrez le nom de la clé",
  "workspace.keys.empty": "Créer une clé API DeepAgent Code Gateway",
  ...
  "workspace.black.subscription.message": "Vous êtes abonné à DeepAgent Code Black pour {{plan}} $ par mois.",
  ...
  "workspace.black.waitlist.joined":
    "Vous êtes sur la liste d'attente pour le forfait DeepAgent Code Black à {{plan}} $ par mois.",
  "workspace.black.waitlist.ready":
    "Nous sommes prêts à vous inscrire au forfait DeepAgent Code Black à {{plan}} $ par mois.",
  ...
  "workspace.lite.subscription.message": "Vous êtes abonné à DeepAgent Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Sélectionnez "DeepAgent Code Go" comme fournisseur dans votre configuration deepagent-code pour utiliser les modèles Go.',
  "workspace.lite.black.message":
    "Vous êtes actuellement abonné à DeepAgent Code Black ou sur liste d'attente. Veuillez d'abord vous désabonner si vous souhaitez passer à Go.",
  "workspace.lite.other.message":
    "Un autre membre de cet espace de travail est déjà abonné à DeepAgent Code Go. Un seul membre par espace de travail peut s'abonner.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go commence à {{price}}, puis 10 $/mois, et offre un accès fiable aux modèles de code ouverts populaires avec des limites d'utilisation généreuses.",
  ...
  "download.title": "DeepAgent Code | Téléchargement",
  "download.meta.description": "Téléchargez DeepAgent Code pour macOS, Windows et Linux",
  "download.hero.title": "Télécharger DeepAgent Code",
  ...
  "download.section.desktop": "DeepAgent Code Desktop (Bêta)",
  "download.section.extensions": "Extensions DeepAgent Code",
  "download.section.integrations": "Intégrations DeepAgent Code",
  ...
  "download.faq.a3.beforeLocal":
    "Pas forcément, mais probablement. Vous aurez besoin d'un abonnement IA si vous voulez connecter DeepAgent Code à un fournisseur payant, mais vous pouvez travailler avec des",
  ...
  "download.faq.a3.afterZen":
    ", DeepAgent Code fonctionne avec tous les fournisseurs populaires comme OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "DeepAgent Code est 100% gratuit à utiliser.",
  "download.faq.a5.p2.beforeZen":
    "Les coûts supplémentaires viendront de votre abonnement à un fournisseur de modèle. Même si DeepAgent Code fonctionne avec n'importe quel fournisseur, nous recommandons d'utiliser",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Vos données et informations ne sont stockées que lorsque vous créez des liens partageables dans DeepAgent Code.",
  "download.faq.a6.p2.beforeShare": "En savoir plus sur",
  "download.faq.a6.shareLink": "les pages de partage",

  "enterprise.title": "DeepAgent Code | Solutions entreprise pour votre organisation",
  "enterprise.meta.description": "Contactez DeepAgent Code pour des solutions entreprise",
  "enterprise.hero.title": "Votre code vous appartient",
  "enterprise.hero.body1":
    "DeepAgent Code fonctionne de manière sécurisée au sein de votre organisation, sans stocker de données ni de contexte, et sans restrictions de licence ni revendications de propriété. Démarrez un essai avec votre équipe, puis déployez-le dans votre organisation en l'intégrant à votre SSO et à votre passerelle IA interne.",
  ...
  "enterprise.faq.q1": "Qu'est-ce que DeepAgent Code Enterprise ?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise s'adresse aux organisations qui veulent s'assurer que leur code et leurs données ne quittent jamais leur infrastructure. Cela est possible grâce à une configuration centralisée qui s'intègre à votre SSO et à votre passerelle IA interne.",
  "enterprise.faq.q2": "Comment démarrer avec DeepAgent Code Enterprise ?",
  "enterprise.faq.a2":
    "Commencez simplement par un essai interne avec votre équipe. Par défaut, DeepAgent Code ne stocke pas votre code ni vos données de contexte, ce qui facilite la prise en main. Ensuite, contactez-nous pour discuter des tarifs et des options de mise en œuvre.",
  ...
  "enterprise.faq.q4": "Mes données sont-elles sécurisées avec DeepAgent Code Enterprise ?",
  "enterprise.faq.a4":
    "Oui. DeepAgent Code ne stocke pas votre code ni vos données de contexte. Tout le traitement se fait localement ou via des appels API directs vers votre fournisseur d'IA. Avec une configuration centralisée et une intégration SSO, vos données restent sécurisées au sein de l'infrastructure de votre organisation.",

  "brand.title": "DeepAgent Code | Marque",
  "brand.meta.description": "Guide de marque DeepAgent Code",
  "brand.heading": "Guide de marque",
  "brand.subtitle": "Ressources et éléments pour vous aider à travailler avec la marque DeepAgent Code.",
  "brand.downloadAll": "Télécharger tous les assets",

  "changelog.title": "DeepAgent Code | Changelog",
  "changelog.meta.description": "Notes de version et changelog d'DeepAgent Code",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nouvelles mises à jour et améliorations pour DeepAgent Code",
