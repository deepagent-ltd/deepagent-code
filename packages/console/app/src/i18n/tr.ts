...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | deepagent-code",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "deepagent-code açık logo",
  "notFound.logoDarkAlt": "deepagent-code koyu logo",
  ...
  "app.meta.description": "DeepAgent Code - Açık kaynaklı kodlama ajanı.",

  "home.title": "DeepAgent Code | Açık kaynaklı yapay zeka kodlama ajanı",

  "temp.title": "deepagent-code | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "deepagent-code tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "deepagent-code TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı deepagent-code TUI",
  "temp.logoLightAlt": "deepagent-code açık logo",
  "temp.logoDarkAlt": "deepagent-code koyu logo",
  ...
  "home.what.title": "DeepAgent Code nedir?",
  "home.what.body":
    "DeepAgent Code, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile DeepAgent Code, her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "DeepAgent Code kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "DeepAgent Code nedir?",
  "home.faq.a1":
    "DeepAgent Code, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "DeepAgent Code'u nasıl kullanırım?",
  "home.faq.a2.before": "Başlamanın en kolay yolu",
  "home.faq.a2.link": "girişi okumaktır",
  "home.faq.q3": "DeepAgent Code için ek AI aboneliklerine ihtiyacım var mı?",
  ...
  "home.faq.a4.p1":
    "Evet. DeepAgent Code tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "DeepAgent Code'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! DeepAgent Code artık sizin bu cihazlarınıza",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "DeepAgent Code ne kadar?",
  "home.faq.a6":
    "DeepAgent Code %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "DeepAgent Code açık kaynak mı?",
  "home.faq.a8.p1": "Evet, DeepAgent Code tamamen açık kaynaktır. Kaynak kodu",
  "home.faq.a8.p2": "'da",
  ...
  "home.zenCta.body":
    "Zen, DeepAgent Code'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",
  "home.zenCta.link": "Zen hakkında",

  "zen.title": "DeepAgent Code Zen | Kodlama ajanları için güvenilir, optimize edilmiş modellerin seçilmiş seti",
  "zen.hero.title": "Kodlama ajanları için güvenilir, optimize modeller",
  "zen.hero.body":
    "Zen, DeepAgent Code'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",

  "zen.faq.q1": "DeepAgent Code Zen nedir?",
  "zen.faq.a1":
    "Zen, DeepAgent Code ekibi tarafından oluşturulan ve kodlama ajanları için test edilip benchmark edilen seçilmiş bir AI model setidir.",
  ...
  "zen.faq.a3":
    "Zen kâr amaçlı değildir. Zen, model sağlayıcılarının maliyetlerini size yansıtır. Zen'in kullanımı arttıkça DeepAgent Code daha iyi fiyatlar pazarlayabilir ve bunları size yansıtabilir.",
  ...
  "zen.faq.a4.p3":
    "Maliyetleri karşılamak için DeepAgent Code, $20 bakiye yüklemesi başına yalnızca $1.23 tutarında küçük bir ödeme işleme ücreti ekler.",
  ...
  "zen.faq.a8":
    "Zen DeepAgent Code ile harika çalışır, ama Zen'i herhangi bir ajan ile kullanabilirsiniz. Tercih ettiğiniz kodlama ajanında kurulum talimatlarını izleyin.",
  ...
  "zen.problem.subtitle": "Bu sorunu yalnızca DeepAgent Code kullanıcıları için değil, herkes için düzeltiyoruz.",
  ...
  "zen.how.body": "Zen'i DeepAgent Code ile kullanmanızı önersek de, Zen'i herhangi bir ajan ile kullanabilirsiniz.",
  ...
  "go.title": "DeepAgent Code Go | Herkes için düşük maliyetli kodlama modelleri",
  "go.meta.description":
  ...
  "go.problem.body":
    "DeepAgent Code deneyimini mümkün olduğunca çok kişiye ulaştırmaya odaklandık. DeepAgent Code Go düşük maliyetli bir aboneliktir: İlk ay $5, sonrasında ayda 10$. Cömert limitler ve en yetenekli açık kaynak modellere güvenilir erişim sağlar.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go ilk ay $5, sonrasında ayda 10$ fiyatıyla başlar. DeepAgent Code veya herhangi bir ajanla kullanabilirsiniz.",
  ...
  "go.faq.q1": "DeepAgent Code Go nedir?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "{{model}} için ücretsiz promosyon sona erdi. DeepAgent Code Go'ya abone olarak modeli kullanmaya devam edebilirsiniz - {{link}}",

  "black.meta.title": "DeepAgent Code Black | Dünyanın en iyi kodlama modellerine erişin",
  "black.meta.description": "DeepAgent Code Black abonelik planlarıyla Claude, GPT, Gemini ve daha fazlasına erişin.",
  "black.hero.title": "Dünyanın en iyi kodlama modellerine erişin",
  "black.hero.subtitle": "Claude, GPT, Gemini ve daha fazlası dahil",
  "black.title": "DeepAgent Code Black | Fiyatlandırma",
  ...
  "black.workspace.title": "DeepAgent Code Black | Çalışma Alanı Seç",
  "black.workspace.selectPlan": "Bu plan için bir çalışma alanı seçin",
  "black.workspace.name": "Çalışma Alanı {{n}}",
  "black.subscribe.title": "DeepAgent Code Black'e Abone Ol",
  ...
  "black.subscribe.success.title": "DeepAgent Code Black bekleme listesindesiniz",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman deepagent-code ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve deepagent-code seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "deepagent-code'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "deepagent-code hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir deepagent-code Gateway API anahtarı oluşturun",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında DeepAgent Code Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} DeepAgent Code Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki DeepAgent Code Black planına kaydetmeye hazırız.",
  ...
  "workspace.lite.subscription.message": "DeepAgent Code Go abonesisiniz.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için deepagent-code yapılandırmanızda "DeepAgent Code Go"\'yu sağlayıcı olarak seçin.',
  "workspace.lite.black.message":
    "Şu anda DeepAgent Code Black abonesisiniz veya bekleme listesindesiniz. Go'ya geçmek istiyorsanız lütfen önce aboneliğinizi iptal edin.",
  "workspace.lite.other.message":
    "Bu çalışma alanındaki başka bir üye zaten DeepAgent Code Go abonesi. Çalışma alanı başına yalnızca bir üye abone olabilir.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go {{price}} fiyatından başlar, sonrasında ayda 10$ olur ve cömert kullanım limitleriyle popüler açık kodlama modellerine güvenilir erişim sağlar.",
  ...
  "download.title": "DeepAgent Code | İndir",
  "download.meta.description": "DeepAgent Code'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "DeepAgent Code'u İndir",
  ...
  "download.section.extensions": "DeepAgent Code Eklentileri",
  "download.section.integrations": "DeepAgent Code Entegrasyonları",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak değil, ama muhtemelen. DeepAgent Code'u ücretli bir sağlayıcıya bağlamak istiyorsanız bir AI aboneliği gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya teşvik ediyoruz, ancak DeepAgent Code OpenAI, Anthropic, xAI vb. gibi tüm popüler sağlayıcılarla çalışır.",

  "download.faq.a5.p1": "DeepAgent Code %100 ücretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model sağlayıcısına olan aboneliğinizden gelir. DeepAgent Code herhangi bir model sağlayıcısıyla çalışır, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanızı öneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnızca DeepAgent Code'da paylaşılabilir bağlantılar oluşturduğunuzda saklanır.",
  "download.faq.a6.p2.beforeShare": "Daha fazla bilgi:",
  "download.faq.a6.shareLink": "paylaşım sayfaları",

  "enterprise.title": "DeepAgent Code | Kurumunuz için kurumsal çözümler",
  "enterprise.meta.description": "Kurumsal çözümler için DeepAgent Code ile iletişime geçin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "DeepAgent Code, hiçbir veri veya bağlam saklamadan ve lisans kısıtlamaları ya da sahiplik iddiaları olmadan kuruluşunuzun içinde güvenli şekilde çalışır. Ekibinizle bir deneme başlatın, ardından SSO'nuz ve dahili AI geçidiniz ile entegre ederek tüm kuruluşunuzda devreye alın.",
  ...
  "enterprise.faq.q1": "DeepAgent Code Enterprise nedir?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise, kodunuzun ve verilerinizin asla altyapınızı terk etmemesini sağlamak isteyen kurumlar içindir. Bunu, SSO'nuz ve dahili AI geçidiniz ile entegre olan merkezileştirilmiş bir konfigürasyonla sağlar.",
  "enterprise.faq.q2": "DeepAgent Code Enterprise'a nasıl başlarım?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile başlayın. DeepAgent Code varsayılan olarak kodunuzu veya bağlam verilerinizi saklamaz, bu da başlamayı kolaylaştırır. Ardından fiyatlandırma ve uygulama seçeneklerini görüşmek için bize ulaşın.",
  ...
  "enterprise.faq.q4": "DeepAgent Code Enterprise ile verilerim güvende mi?",
  "enterprise.faq.a4":
    "Evet. DeepAgent Code kodunuzu veya bağlam verilerinizi saklamaz. Tüm işleme yerel olarak ya da AI sağlayıcınıza doğrudan API çağrıları ile gerçekleştirilir. Merkezileştirilmiş konfigürasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapısı içinde güvende kalır.",

  "brand.title": "DeepAgent Code | Marka",
  "brand.meta.description": "DeepAgent Code marka kılavuzu",
  "brand.heading": "Marka kılavuzu",
  "brand.subtitle": "DeepAgent Code markası ile çalışmanıza yardımcı olacak kaynaklar ve varlıklar.",
  "brand.downloadAll": "Tüm varlıkları indir",

  "changelog.title": "DeepAgent Code | Değişiklik günlüğü",
  "changelog.meta.description": "DeepAgent Code sürüm notları ve değişiklik günlüğü",
  "changelog.hero.title": "Değişiklik günlüğü",
  "changelog.hero.subtitle": "DeepAgent Code için yeni güncellemeler ve iyileştirmeler",
