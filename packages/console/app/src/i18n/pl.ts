...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | deepagent-code",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo deepagent-code",
  "notFound.logoDarkAlt": "ciemne logo deepagent-code",
  ...
  "app.meta.description": "DeepAgent Code - Otwartoźródłowy agent programistyczny.",

  "home.title": "DeepAgent Code | Open source'owy agent AI do kodowania",

  "temp.title": "deepagent-code | Agent AI do kodowania zbudowany dla terminala",
  "temp.hero.title": "Agent AI do kodowania zbudowany dla terminala",
  "temp.zen": "deepagent-code zen",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez deepagent-code",
  "temp.feature.models.beforeLink": "Obsługuje 75+ dostawców LLM przez",
  "temp.feature.models.afterLink": ", w tym modele lokalne",
  "temp.screenshot.caption": "DeepAgent Code TUI z motywem tokyonight",
  "temp.screenshot.alt": "DeepAgent Code TUI z motywem tokyonight",
  "temp.logoLightAlt": "jasne logo deepagent-code",
  "temp.logoDarkAlt": "ciemne logo deepagent-code",
  ...
  "home.what.title": "Czym jest DeepAgent Code?",
  "home.what.body":
    "DeepAgent Code to open source'owy agent, który pomaga pisać kod w terminalu, IDE lub aplikacji desktopowej.",
  ...
  "home.growth.body":
    "Z ponad <strong>{{stars}}</strong> gwiazdkami na GitHubie, <strong>{{contributors}}</strong> współtwórcami i ponad <strong>{{commits}}</strong> commitami, DeepAgent Code jest używany i ceniony przez ponad <strong>{{monthlyUsers}}</strong> deweloperów każdego miesiąca.",
  ...
  "home.privacy.body":
    "DeepAgent Code nie przechowuje Twojego kodu ani danych kontekstowych, dzięki czemu może działać w środowiskach wrażliwych na prywatność.",
  "home.privacy.learnMore": "Dowiedz się więcej o",
  "home.privacy.link": "prywatności",

  "home.faq.q1": "Czym jest DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code to open source'owy agent, który pomaga pisać i uruchamiać kod z dowolnym modelem AI. Jest dostępny jako interfejs terminalowy, aplikacja desktopowa lub rozszerzenie IDE.",
  "home.faq.q2": "Jak korzystać z DeepAgent Code?",
  "home.faq.a2.before": "Najłatwiej zacząć od przeczytania",
  "home.faq.a2.link": "wprowadzenia",
  "home.faq.q3": "Czy potrzebuję dodatkowych subskrypcji AI, aby używać DeepAgent Code?",
  "home.faq.a3.p1":
    "Niekoniecznie. DeepAgent Code posiada zestaw darmowych modeli, z których możesz korzystać bez zakładania konta.",
  "home.faq.a3.p2.beforeZen": "Poza tym możesz używać dowolnych popularnych modeli do kodowania, tworząc konto",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Chociaż zachęcamy do korzystania z Zen, DeepAgent Code działa również ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",
  "home.faq.a3.p4.beforeLocal": "Możesz nawet podłączyć swoje",
  "home.faq.a3.p4.localLink": "lokalne modele",
  "home.faq.q4": "Czy mogę używać moich istniejących subskrypcji AI z DeepAgent Code?",
  "home.faq.a4.p1":
    "Tak, DeepAgent Code obsługuje plany subskrypcyjne od wszystkich głównych dostawców. Możesz używać swoich subskrypcji Claude Pro/Max, ChatGPT Plus/Pro lub GitHub Copilot.",
  "home.faq.q5": "Czy mogę używać DeepAgent Code tylko w terminalu?",
  "home.faq.a5.beforeDesktop": "Już nie! DeepAgent Code jest teraz dostępny jako aplikacja na",
  "home.faq.a5.desktop": "pulpit (desktop)",
  "home.faq.a5.and": "i",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Ile kosztuje DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code jest w 100% darmowy. Zawiera również zestaw darmowych modeli. Mogą pojawić się dodatkowe koszty, jeśli podłączysz innego dostawcę.",
  ...
  "home.faq.q8": "Czy DeepAgent Code jest open source?",
  "home.faq.a8.p1": "Tak, DeepAgent Code jest w pełni open source. Kod źródłowy jest publicznie dostępny na",
  ...
  "home.zenCta.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które DeepAgent Code przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość u różnych dostawców, używaj sprawdzonych modeli, które działają.",
  "home.zenCta.link": "Dowiedz się więcej o Zen",

  "zen.title": "DeepAgent Code Zen | Wyselekcjonowany zestaw niezawodnych, zoptymalizowanych modeli dla agentów kodujących",
  "zen.hero.title": "Niezawodne, zoptymalizowane modele dla agentów kodujących",
  "zen.hero.body":
    "Zen daje dostęp do wyselekcjonowanego zestawu modeli AI, które DeepAgent Code przetestował i sprawdził (benchmark) specjalnie dla agentów kodujących. Nie musisz martwić się o niespójną wydajność i jakość, używaj sprawdzonych modeli, które działają.",

  "zen.faq.q1": "Czym jest DeepAgent Code Zen?",
  "zen.faq.a1":
    "Zen to wyselekcjonowany zestaw modeli AI przetestowanych i sprawdzonych pod kątem agentów kodujących, stworzony przez zespół stojący za DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen nie jest nastawiony na zysk. Zen przekazuje koszty od dostawców modeli bezpośrednio do Ciebie. Im większe użycie Zen, tym lepsze stawki DeepAgent Code może wynegocjować i przekazać Tobie.",
  ...
  "zen.faq.a4.p3":
    "Aby pokryć koszty, DeepAgent Code dolicza jedynie niewielką opłatę za przetwarzanie płatności w wysokości $1.23 przy każdym doładowaniu salda o $20.",
  ...
  "zen.faq.a8":
    "Chociaż Zen świetnie działa z DeepAgent Code, możesz używać Zen z dowolnym agentem. Postępuj zgodnie z instrukcjami konfiguracji w swoim preferowanym agencie.",
  ...
  "zen.problem.subtitle": "Naprawiamy to dla wszystkich, nie tylko dla użytkowników DeepAgent Code.",
  ...
  "zen.how.body": "Chociaż sugerujemy używanie Zen z DeepAgent Code, możesz używać Zen z dowolnym agentem.",
  ...
  "go.title": "DeepAgent Code Go | Niskokosztowe modele do kodowania dla każdego",
  "go.meta.description":
  ...
  "go.testimonials.handle": "@DeepAgent Code",
  ...
  "go.problem.body":
    "Skupiamy się na udostępnieniu doświadczenia DeepAgent Code jak największej liczbie osób. DeepAgent Code Go to tania subskrypcja: $5 za pierwszy miesiąc, potem $10/miesiąc. Zapewnia hojne limity i niezawodny dostęp do najbardziej wydajnych modeli open source.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go zaczyna się od $5 za pierwszy miesiąc, potem $10/miesiąc. Możesz go używać z DeepAgent Code lub dowolnym agentem.",
  ...
  "go.faq.q1": "Czym jest DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Bezpłatna promocja {{model}} dobiegła końca. Możesz dalej korzystać z modelu, subskrybując DeepAgent Code Go - {{link}}",

  "black.meta.title": "DeepAgent Code Black | Dostęp do najlepszych na świecie modeli kodujących",
  "black.meta.description": "Uzyskaj dostęp do Claude, GPT, Gemini i innych dzięki planom subskrypcji DeepAgent Code Black.",
  "black.hero.title": "Dostęp do najlepszych na świecie modeli kodujących",
  "black.hero.subtitle": "W tym Claude, GPT, Gemini i inne",
  "black.title": "DeepAgent Code Black | Cennik",
  ...
  "black.workspace.title": "DeepAgent Code Black | Wybierz obszar roboczy",
  "black.workspace.selectPlan": "Wybierz obszar roboczy dla tego planu",
  "black.workspace.name": "Obszar roboczy {{n}}",
  "black.subscribe.title": "Subskrybuj DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "Jesteś na liście oczekujących DeepAgent Code Black",
  "black.subscribe.success.subscriptionPlan": "Plan subskrypcji",
  "black.subscribe.success.planName": "DeepAgent Code Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Używaj Zen z dowolnym agentem kodującym i kontynuuj korzystanie z innych dostawców z DeepAgent Code, kiedy tylko chcesz.",
  ...
  "workspace.newUser.step.login.after": "i wybierz deepagent-code",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom deepagent-code i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług deepagentCode.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy deepagent-code",
  ...
  "workspace.black.subscription.message": "Subskrybujesz DeepAgent Code Black za ${{plan}} miesięcznie.",
  ...
  "workspace.black.waitlist.joined": "Jesteś na liście oczekujących na plan DeepAgent Code Black za ${{plan}} miesięcznie.",
  "workspace.black.waitlist.ready": "Jesteśmy gotowi zapisać Cię do planu DeepAgent Code Black za ${{plan}} miesięcznie.",
  ...
  "workspace.lite.subscription.message": "Subskrybujesz DeepAgent Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "DeepAgent Code Go" jako dostawcę w konfiguracji deepagent-code, aby używać modeli Go.',
  "workspace.lite.black.message":
    "Obecnie subskrybujesz DeepAgent Code Black lub jesteś na liście oczekujących. Jeśli chcesz przejść na Go, najpierw anuluj subskrypcję.",
  "workspace.lite.other.message":
    "Inny członek tego obszaru roboczego już subskrybuje DeepAgent Code Go. Tylko jeden członek na obszar roboczy może subskrybować.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go zaczyna się od {{price}}, potem $10/miesiąc, i zapewnia niezawodny dostęp do popularnych otwartych modeli kodowania z hojnymi limitami użycia.",
  ...
  "download.title": "DeepAgent Code | Pobierz",
  "download.meta.description": "Pobierz DeepAgent Code na macOS, Windows i Linux",
  "download.hero.title": "Pobierz DeepAgent Code",
  "download.hero.subtitle": "Dostępne w wersji Beta na macOS, Windows i Linux",
  "download.hero.button": "Pobierz na {{os}}",
  "download.section.terminal": "Terminal DeepAgent Code",
  "download.section.desktop": "Pulpit DeepAgent Code (Beta)",
  "download.section.extensions": "Rozszerzenia DeepAgent Code",
  "download.section.integrations": "Integracje DeepAgent Code",
  ...
  "download.faq.a3.beforeLocal":
    "Niekoniecznie, ale prawdopodobnie. Będziesz potrzebować subskrypcji AI, jeśli chcesz połączyć DeepAgent Code z płatnym dostawcą, chociaż możesz pracować z",
  ...
  "download.faq.a3.afterZen":
    ", DeepAgent Code współpracuje ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",

  "download.faq.a5.p1": "DeepAgent Code jest w 100% darmowy.",
  "download.faq.a5.p2.beforeZen":
    "Wszelkie dodatkowe koszty będą pochodzić z Twojej subskrypcji u dostawcy modelu. Chociaż DeepAgent Code współpracuje z dowolnym dostawcą modeli, zalecamy korzystanie z",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Twoje dane i informacje są przechowywane tylko wtedy, gdy tworzysz linki do udostępniania w DeepAgent Code.",
  "download.faq.a6.p2.beforeShare": "Dowiedz się więcej o",
  "download.faq.a6.shareLink": "stronach udostępniania",

  "enterprise.title": "DeepAgent Code | Rozwiązania Enterprise dla Twojej organizacji",
  "enterprise.meta.description": "Skontaktuj się z DeepAgent Code w sprawie rozwiązań dla przedsiębiorstw",
  "enterprise.hero.title": "Twój kod jest Twój",
  "enterprise.hero.body1":
    "DeepAgent Code działa bezpiecznie wewnątrz Twojej organizacji bez przechowywania danych czy kontekstu, oraz bez ograniczeń licencyjnych czy roszczeń własnościowych. Rozpocznij okres próbny ze swoim zespołem, a następnie wdróż go w całej organizacji, integrując z SSO i wewnętrzną bramą AI.",
  ...
  "enterprise.faq.q1": "Czym jest DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise jest dla organizacji, które chcą mieć pewność, że ich kod i dane nigdy nie opuszczą ich infrastruktury. Można to osiągnąć dzięki scentralizowanej konfiguracji, która integruje się z Twoim SSO i wewnętrzną bramą AI.",
  "enterprise.faq.q2": "Jak zacząć z DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Po prostu rozpocznij wewnętrzny okres próbny ze swoim zespołem. DeepAgent Code domyślnie nie przechowuje Twojego kodu ani danych kontekstowych, co ułatwia start. Następnie skontaktuj się z nami, aby omówić opcje cenowe i wdrożeniowe.",
  ...
  "enterprise.faq.q4": "Czy moje dane są bezpieczne z DeepAgent Code Enterprise?",
  "enterprise.faq.a4":
    "Tak. DeepAgent Code nie przechowuje Twojego kodu ani danych kontekstowych. Całe przetwarzanie odbywa się lokalnie lub poprzez bezpośrednie wywołania API do Twojego dostawcy AI. Dzięki centralnej konfiguracji i integracji SSO, Twoje dane pozostają bezpieczne w infrastrukturze Twojej organizacji.",

  "brand.title": "DeepAgent Code | Marka",
  "brand.meta.description": "Wytyczne marki DeepAgent Code",
  "brand.heading": "Wytyczne marki",
  "brand.subtitle": "Zasoby i aktywa, które pomogą Ci pracować z marką DeepAgent Code.",
  "brand.downloadAll": "Pobierz wszystkie zasoby",

  "changelog.title": "DeepAgent Code | Dziennik zmian",
  "changelog.meta.description": "Notatki o wydaniu i dziennik zmian DeepAgent Code",
  "changelog.hero.title": "Dziennik zmian",
  "changelog.hero.subtitle": "Nowe aktualizacje i ulepszenia DeepAgent Code",
