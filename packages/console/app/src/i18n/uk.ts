...
export const dict = {
  ...
  "notFound.title": "Не знайдено | deepagent-code",
  "notFound.heading": "404 — Сторінку не знайдено",
  "notFound.home": "Головна",
  "notFound.docs": "Документація",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "світлий логотип deepagent-code",
  "notFound.logoDarkAlt": "темний логотип deepagent-code",
  ...
  "app.meta.description": "DeepAgent Code — відкритий агент для програмування.",

  "home.title": "DeepAgent Code | Відкритий AI-агент для кодування",

  "temp.title": "deepagent-code | AI-агент для кодування, створений для термінала",
  ...
  "temp.feature.zen.afterLink": "від deepagent-code",
  "temp.feature.models.beforeLink": "Підтримує 75+ LLM-провайдерів через",
  "temp.feature.models.afterLink": ", включаючи локальні моделі",
  "temp.screenshot.caption": "DeepAgent Code TUI з темою tokyonight",
  "temp.screenshot.alt": "DeepAgent Code TUI з темою tokyonight",
  "temp.logoLightAlt": "світлий логотип deepagent-code",
  "temp.logoDarkAlt": "темний логотип deepagent-code",
  ...
  "home.what.title": "Що таке DeepAgent Code?",
  "home.what.body": "DeepAgent Code — це відкритий агент, який допомагає писати код у терміналі, IDE або на десктопі.",
  ...
  "home.growth.body":
    "З понад <strong>{{stars}}</strong> зірками на GitHub, <strong>{{contributors}}</strong> учасниками та понад <strong>{{commits}}</strong> комітами, DeepAgent Code використовують понад <strong>{{monthlyUsers}}</strong> розробників щомісяця.",
  ...
  "home.privacy.body":
    "DeepAgent Code не зберігає ваш код або контекстні дані, тому може працювати в середовищах з чутливими даними.",
  "home.privacy.learnMore": "Дізнатися більше про",
  "home.privacy.link": "конфіденційність",

  "home.faq.q1": "Що таке DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code — це відкритий агент, який допомагає писати та запускати код з будь-якою AI-моделлю. Доступний як термінальний інтерфейс, десктопний застосунок або розширення IDE.",
  "home.faq.q2": "Як почати користуватися DeepAgent Code?",
  "home.faq.a2.before": "Найпростіший спосіб почати — прочитати",
  "home.faq.a2.link": "вступ",
  "home.faq.q3": "Чи потрібні додаткові AI-підписки для використання DeepAgent Code?",
  "home.faq.a3.p1":
    "Не обов'язково, DeepAgent Code має набір безкоштовних моделей, які можна використовувати без реєстрації.",
  "home.faq.a3.p2.beforeZen":
    "Крім цього, ви можете використовувати будь-які популярні моделі, створивши обліковий запис",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хоча ми рекомендуємо Zen, DeepAgent Code також працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",
  "home.faq.a3.p4.beforeLocal": "Ви навіть можете підключити свої",
  "home.faq.a3.p4.localLink": "локальні моделі",
  "home.faq.q4": "Чи можу я використовувати свої наявні AI-підписки з DeepAgent Code?",
  "home.faq.a4.p1":
    "Так, DeepAgent Code підтримує підписки всіх основних провайдерів. Ви можете використовувати Claude Pro/Max, ChatGPT Plus/Pro або GitHub Copilot.",
  "home.faq.q5": "Чи можна використовувати DeepAgent Code лише в терміналі?",
  "home.faq.a5.beforeDesktop": "Вже ні! DeepAgent Code тепер доступний як застосунок для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "та",
  "home.faq.a5.web": "вебу",
  "home.faq.q6": "Скільки коштує DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code є 100% безкоштовним. Він також має набір безкоштовних моделей. Додаткові витрати можливі, якщо ви підключите іншого провайдера.",
  ...
  "home.faq.q8": "Чи є DeepAgent Code відкритим?",
  "home.faq.a8.p1": "Так, DeepAgent Code повністю відкритий. Вихідний код доступний публічно на",
  ...
  "home.zenCta.body":
    "Zen дає доступ до добірки AI-моделей, які DeepAgent Code протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",
  "home.zenCta.link": "Дізнатися про Zen",

  "zen.title": "DeepAgent Code Zen | Добірка надійних оптимізованих моделей для агентів кодування",
  "zen.hero.title": "Надійні оптимізовані моделі для агентів кодування",
  "zen.hero.body":
    "Zen дає доступ до добірки AI-моделей, які DeepAgent Code протестував спеціально для агентів кодування. Не турбуйтеся про нестабільну якість — використовуйте перевірені моделі.",

  "zen.faq.q1": "Що таке DeepAgent Code Zen?",
  "zen.faq.a1": "Zen — це добірка AI-моделей, протестованих для агентів кодування, створена командою DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen не є прибутковим. Zen передає вам вартість від провайдерів моделей. Чим вище використання Zen, тим кращі ціни DeepAgent Code може узгодити та передати вам.",
  ...
  "zen.faq.a4.p3":
    "Щоб покрити витрати, DeepAgent Code додає лише невелику комісію за обробку платежу в розмірі $1.23 за кожне поповнення балансу $20.",
  ...
  "zen.faq.a8":
    "Хоча Zen чудово працює з DeepAgent Code, ви можете використовувати Zen з будь-яким агентом. Дотримуйтесь інструкцій з налаштування у вашому агенті.",
  ...
  "zen.problem.subtitle": "Ми вирішуємо це для всіх, а не лише для користувачів DeepAgent Code.",
  ...
  "zen.how.body":
    "Хоча ми пропонуємо використовувати Zen з DeepAgent Code, ви можете використовувати Zen з будь-яким агентом.",
  ...
  "go.title": "DeepAgent Code Go | Недорогі моделі кодування для всіх",
  "go.meta.description":
  ...
  "go.problem.body":
    "Ми зосереджені на тому, щоб зробити досвід DeepAgent Code доступним для якомога більшої кількості людей. DeepAgent Code Go — це недорога підписка: $5 за перший місяць, потім $10/місяць. Вона надає щедрі ліміти та надійний доступ до найкращих моделей з відкритим кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go починається від $5 за перший місяць, потім $10/місяць. Використовуйте з DeepAgent Code або будь-яким агентом.",
  ...
  "go.faq.q1": "Що таке DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "black.workspace.title": "DeepAgent Code Black | Виберіть робочий простір",
  "black.workspace.selectPlan": "Виберіть робочий простір для цього плану",
  "black.workspace.name": "Робочий простір {{n}}",
  "black.subscribe.title": "Підписатися на DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "Ви в списку очікування DeepAgent Code Black",
  ...
  "workspace.newUser.step.login.after": "і виберіть deepagent-code",
  "workspace.newUser.step.pasteKey": "Вставте ключ API",
  "workspace.newUser.step.models.before": "Запустіть deepagent-code і виконайте",
  ...
  "workspace.keys.subtitle": "Керуйте ключами API для доступу до сервісів deepagentCode.",
  "workspace.keys.create": "Створити ключ API",
  "workspace.keys.placeholder": "Введіть назву ключа",
  "workspace.keys.empty": "Створіть ключ API шлюзу deepagent-code",
  ...
  "workspace.black.subscription.message": "Ви підписані на DeepAgent Code Black за ${{plan}} на місяць.",
  ...
  "workspace.black.waitlist.joined": "Ви в списку очікування на план DeepAgent Code Black за ${{plan}} на місяць.",
  "workspace.black.waitlist.ready": "Ми готові зареєструвати вас на план DeepAgent Code Black за ${{plan}} на місяць.",
  ...
  "workspace.lite.subscription.message": "Ви підписані на DeepAgent Code Go.",
  ...
  "download.title": "DeepAgent Code | Завантажити",
  "download.meta.description": "Завантажте DeepAgent Code для macOS, Windows та Linux",
  "download.hero.title": "Завантажити DeepAgent Code",
  "download.hero.subtitle": "Доступно в бета-версії для macOS, Windows та Linux",
  "download.hero.button": "Завантажити для {{os}}",
  "download.section.terminal": "Термінал DeepAgent Code",
  "download.section.desktop": "Десктоп DeepAgent Code (Бета)",
  "download.section.extensions": "Розширення DeepAgent Code",
  "download.section.integrations": "Інтеграції DeepAgent Code",
  ...
  "download.faq.a3.afterZen":
    ", DeepAgent Code працює з усіма популярними провайдерами, такими як OpenAI, Anthropic, xAI тощо.",

  "download.faq.a5.p1": "DeepAgent Code є 100% безкоштовним.",
  "download.faq.a5.p2.beforeZen":
    "Будь-які додаткові витрати будуть з вашої підписки у провайдера моделі. Ми рекомендуємо",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваші дані зберігаються лише при створенні посилань для обміну в DeepAgent Code.",
  "download.faq.a6.p2.beforeShare": "Дізнайтеся більше про",
  "download.faq.a6.shareLink": "сторінки обміну",

  "enterprise.title": "DeepAgent Code | Enterprise-рішення для вашої організації",
  "enterprise.meta.description": "Зв'яжіться з DeepAgent Code для Enterprise-рішень",
  "enterprise.hero.title": "Ваш код належить вам",
  "enterprise.hero.body1":
    "DeepAgent Code працює безпечно всередині вашої організації без зберігання даних, ліцензійних обмежень. Почніть пробний період із командою, потім розгорніть через SSO та внутрішній AI-шлюз.",
  ...
  "enterprise.faq.q1": "Що таке DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise для організацій, які хочуть гарантувати, що код і дані ніколи не залишають їхню інфраструктуру.",
  "enterprise.faq.q2": "Як почати з DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Почніть із внутрішнього тестування з командою. DeepAgent Code за замовчуванням не зберігає код. Потім зв'яжіться з нами для обговорення цін.",
  ...
  "enterprise.faq.q4": "Чи безпечні мої дані з DeepAgent Code Enterprise?",
  "enterprise.faq.a4":
    "Так. DeepAgent Code не зберігає ваш код або контекст. Вся обробка відбувається локально або через прямі API-виклики.",

  "brand.title": "DeepAgent Code | Бренд",
  "brand.meta.description": "Рекомендації щодо бренду DeepAgent Code",
  "brand.heading": "Рекомендації щодо бренду",
  "brand.subtitle": "Ресурси та матеріали для роботи з брендом DeepAgent Code.",
  "brand.downloadAll": "Завантажити всі матеріали",

  "changelog.title": "DeepAgent Code | Журнал змін",
  "changelog.meta.description": "Нотатки про випуски та журнал змін DeepAgent Code",
  "changelog.hero.title": "Журнал змін",
  "changelog.hero.subtitle": "Нові оновлення та покращення DeepAgent Code",
