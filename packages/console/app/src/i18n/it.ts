...
export const dict = {
  ...
  "notFound.title": "Non trovato | deepagent-code",
  "notFound.heading": "404 - Pagina non trovata",
  "notFound.home": "Home",
  "notFound.docs": "Documentazione",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "logo chiaro di deepagent-code",
  "notFound.logoDarkAlt": "logo scuro di deepagent-code",
  ...
  "app.meta.description": "DeepAgent Code - L'agente di programmazione open source.",

  "home.title": "DeepAgent Code | L'agente di coding IA open source",

  "temp.title": "deepagent-code | Agente di coding IA costruito per il terminale",
  ...
  "temp.feature.zen.afterLink": "fornita da deepagent-code",
  "temp.feature.models.beforeLink": "Supporta 75+ provider LLM tramite",
  "temp.feature.models.afterLink": ", inclusi modelli locali",
  "temp.screenshot.caption": "DeepAgent Code TUI con il tema tokyonight",
  "temp.screenshot.alt": "DeepAgent Code TUI con tema tokyonight",
  "temp.logoLightAlt": "logo chiaro di deepagent-code",
  "temp.logoDarkAlt": "logo scuro di deepagent-code",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, DeepAgent Code è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "DeepAgent Code non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso DeepAgent Code?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare DeepAgent Code?",
  "home.faq.a3.p1":
    "Non necessariamente: DeepAgent Code include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, DeepAgent Code funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con DeepAgent Code?",
  "home.faq.a4.p1":
    "Sì, DeepAgent Code supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare DeepAgent Code solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! DeepAgent Code ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "DeepAgent Code è open source?",
  "home.faq.a8.p1": "Sì, DeepAgent Code è completamente open source. Il codice sorgente è pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dà accesso a una selezione di modelli di IA che DeepAgent Code ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "DeepAgent Code Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dà accesso a una selezione di modelli di IA che DeepAgent Code ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'è DeepAgent Code Zen?",
  "zen.faq.a1":
    "Zen è un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen non è a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. Più Zen viene usato, più DeepAgent Code può negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, DeepAgent Code aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con DeepAgent Code, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti DeepAgent Code.",
  ...
  "go.title": "DeepAgent Code Go | Modelli di coding a basso costo per tutti",
  "go.meta.description":
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza DeepAgent Code a quante più persone possibile. DeepAgent Code Go è un abbonamento a basso costo: $5 il primo mese, poi $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source più capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go inizia a $5 per il primo mese, poi $10/mese. Puoi usarlo con DeepAgent Code o qualsiasi agente.",
  ...
  "go.faq.q1": "Che cos'è DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promozione gratuita di {{model}} è terminata. Puoi continuare a usare il modello abbonandoti a DeepAgent Code Go - {{link}}",

  "black.meta.title": "DeepAgent Code Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento DeepAgent Code Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "DeepAgent Code Black | Prezzi",
  ...
  "black.workspace.title": "DeepAgent Code Black | Seleziona Workspace",
  "black.workspace.selectPlan": "Seleziona un workspace per questo piano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Abbonati a DeepAgent Code Black",
  ...
  "black.subscribe.success.title": "Sei nella lista d'attesa di DeepAgent Code Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con qualsiasi agente di coding, e continua a usare altri provider con deepagent-code quando vuoi.",
  ...
  "workspace.newUser.step.login.after": "e seleziona deepagent-code",
  "workspace.newUser.step.pasteKey": "Incolla la tua chiave API",
  "workspace.newUser.step.models.before": "Avvia deepagent-code ed esegui",
  ...
  "workspace.keys.subtitle": "Gestisci le tue chiavi API per accedere ai servizi deepagentCode.",
  "workspace.keys.create": "Crea Chiave API",
  "workspace.keys.placeholder": "Inserisci nome chiave",
  "workspace.keys.empty": "Crea una chiave API deepagent-code Gateway",
  ...
  "workspace.black.subscription.message": "Sei abbonato a DeepAgent Code Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano DeepAgent Code Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano DeepAgent Code Black da ${{plan}} al mese.",
  ...
  "workspace.lite.subscription.message": "Sei abbonato a DeepAgent Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "DeepAgent Code Go" come provider nella tua configurazione deepagent-code per utilizzare i modelli Go.',
  "workspace.lite.black.message":
    "Attualmente sei abbonato a DeepAgent Code Black o sei in lista d'attesa. Annulla l'iscrizione prima se desideri passare a Go.",
  "workspace.lite.other.message":
    "Un altro membro in questo workspace è già abbonato a DeepAgent Code Go. Solo un membro per workspace può abbonarsi.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go parte da {{price}}, poi $10/mese, e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  ...
  "download.meta.description": "Scarica DeepAgent Code per macOS, Windows e Linux",
  "download.hero.title": "Scarica DeepAgent Code",
  ...
  "enterprise.title": "DeepAgent Code | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta DeepAgent Code per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice è tuo",
  "enterprise.hero.body1":
    "DeepAgent Code opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietà. Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'è DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise è per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. Può farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. DeepAgent Code per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con DeepAgent Code Enterprise?",
  "enterprise.faq.a4":
    "Sì. DeepAgent Code non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "DeepAgent Code | Brand",
  "brand.meta.description": "Linee guida del brand DeepAgent Code",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand DeepAgent Code.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "DeepAgent Code | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog DeepAgent Code",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a DeepAgent Code",
