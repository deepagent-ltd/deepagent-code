...
export const dict = {
  ...
  "notFound.title": "Ikke fundet | deepagent-code",
  "notFound.heading": "404 - Siden blev ikke fundet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentation",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "deepagent-code logo light",
  "notFound.logoDarkAlt": "deepagent-code logo dark",
  ...
  "app.meta.description": "DeepAgent Code - Den open source kodningsagent.",

  "home.title": "DeepAgent Code | Den open source AI-kodningsagent",

  "temp.title": "deepagent-code | AI-kodningsagent bygget til terminalen",
  ...
  "temp.feature.zen.afterLink": "leveret af deepagent-code",
  ...
  "temp.screenshot.caption": "deepagent-code TUI med tokyonight-temaet",
  "temp.screenshot.alt": "deepagent-code TUI med tokyonight-temaet",
  "temp.logoLightAlt": "deepagent-code logo light",
  "temp.logoDarkAlt": "deepagent-code logo dark",
  ...
  "home.what.title": "Hvad er DeepAgent Code?",
  "home.what.body":
    "DeepAgent Code er en open source agent, der hjælper dig med at skrive kode i din terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsydere og over <strong>{{commits}}</strong> commits bruges DeepAgent Code af over <strong>{{monthlyUsers}}</strong> udviklere hver måned.",
  ...
  "home.privacy.body":
    "DeepAgent Code gemmer ikke din kode eller kontekstdata, så den kan bruges i privatlivsfølsomme miljøer.",
  "home.privacy.learnMore": "Læs mere om",
  "home.privacy.link": "privatliv",

  "home.faq.q1": "Hvad er DeepAgent Code?",
  "home.faq.a1":
    "DeepAgent Code er en open source agent, der hjælper dig med at skrive og køre kode med enhver AI-model. Den er tilgængelig som terminal-interface, desktop-app eller IDE-udvidelse.",
  "home.faq.q2": "Hvordan bruger jeg DeepAgent Code?",
  "home.faq.a2.before": "Den nemmeste måde at komme i gang på er at læse",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Skal jeg have ekstra AI-abonnementer for at bruge DeepAgent Code?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. DeepAgent Code kommer med gratis modeller, som du kan bruge uden at oprette en konto.",
  "home.faq.a3.p2.beforeZen": "Derudover kan du bruge populære kodningsmodeller ved at oprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi opfordrer til at bruge Zen, men DeepAgent Code virker også med populære udbydere som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan endda forbinde dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruge mine eksisterende AI-abonnementer med DeepAgent Code?",
  "home.faq.a4.p1":
    "Ja. DeepAgent Code understøtter abonnementer fra alle store udbydere. Du kan bruge Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg kun bruge DeepAgent Code i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke længere! DeepAgent Code er nu tilgængelig som en app til",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hvad koster DeepAgent Code?",
  "home.faq.a6":
    "DeepAgent Code er 100% gratis at bruge. Det kommer også med et sæt gratis modeller. Der kan være ekstra omkostninger, hvis du forbinder en anden udbyder.",
  ...
  "home.faq.q8": "Er DeepAgent Code open source?",
  "home.faq.a8.p1": "Ja, DeepAgent Code er fuldt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen giver dig adgang til et håndplukket sæt AI-modeller, som DeepAgent Code har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet på tværs af udbydere: brug validerede modeller, der virker.",
  "home.zenCta.link": "Læs om Zen",

  "zen.title": "DeepAgent Code Zen | Et kurateret sæt af pålidelige, optimerede modeller til kodningsagenter",
  "zen.hero.title": "Pålidelige optimerede modeller til kodningsagenter",
  "zen.hero.body":
    "Zen giver dig adgang til et kurateret sæt AI-modeller, som DeepAgent Code har testet og benchmarked specifikt til kodningsagenter. Du behøver ikke bekymre dig om svingende performance og kvalitet: brug validerede modeller, der virker.",

  "zen.faq.q1": "Hvad er DeepAgent Code Zen?",
  "zen.faq.a1":
    "Zen er et kurateret sæt AI-modeller testet og benchmarked til kodningsagenter, skabt af teamet bag DeepAgent Code.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profit. Zen videregiver omkostningerne fra modeludbyderne til dig. Jo mere Zen bruges, desto mere kan DeepAgent Code forhandle bedre priser og give dem videre til dig.",
  ...
  "zen.faq.a4.p3":
    "For at dække omkostninger tilføjer DeepAgent Code kun et lille betalingsgebyr på $1.23 per $20 saldo-opfyldning.",
  ...
  "zen.faq.a8":
    "Selvom Zen fungerer godt med DeepAgent Code, kan du bruge Zen med enhver agent. Følg opsætningsinstruktionerne i din foretrukne kodningsagent.",
  ...
  "zen.problem.subtitle": "Vi løser dette for alle, ikke kun DeepAgent Code-brugere.",
  ...
  "zen.how.body": "Selvom vi foreslår, at du bruger Zen med DeepAgent Code, kan du bruge Zen med enhver agent.",
  ...
  "go.title": "DeepAgent Code Go | Kodningsmodeller til lav pris for alle",
  "go.meta.description":
  ...
  "go.problem.body":
    "Vi fokuserer på at bringe DeepAgent Code-oplevelsen ud til så mange som muligt. DeepAgent Code Go er et lavprisabonnement: $5 for den første måned, derefter $10/måned. Det giver generøse grænser og pålidelig adgang til de mest kapable open source-modeller.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter ved $5 for den første måned, derefter $10/måned. Du kan bruge det med DeepAgent Code eller enhver agent.",
  ...
  "go.faq.q1": "Hvad er DeepAgent Code Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampagne for {{model}} er afsluttet. Du kan fortsætte med at bruge modellen ved at abonnere på DeepAgent Code Go - {{link}}",

  "black.meta.title": "DeepAgent Code Black | Få adgang til verdens bedste kodningsmodeller",
  "black.meta.description": "Få adgang til Claude, GPT, Gemini og mere med DeepAgent Code Black-abonnementer.",
  ...
  "black.workspace.title": "DeepAgent Code Black | Vælg workspace",
  ...
  "black.subscribe.success.title": "Du er på DeepAgent Code Black-ventelisten",
  ...
  "workspace.newUser.feature.lockin.body":
    "Brug Zen med en hvilken som helst kodningsagent, og fortsæt med at bruge andre udbydere med deepagent-code, når du vil.",
  ...
  "workspace.newUser.step.login.after": "og vælg deepagent-code",
  "workspace.newUser.step.pasteKey": "Indsæt din API-nøgle",
  "workspace.newUser.step.models.before": "Start deepagent-code og kør",
  ...
  "workspace.keys.subtitle": "Administrer dine API-nøgler for at få adgang til deepagent-code-tjenester.",
  "workspace.keys.create": "Opret API-nøgle",
  "workspace.keys.placeholder": "Indtast nøglenavn",
  "workspace.keys.empty": "Opret en deepagent-code Gateway API-nøgle",
  ...
  "workspace.black.subscription.message": "Du abonnerer på DeepAgent Code Black for ${{plan}} om måneden.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned DeepAgent Code Black plan.",
  "workspace.black.waitlist.ready": "Vi er klar til at tilmelde dig ${{plan}} per måned DeepAgent Code Black plan.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Vælg "DeepAgent Code Go" som udbyder i din deepagent-code-konfiguration for at bruge Go-modeller.',
  "workspace.lite.black.message":
    "Du abonnerer i øjeblikket på DeepAgent Code Black eller er på venteliste. Afmeld venligst først, hvis du vil skifte til Go.",
  "workspace.lite.other.message":
    "Et andet medlem i dette workspace abonnerer allerede på DeepAgent Code Go. Kun ét medlem pr. workspace kan abonnere.",
  "workspace.lite.promo.description":
    "DeepAgent Code Go starter ved {{price}}, derefter $10/måned, og giver pålidelig adgang til populære åbne kodningsmodeller med generøse brugsgrænser.",
  ...
  "download.title": "DeepAgent Code | Download",
  "download.meta.description": "Download DeepAgent Code til macOS, Windows og Linux",
  "download.hero.title": "Download DeepAgent Code",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sandsynligvis. Du skal bruge et AI-abonnement hvis du vil forbinde DeepAgent Code til en betalt udbyder, men du kan arbejde med",
  ...
  "download.faq.a3.afterZen": ", fungerer DeepAgent Code med alle populære udbydere som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "DeepAgent Code er 100% gratis at bruge.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra omkostninger kommer fra dit abonnement hos en modeludbyder. Selvom DeepAgent Code fungerer med enhver modeludbyder, anbefaler vi at bruge",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dine data og oplysninger gemmes kun når du opretter delbare links i DeepAgent Code.",
  "download.faq.a6.p2.beforeShare": "Læs mere om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "DeepAgent Code | Enterprise-løsninger til din organisation",
  ...
  "enterprise.hero.body1":
    "DeepAgent Code fungerer sikkert inde i din organisation uden at lagre data eller kontekst og uden licensbegrænsninger eller ejerskabskrav. Start en prøveperiode med dit team, og udrul det derefter i hele din organisation ved at integrere det med dit SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hvad er DeepAgent Code Enterprise?",
  "enterprise.faq.a1":
    "DeepAgent Code Enterprise er til organisationer, der vil sikre, at deres kode og data aldrig forlader deres infrastruktur. Det kan gøres med en central konfiguration, der integrerer med dit SSO og din interne AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med DeepAgent Code Enterprise?",
  "enterprise.faq.a2":
    "Start blot med en intern prøveperiode med dit team. DeepAgent Code gemmer som standard ikke din kode eller kontekstdata, hvilket gør det nemt at komme i gang. Kontakt os derefter for at tale om priser og implementeringsmuligheder.",
  ...
  "enterprise.faq.q4": "Er mine data sikre med DeepAgent Code Enterprise?",
  "enterprise.faq.a4":
    "Ja. DeepAgent Code gemmer ikke din kode eller kontekstdata. Al behandling sker lokalt eller via direkte API-kald til din AI-udbyder. Med central konfiguration og SSO-integration forbliver dine data sikre inden for din organisations infrastruktur.",

  "brand.title": "DeepAgent Code | Brand",
  "brand.meta.description": "DeepAgent Code brandretningslinjer",
  "brand.heading": "Brandretningslinjer",
  "brand.subtitle": "Ressourcer og assets, der hjælper dig med at arbejde med DeepAgent Code-brandet.",
  "brand.downloadAll": "Download alle assets",

  "changelog.title": "DeepAgent Code | Changelog",
  "changelog.meta.description": "DeepAgent Code versionsnoter og changelog",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nye opdateringer og forbedringer til DeepAgent Code",
