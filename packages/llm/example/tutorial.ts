...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@deepagent-code/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@deepagent-code/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-deepagent-code-tutorial": "1" },
    query: { debug: "1" },
  },
})
