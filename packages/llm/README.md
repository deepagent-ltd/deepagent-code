...
Schema-first LLM core for deepagent-code. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@deepagent-code/llm"
import { OpenAI } from "@deepagent-code/llm/providers"
...
```ts
import { OpenAI } from "@deepagent-code/llm/providers"
import { CloudflareAIGateway } from "@deepagent-code/llm/providers/compat"
...
Main providers: OpenAI, Anthropic, and OpenAI-compatible helpers such as DeepSeek. Legacy provider facades including Google, Amazon Bedrock, Azure OpenAI, Cloudflare, GitHub Copilot, OpenRouter, and xAI remain available from `@deepagent-code/llm/providers/compat`.
