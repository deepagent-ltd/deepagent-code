...
Practical reference for the current tool-migration state in `packages/deepagent-code`.
...
Tool tests should use the existing Effect helpers in `packages/deepagent-code/test/lib/effect.ts`:
