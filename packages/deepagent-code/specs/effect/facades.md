...
Concrete inventory of the remaining `makeRuntime(...)`-backed facades in `packages/deepagent-code`.
...
- [x] `../core/src/filesystem.ts` (`FileSystem`) - legacy deepagent-code service removed
