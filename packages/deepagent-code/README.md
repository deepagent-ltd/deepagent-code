...
The CLI runtime is part of the coordinated Core V2 and Desktop 2.0 beta line: package version `2.0.0-beta.0`, with the Core release label `core-v2.0beta` and the Desktop release label `desktop-v2.0beta`.
