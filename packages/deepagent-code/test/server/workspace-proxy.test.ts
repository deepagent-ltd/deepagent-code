...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips deepagent-code-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      const request = HttpServerRequest.fromWeb(
        new Request("http://localhost/test", {
          headers: {
            ...
            "x-deepagent-code-workspace": "ws_123",
            "x-custom": "preserved",
          },
        }),
      )
      ...
      expect(forwarded["x-deepagent-code-directory"]).toBeUndefined()
      expect(forwarded["x-deepagent-code-workspace"]).toBeUndefined()
