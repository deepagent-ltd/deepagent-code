...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      DEEPAGENT_CODE_EXPERIMENTAL_WORKSPACES: Flag.DEEPAGENT_CODE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.DEEPAGENT_CODE_EXPERIMENTAL_WORKSPACES = original.DEEPAGENT_CODE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
