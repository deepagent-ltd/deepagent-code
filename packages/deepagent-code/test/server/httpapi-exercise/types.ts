...
export type CaptureMode = "full" | "headers" | "stream"
...
export type ActiveScenario = {
  ...
  seed: (ctx: ScenarioContext) => Effect.Effect<unknown, unknown, Scope.Scope>
...
export type BuilderState<S> = {
  ...
  name: string
  project: ProjectOptions | undefined
  seed: (ctx: ScenarioContext) => Effect.Effect<S, unknown, Scope.Scope>
