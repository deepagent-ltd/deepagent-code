...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips deepagent-code-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-deepagent-code-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-deepagent-code-directory")).toBeNull()
      expect(result.get("x-deepagent-code-workspace")).toBeNull()
