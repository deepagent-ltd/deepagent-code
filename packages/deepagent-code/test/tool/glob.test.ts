  ...
  references.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "deepagent-code-glob-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "deepagent-code-glob-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "deepagent-code-glob-reference/repo",
        },
      },
    },
  )
