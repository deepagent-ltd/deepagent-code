  ...
  references.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const cache = path.join(Global.Path.repos, "github.com", "deepagent-code-grep-reference", "repo")
        ...
        const remoteDir = path.join(remoteRoot, "deepagent-code-grep-reference")
      ...
      }),
    {
      config: {
        reference: {
          docs: "deepagent-code-grep-reference/repo",
        },
      },
    },
  )
