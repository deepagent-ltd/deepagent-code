...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders DEEPAGENT_CODE_CALLER", () => {
    process.env["DEEPAGENT_CODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode DEEPAGENT_CODE_CALLER", () => {
    process.env["DEEPAGENT_CODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown DEEPAGENT_CODE_CALLER", () => {
    process.env["DEEPAGENT_CODE_CALLER"] = "unknown"
