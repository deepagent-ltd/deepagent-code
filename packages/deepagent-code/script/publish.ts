...
if (!Script.preview) {
  ...
  const homebrewFormula = [
    ...
    "class DeepagentCode < Formula",
    `  desc "The AI coding agent built for the terminal."`,
    `  homepage "https://github.com/deepagent-ltd/deepagent-code"`,
    ...
    `      url "https://github.com/deepagent-ltd/deepagent-code/releases/download/v${Script.version}/deepagent-code-darwin-x64.zip"`,
    `      sha256 "${macX64Sha}"`,
    "",
    "      def install",
    ...
    "    end",
    "    if Hardware::CPU.arm?",
    `      url "https://github.com/deepagent-ltd/deepagent-code/releases/download/v${Script.version}/deepagent-code-darwin-arm64.zip"`,
    `      sha256 "${macArm64Sha}"`,
    "",
    "      def install",
    '        bin.install "deepagent-code"',
  ...
  const tap = `https://x-access-token:${token}@github.com/deepagent-ltd/homebrew-tap.git`
