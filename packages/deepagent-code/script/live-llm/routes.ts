...
export const modelSuites = [
  ...
  "interrupted-permission-package",
...
const interruptedPermissionPackage = modelRun("ext", "renderer-ui", "interrupted-permission-package")
...
export const routeManifest = [
  ...
  {
    id: "live-llm-interrupted-permission-package-harness",
    paths: [
      "packages/desktop/electron-builder.config.ts",
      "packages/desktop/scripts/live-llm/interrupted-permission-package.ts",
      "packages/desktop/scripts/live-llm/runtime.ts",
      "packages/desktop/scripts/package.ts",
    ],
    checks: ["desktop-runtime", "permission", "prompt-intent"],
    runs: [interruptedPermissionPackage],
  },
  {
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/core/src/session/runtime-status.ts",
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/core/src/session/compaction-request.ts",
      "packages/core/src/session/compaction-request.sql.ts",
    ],
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/core/src/session/legacy-wire.ts",
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/core/src/tool/delegation.ts",
      "packages/core/src/tool/task.ts",
      "packages/core/src/tool/task.txt",
      "packages/core/src/tool/task-policy.ts",
      "packages/core/src/session/task-run.ts",
      "packages/core/src/session/task-run-dispatcher.ts",
      "packages/core/src/session/task-outbox.ts",
      "packages/core/src/session/task-workspace.ts",
      "packages/core/src/session/task-pr-review.ts",
      "packages/core/src/tool/git-read.ts",
      "packages/core/src/tool/apply-patch-chunk.ts",
    ],
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/core/src/tool/edit-replace.ts",
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/core/src/tool/plan.txt",
    ],
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/deepagent-code/src/session/facade-activity.ts",
      ...
      "packages/deepagent-code/src/session/command-effect-receipt.ts",
      "packages/deepagent-code/src/session/command-v2.ts",
      "packages/deepagent-code/src/session/structured-output-prompt.ts",
      "packages/deepagent-code/src/session/v2-agent-roster.ts",
      "packages/deepagent-code/src/session/v2-mcp-bridge.ts",
      "packages/deepagent-code/src/session/v2-plugin-tools-bridge.ts",
      "packages/deepagent-code/src/session/legacy-execution-zero.ts",
      "packages/deepagent-code/src/session/steer.ts",
      "packages/deepagent-code/src/session/turn-deadline-watchdog.ts",
      "packages/deepagent-code/src/session/turn-stage-evidence.sql.ts",
      "packages/deepagent-code/src/session/turn-stage-evidence.ts",
    ],
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/deepagent-code/src/session/remote-compact.ts",
  ...
  },
  {
    ...
    paths: [
      ...
      "packages/deepagent-code/src/session/__tests__/snapshot.test.ts",
      "packages/deepagent-code/src/session/snapshot.ts",
  ...
  },
  {
    ...
    paths: ["packages/deepagent-code/src/permission/**", "packages/deepagent-code/src/session/tools.ts"],
    checks: ["permission"],
    runs: [
      permissionsDeny,
      multiAgentParallelWorktrees,
