...
export const routeManifest = [
  ...
  },
  {
    ...
    runs: [worktreeRouting, interruptedSubagent, backgroundSubagent],
  },
  {
  ...
  },
  {
    ...
    checks: ["llm-adapter"],
    runs: [legacyStructured, legacySubagent, expertPanel, goalGraderCliEntry],
  },
  {
  ...
  },
  {
    ...
    checks: ["permission", "worktree-routing"],
    runs: [legacySubagent, worktreeRouting, interruptedSubagent, backgroundSubagent, expertPanel, goalGraderCliEntry],
  },
  {
