import type { AuthOAuthResult, Hooks } from "@deepagent-code/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@deepagent-code/ProviderAuth") {}
