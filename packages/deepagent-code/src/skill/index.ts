...
import { FrontmatterError } from "@deepagent-code/core/v1/config/error"
...
const DEEPAGENT_CODE_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
const SKILL_PATTERN = "**/SKILL.md"

// Built-in skill that ships with deepagentCode. The model's intuition for what an
// deepagent-code.json should look like is often wrong, and deepagent-code hard-fails on
// invalid config, so users hit cryptic startup errors. Loading this skill
// when the model is asked to touch deepagent-code's own config files gives it the
...
const discoverSkills = Effect.fnUntraced(function* (
  ...
  for (const dir of configDirs) {
    yield* scan(state, dir, DEEPAGENT_CODE_SKILL_PATTERN)
  }
...
export class Service extends Context.Service<Service, Interface>()("@deepagent-code/Skill") {}
  ...
  Effect.gen(function* () {
    ...
    const state = yield* InstanceState.make(
      Effect.fn("Skill.state")(function* () {
        ...
        s.skills[CUSTOMIZE_DEEPAGENT_CODE_SKILL_NAME] = {
          name: CUSTOMIZE_DEEPAGENT_CODE_SKILL_NAME,
          description: CUSTOMIZE_DEEPAGENT_CODE_SKILL_DESCRIPTION,
          location: "<built-in>",
          content: CUSTOMIZE_DEEPAGENT_CODE_SKILL_BODY,
        }
