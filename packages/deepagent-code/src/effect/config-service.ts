 ...
 *   "@deepagent-code/ServerAuthConfig",
 *   {
 *     password: Config.string("DEEPAGENT_CODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("DEEPAGENT_CODE_SERVER_USERNAME").pipe(Config.withDefault("deepagent-code")),
 *   },
 * ) {}
 *
