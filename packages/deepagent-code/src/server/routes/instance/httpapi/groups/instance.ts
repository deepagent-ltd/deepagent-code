...
const PathInfo = Schema.Struct({
  ...
  agent: Schema.Struct({
    ...
    providerExecutedToolPolicy: Schema.Literals(["deny_by_default", "allowlist_required"]),
    knowledgeEnabled: Schema.Boolean,
    directories: Schema.Struct({
      data: Schema.String,
      cache: Schema.String,
      state: Schema.String,
      tmp: Schema.String,
    ...
    coverage: Schema.Array(
      Schema.Struct({
        ...
        status: Schema.Literals(["covered", "planned", "blocked"]),
        note: Schema.String,
      }),
    ),
  }),
      ...
      .add(
        HttpApiEndpoint.post("dispose", InstancePaths.dispose, {
          ...
          OpenApi.annotations({
            ...
            description: "Clean up and dispose the current DeepAgent Code instance, releasing all resources.",
          }),
        ),
        HttpApiEndpoint.get("path", InstancePaths.path, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get paths",
            description:
              "Retrieve the current working directory and related path information for the DeepAgent Code instance.",
          }),
        ),
        ...
        HttpApiEndpoint.get("command", InstancePaths.command, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all available commands in the DeepAgent Code system.",
          }),
        ),
        HttpApiEndpoint.get("agent", InstancePaths.agent, {
          ...
          OpenApi.annotations({
            ...
            summary: "List agents",
            description: "Get a list of all available AI agents in the DeepAgent Code system.",
          }),
        ),
        HttpApiEndpoint.get("skill", InstancePaths.skill, {
          ...
          OpenApi.annotations({
            ...
            summary: "List skills",
            description: "Get a list of all available skills in the DeepAgent Code system.",
          }),
        ),
