    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.get("continuationResolutionList", SessionPaths.continuationResolution, {
          ...
          query: WorkspaceRoutingQuery,
          success: described(
            Schema.Array(SessionCompaction.ContinuationResolutionDescriptor),
            "Pending compaction continuation recovery decisions",
          ),
          error: [HttpApiError.BadRequest, ApiNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "session.continuationResolutionList",
            summary: "List continuation recovery decisions",
          }),
        ),
        HttpApiEndpoint.post("continuationResolutionResolve", SessionPaths.continuationResolution, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          payload: ContinuationResolutionPayload,
          success: described(SessionCompaction.ContinuationResolutionResult, "Resolved continuation outcome"),
          error: [HttpApiError.BadRequest, ApiNotFoundError, ConflictError, ServiceUnavailableError],
        }).annotateMerge(
          OpenApi.annotations({
