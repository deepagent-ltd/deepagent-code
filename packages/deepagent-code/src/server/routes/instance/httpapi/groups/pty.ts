...
import { InvalidRequestError, PtyForbiddenError, PtyNotFoundError } from "../errors"
      ...
      .add(
        ...
        HttpApiEndpoint.get("list", PtyPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all active pseudo-terminal (PTY) sessions managed by DeepAgent Code.",
          }),
        ),
