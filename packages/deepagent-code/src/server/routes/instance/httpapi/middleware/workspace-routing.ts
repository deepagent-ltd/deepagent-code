...
>()("@deepagent-code/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@deepagent-code/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.DEEPAGENT_CODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.DEEPAGENT_CODE_WORKSPACE_ID) : undefined
}
