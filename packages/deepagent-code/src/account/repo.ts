...
import { AccountStateTable, AccountTable } from "@deepagent-code/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@deepagent-code/AccountRepo") {}
