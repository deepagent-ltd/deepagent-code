...
export const DEPRECATED_PLUGIN_PACKAGES = ["deepagent-code-openai-codex-auth", "deepagent-code-copilot-auth"]
...
export async function resolvePluginTarget(spec: string) {
  ...
  pluginTargetResolutions.set(spec, resolution)
  return resolution
}
