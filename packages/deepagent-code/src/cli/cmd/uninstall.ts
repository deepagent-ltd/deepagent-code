...
export const UninstallCommand = {
  command: "uninstall",
  describe: "uninstall deepagent-code and remove all related files",
  builder: (yargs: Argv) =>
    yargs
      .option("keep-config", {
        alias: "c",
  ...
  handler: async (args: UninstallArgs) => {
    ...
    UI.println(UI.logo("  "))
    UI.empty()
    prompts.intro("Uninstall DeepAgent Code")
...
async function showRemovalSummary(targets: RemovalTargets, method: Installation.Method) {
  ...
  if (method !== "curl" && method !== "unknown") {
    const cmds: Record<string, string> = {
      ...
      yarn: "yarn global remove deepagent-code",
      brew: "brew uninstall deepagent-code",
      choco: "choco uninstall deepagent-code",
...
async function executeUninstall(method: Installation.Method, targets: RemovalTargets) {
  ...
  UI.empty()
  prompts.log.success("Thank you for using DeepAgent Code!")
}
