...
import type { PermissionRequest } from "@deepagent-code/sdk/v2"
import {
...
export function RejectField(props: {
  ...
  return (
    <textarea
      ...
      maxHeight={3}
      wrapMode="word"
      placeholder="Tell DeepAgent Code what to do differently"
      ...
      >
        ...
        <Switch>
          ...
          <Match when={state().stage === "reject"}>
            <box paddingLeft={1}>
              <text fg={props.theme.muted}>Tell DeepAgent Code what to do differently</text>
            </box>
          </Match>
        </Switch>
      </box>
