...
import type { Event, GlobalEvent, OpencodeClient } from "@deepagent-code/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@deepagent-code/RunStreamTransport") {}
