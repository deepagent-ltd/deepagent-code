import type { JsonSchema, LLMRequest, ProviderMetadata } from "@deepagent-code/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@deepagent-code/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @deepagent-code/llm request objects from deepagent-code's session/AI SDK-shaped data.
  return LLM.request({
