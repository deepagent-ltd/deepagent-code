...
const sensitiveKey = /(?:^|[_-])(?:api[_-]?key|authorization|token|secret|password|credential|private[_-]?key|url|env(?:ironment)?)$|(?:ApiKey|Token|Secret|Password|Credential|PrivateKey)$/i
