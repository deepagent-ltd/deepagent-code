...
- Do not add deepagent-code-specific tables, paths, migrations, post-commit hooks, or domain storage APIs here.
...
- If touching Effect APIs, verify against the repository's installed Effect version and upstream source.
