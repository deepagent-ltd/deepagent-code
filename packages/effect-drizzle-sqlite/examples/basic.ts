...
class Database extends Context.Service<Database, DatabaseShape>()("@deepagent-code/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@deepagent-code/example/UserStore") {
