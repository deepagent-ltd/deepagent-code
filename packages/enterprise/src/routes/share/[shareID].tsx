import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@deepagent-code/sdk/v2"
import { SessionTurn } from "@deepagent-code/ui/session-turn"
import { SessionReview } from "@deepagent-code/ui/session-review"
import { DataProvider } from "@deepagent-code/ui/context"
import { FileComponentProvider } from "@deepagent-code/ui/context/file"
import { WorkerPoolProvider } from "@deepagent-code/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@deepagent-code/ui/logo"
import { IconButton } from "@deepagent-code/ui/icon-button"
import { ProviderIcon } from "@deepagent-code/ui/provider-icon"
import { iife } from "@deepagent-code/core/util/iife"
...
import { MessageNav } from "@deepagent-code/ui/message-nav"
import { FileSSR } from "@deepagent-code/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@deepagent-code/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/deepagent-code-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | DeepAgent Code</Title>
              </Show>
              <Meta name="description" content="deepagent-code - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://deepagent-code.ai/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
