...
- PR #10809: https://github.com/lessweb/deepagent-code/pull/10809
- PR #11496: https://github.com/lessweb/deepagent-code/pull/11496

## Do Not Translate (Locale Additions)

- `DeepAgent Code` (preserve casing in prose; keep `deepagent-code` only in commands, package names, paths, or code)
- `DeepAgent Code CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
