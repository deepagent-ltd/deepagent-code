...
Use this folder for locale-specific translation guidance that supplements `.deepagent-code/agent/translator.md`.
...
- PR #12345: https://github.com/lessweb/deepagent-code/pull/12345

## Do Not Translate (Locale Additions)

- `DeepAgent Code` (preserve casing)
