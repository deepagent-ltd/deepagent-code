...
- PR #13942: https://github.com/lessweb/deepagent-code/pull/13942

## Do Not Translate (Locale Additions)

- `DeepAgent Code` (preserve casing in prose; keep `deepagent-code` only when it is part of commands, package names, paths, or code)
- `DeepAgent Code Zen`
- `DeepAgent Code CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `deepagent-code` in prose when referring to the product name; use `DeepAgent Code`
