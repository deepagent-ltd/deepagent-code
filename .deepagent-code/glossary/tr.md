...
- PR #15835: https://github.com/lessweb/deepagent-code/pull/15835

## Do Not Translate (Locale Additions)

- `DeepAgent Code` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `deepagent-code` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `DeepAgent Code` in prose, `deepagent-code` only for exact technical identifiers
...
- Avoid changing `deepagent-code` to `DeepAgent Code` inside commands, URLs, package names, or code literals
