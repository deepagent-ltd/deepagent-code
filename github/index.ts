...
function useShareUrl() {
  return isMock() ? "https://dev.ai.deepagent.ltd" : "https://ai.deepagent.ltd"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.deepagent.ltd/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.deepagent.ltd/exchange_github_app_token", {
      method: "POST",
      headers: {
